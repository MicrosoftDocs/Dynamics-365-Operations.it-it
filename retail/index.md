...
## <a name="workforce-management"></a>Gestione della forza lavoro
Per mantenere la redditività in un ambiente in cui i margini decrescono, i rivenditori cercano costantemente di ridurre i costi operativi. Per la maggior parte di essi, il costo del personale rappresenta una parte importante di tali costi. Se pertanto riescono a tenere sotto controllo questa voce di costo, i rivenditori possono registrare un impatto positivo sui margini di profitto. Inoltre, una forza lavoro potenziata e produttiva tende a offrire migliori esperienze ai clienti.

Con Retail i responsabili dei punti vendita possono creare e pubblicare turni e programmazioni per i lavoratori, annotare i turni con istruzioni, copiare le programmazioni da una settimana precedente a quella corrente. Inoltre, i responsabili possono visualizzare con maggiore chiarezza le richieste di assenza inviate dai lavoratori e possono approvarle o rifiutarle. Anche le richieste di scambio turno e offerta di turni sono più visibili e anche queste possono essere approvate e rifiutate.

Gli assistenti nel punto vendita possono visualizzare chiaramente i turni e le programmazioni assegnate, insieme alle relative istruzioni, e i colleghi assegnati ai turni. Possono inoltre inviare richieste di assenza, richieste di scambio turno con i colleghi e richieste di offerta di turni.
...
- [Microsoft Dynamics 365 for Retail per sviluppatori e professionisti IT](/dynamics365/unified-operations/dev-itpro/dev-tools/developer-home-page)
...
### <a name="blogs"></a>Blog
Per opinioni, notizie e altre informazioni su Retail e altre soluzioni, fare riferimento al [blog di Microsoft Dynamics 365](https://community.dynamics.com/b/msftdynamicsblog).

Sono disponibili numerosi post su Retail nel [blog del team di prodotto Microsoft Dynamics AX](https://blogs.msdn.microsoft.com/dax/). Alcuni di questi post si riferiscono alla versione precedente di Retail, ma i concetti sono ancora validi e le procedure sono simili nella versione corrente.
