...
description: In questo articolo viene descritto come impostare i prodotti al dettaglio in Microsoft Dynamics 365 per le operazioni al dettaglio.
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
5.  Aggiungere prodotti alle gerarchie di navigazione. Prima che i prodotti possano essere passati al online o in Retail POS (POS), devono essere classificati in una gerarchia punti vendita al dettaglio di navigazione.
6.  Aggiungere prodotti al catalogo. Sebbene questo passaggio è facoltativo per il POS, i punti vendita in linea è necessario che i prodotti da includere almeno in un catalogo.
