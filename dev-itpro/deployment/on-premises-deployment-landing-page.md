...
- [Dimensionamento hardware per ambienti locali](../get-started/hardware-sizing-on-premises-environments.md)
- [Criteri del ciclo di vita del software locale e dei servizi online](../migration-upgrade/versions-update-policy.md)
- [Acquistare Dynamics 365 for Finance and Operations, Enterprise Edition (locale)](../get-started/purchase-on-premises.md)
...
- [Configurare la gestione dei documenti](/dynamics365/unified-operations/fin-and-ops/organization-administration/configure-document-management)
