...
---
# <a name="define-the-dependency-of-configurations-from-othcomponents-for-electronic-reporting-er"></a>Definire la dipendenza delle configurazioni da altri componenti per la creazione di report elettronici (ER)
