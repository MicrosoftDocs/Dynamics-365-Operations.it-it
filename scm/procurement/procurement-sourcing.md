...
-   [Creare una richiesta per il consumo](http://ax.help.dynamics.com/en/wiki/create-a-requisition-for-consumption/)
-   [Creare una richiesta che usa una RdO](http://ax.help.dynamics.com/en/wiki/create-a-requisition-that-uses-an-rfq/)
-   [Impostare le autorizzazioni per ordinare prodotti per conto di altri](http://ax.help.dynamics.com/en/wiki/set-up-permissions-for-ordering-products-on-behalf-of-someone-else/)

## <a name="requests-for-quotation"></a>Richieste di offerta
-   [Richieste di offerta](request-quotations.md)
-   [Consente di creare una richiesta di offerta](http://ax.help.dynamics.com/en/wiki/create-a-request-for-quotation/)
-   [Immettere e confrontare le offerte RdO e assegnare i contratti](http://ax.help.dynamics.com/en/wiki/enter-and-compare-rfq-bids-and-award-contracts/)
-   [Creare un metodo di assegnazione punteggi per RdO](http://ax.help.dynamics.com/en/wiki/create-a-scoring-method-for-rfqs/)
-   [Creare tipi di sollecito e criteri di assegnazione punteggi per RdO](http://ax.help.dynamics.com/en/wiki/create-solicitation-types-and-scoring-criteria-for-rfqs/)
...
-   [Creazione di un conto fornitore](http://ax.help.dynamics.com/en/wiki/create-a-vendor-account/)
-   [Creare un conto bancario fornitore](http://ax.help.dynamics.com/en/wiki/create-a-vendor-bank-account/)
-   [Ricerca di fornitori](http://ax.help.dynamics.com/en/wiki/search-for-vendors/)
-   [Approvare fornitori per prodotti specifici](http://ax.help.dynamics.com/en/wiki/approve-vendors-for-specific-products/)
...
-   [Creare un catalogo di approvvigionamento](http://ax.help.dynamics.com/en/wiki/create-a-procurement-catalog/)
...
-   [Impostare una gerarchia di categorie di approvvigionamento](http://ax.help.dynamics.com/en/wiki/set-up-a-procurement-category-hierarchy/)
-   [Impostare criteri per le gerarchie di categorie di approvvigionamento](http://ax.help.dynamics.com/en/wiki/set-up-policies-for-procurement-category-hierarchies/)
-   [Approvare i fornitori per categorie specifiche di approvvigionamento](http://ax.help.dynamics.com/en/wiki/approve-vendors-for-specific-procurement-categories/)
...
-   [Creazione di un ordine fornitore](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order/)
-   [Creare un ordine fornitore ripetuto](http://ax.help.dynamics.com/en/wiki/create-a-repeat-purchase-order/)
-   [Creare un ordine fornitore da un ordine cliente](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-from-a-sales-order/)
-   [Creare un ordine fornitore per un fornitore occasionale](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-for-a-one-time-supplier/)
-   [Creare un ordine fornitore con una programmazione consegna](http://ax.help.dynamics.com/en/wiki/create-a-purchase-order-with-a-delivery-schedule/)
-   [Creare un ordine di reso acquisti](http://ax.help.dynamics.com/en/wiki/create-a-purchase-return-order/)
-   [Creare un ordine fornitore di rilascio da un contratto di acquisto](http://ax.help.dynamics.com/en/wiki/create-a-purchase-release-order-from-a-purchase-agreement/)
-   [Creare un ordine di rilascio acquisto per creare l'ordine fornitore](http://ax.help.dynamics.com/en/wiki/create-a-purchase-release-order-when-creating-the-purchase-order/)
-   [Creare un nuovo ordine di rifornimento spedizione](http://ax.help.dynamics.com/en/wiki/create-a-consignment-replenishment-order/)

## <a name="prices-and-discounts"></a>Prezzi e sconti
-   [Contratti di acquisto](purchase-agreements.md)
-   [Creare un contratto di acquisto](http://ax.help.dynamics.com/en/wiki/create-a-purchase-agreement/)
...
-   [Registrare l'entrata di merci sull'ordine fornitore](http://ax.help.dynamics.com/en/wiki/record-receipt-of-goods-on-a-purchase-order/)
...
-   [Creazione di criteri di acquisto](http://ax.help.dynamics.com/en/wiki/create-purchasing-policies/)
