...
| Azione                                                                                                        | Stato e versione                                                                                                                                                                                                                                                                                                                                                                          |
|---------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| La versione iniziale dell'ordine fornitore viene creata in Dynamics AX.                                                      | Lo stato è **Bozza**.                                                                                                                                                                                                                                                                                                                                                                    |
...
| L'ordine fornitore viene inviato al portale fornitore                                                                           | La versione viene registrata nel portale e lo stato passa a **In revisione esterna**.                                                                                                                                                                                                                                                                                        |
...
| Si invia la nuova versione dell'ordine fornitore nel portale fornitori.                                                      | La nuova versione viene registrata nel portale e lo stato passa a **In revisione esterna**.                                                                                                                                                                                                                                                                                    |
