...
- **CustomerGroupId** deve essere aggiornato con un valore valido in Finance and Operations. È possibile specificare un valore predefinito oppure è possibile impostare il valore utilizzando una mappa di valori. Il valore del modello predefinito è **10**.
- **Codice paese-regione indirizzo** è obbligatorio in Finance and Operations. Per evitare errori di sincronizzazione, è possibile specificare un valore predefinito. Tale valore predefinito viene quindi utilizzato se il campo viene lasciato vuoto in Sales.
...
[Sincronizzare le intestazioni e le righe di offerte di vendita da Sales a Finance and Operations](sales-quotation-template-mapping.md)
