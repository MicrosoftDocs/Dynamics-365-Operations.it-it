...
-   Assicurarsi che i **Decimali supportati** per l'UDM corrispondano ai requisiti in **CDS -\> destinazione**. Se occorrono valori diversi per UDM, è possibile impostarli con **ValueMap** da Unità, ad esempio [Ogni: 0] & [Sterlina: 2].

    -   Il valore predefinito del modello è 0.
