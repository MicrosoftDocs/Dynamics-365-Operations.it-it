...
| Compito                                                        | descrizione                                                                                                                                                                                                                                                                                                                                                                                        |
|-------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Creare una rappresentazione generale prodotto.                                    | Creare una rappresentazione generale prodotto nell'elenco **Rappresentazione generale prodotto**. Rilascio della rappresentazione generale prodotto a tutte le società corrispondenti. Per una rappresentazione generale prodotto utilizzata come rilascio per un modello di configurazione prodotto o come sottocomponente, ** configurazione basata su vincoli ** deve essere selezionata la tecnologia di configurazione e la dimensione di configurazione deve essere selezionati solo per il gruppo di dimensioni prodotto. |
