...
[Creare una nomenclatura di numero prodotto per le varianti prodotto predefinite](http://ax.help.dynamics.com/en/wiki/create-a-product-number-nomenclature-for-predefined-product-variants/)

[Creare una nomenclatura di numero prodotto per le varianti prodotto configurate](http://ax.help.dynamics.com/en/wiki/create-a-product-number-nomenclature-for-configured-product-variants/)
