...
| Termine                          | descrizione                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|-------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Esecuzione produzione       | Funzione utilizzata per registrare il tempo, consumo di materiali, i costi ai processi di produzione, progetti e attività indirette. La registrazione viene effettuata tramite un client di registrazione di esecuzione produzione.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
-   ** Le commissioni di progetto di registro e gli articoli di progetto ** (disponibile nel modulo Orario e presenze) - lavoratori possono registrare le commissioni (spese) associate a un progetto in un giornale di registrazione commissioni progetto, ad esempio carburante e pedaggi autostradali. I lavoratori possono registrare il consumo per articolo nei progetti. In tal caso viene utilizzato un giornale di registrazione articoli progetto.
