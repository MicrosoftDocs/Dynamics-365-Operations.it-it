...
[Impostare una voce di menu del dispositivo mobile per ultimare i lavori di tipo ordine acquisto (guida attività)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu)

[Impostare una voce di menu del dispositivo mobile per registrare gli articoli ricevuti (guida attività)](/dynamics365/unified-operations/supply-chain/warehousing/tasks/set-up-mobile-device-menu-item-register-received-items)
