...
Quando i clienti effettuano un pagamento parziale, possono pianificare di effettuare un pagamento parziale aggiuntivo per liquidare interamente la fattura. Per ottenere uno sconto di cassa per un pagamento parziale, è necessario impostare ** calcolare gli sconti di cassa per i pagamenti parziali ** l'opzione ** Sì ** ** parametri di contabilità clienti ** nella pagina. 
...
I clienti possono effettuare un pagamento parziale in cui l'importo rimanente non verrà pagato ma è superiore a quello di pagamento specificato ** parametri di conto da pagare ** nella pagina. Se si desidera contrassegnare la fattura come completamente liquidata, è possibile utilizzare ** liquidazione completa ** l'opzione ** transazione liquidati ** nella pagina. È possibile attivare la funzionalità di liquidazione completa utilizzando una chiave di configurazione. Ad esempio, una fattura viene registrata per 1.000,00 e il cliente effettua un pagamento di 990,00. E ha il quale non deve pagare i 10.00 rimanenti. Dopo aver si seleziona la fattura per la liquidazione, è inoltre possibile contrassegnare selezionato ** liquidazione completa **. La fattura verrà considerata interamente liquidata. La differenza di 10,00 verrà registrata in un conto dello sconto di cassa come ulteriore importo di sconto di cassa.
