...
L'impostazione dell'importazione dei rendiconti bancari varia a seconda del formato del rendiconto bancario elettronico. Microsoft Dynamics 365 per le operazioni sono supportati i formati di rendiconto bancario dalla casella: ISO20022, MT940 e BAI2.

## <a name="sample-files"></a>File di esempio
Per tutti e tre i formati, è necessario disporre di file che convertono il rendiconto bancario elettronico dal formato originale per un formato per Dynamics 365 per le operazioni può utilizzare. È possibile trovare i file di risorse necessari nel nodo **Risorse** in Application Explorer in Microsoft Visual Studio. Dopo avere individuato i file, copiarli in un'unica posizione nota in modo che sia possibile caricarli più facilmente durante il processo di impostazione.

| Nome risorsa                                           | Nome file                            |
|---------------------------------------------------------|--------------------------------------|
| BankStmtImport\_BAI2CSV xslt\_a\_BAI2XML\_              | BAI2CSV-to-BAI2XML.xslt              |
| BankStmtImport\_BAI2XML xslt\_a\_di riconciliazione\_       | BAI2XML-to-Reconciliation.xslt       |
| BankStmtImport\_a\_BankReconciliation xslt composito\_\_ | BankReconciliation-to-Composite.xslt |
...
| BankStmtImport\_MT940XML xslt\_a\_di riconciliazione\_      | MT940XML-to-Reconciliation.xslt      |
| Xml di BankStmtImport\_SampleBankCompositeEntity\_          | SampleBankCompositeEntity.xml        |
...
Di seguito sono inclusi esempi di definizioni tecniche layout di riconciliazione estratti conto avanzato del file di importazione e di tre file di esempio correlati di rendiconto bancario: https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/how-to-articles/exofbankstfotechlayouts  
...
1.  Va ** aree di lavoro ** &gt; ** la gestione dei dati **.
2.  Click **Import**.
...
10. Per il numero di sequenza 1, fare clic su **Carica file** e selezionare il file **ISO20022XML-to-Reconciliation.xslt** salvato in precedenza. ** Nota: ** Dynamics 365 per i file di trasformazione delle operazioni viene creata per il formato standard. Poiché le banche divergono spesso da questo formato, potrebbe essere necessario aggiornare il file di trasformazione per mappare al formato di rendiconto bancario. <!-- For details about the expected format for ISO20022, see [Dynamics AX ISO20022 Layout](./media/dynamicsaxiso20022layout1.xlsx).-->
11. Click **New**.
...
1.  Torna ai ** banche e la gestione ** &gt; ** l'impostazione ** &gt; ** riconciliazione estratti conto avanzata impostata ** &gt; ** formato di rendiconto bancario **.
2.  Click **New**.
...
1.  Vanno ** i banche e la gestione ** &gt; ** i conti bancari **.
...
12. Per il numero di sequenza 2, fare clic su **Carica file** e selezionare il file **MT940XML-to-Reconciliation.xslt** salvato in precedenza. ** Nota: ** Dynamics 365 per i file di trasformazione delle operazioni viene creata per il formato standard. Poiché le banche divergono spesso da questo formato, potrebbe essere necessario aggiornare il file di trasformazione per mappare al formato di rendiconto bancario. <!--- For details about the expected format for MT940, see [Dynamics AX MT940 Layout](./media/dynamicsaxmt940layout1.xlsx)-->
13. Click **New**.
...
11. Fare clic su **Nuovo**.
12. Per il numero di sequenza 2, fare clic su **Carica file** e selezionare il file **BAI2XML-to-Reconciliation.xslt** salvato in precedenza. ** Nota: ** Dynamics 365 per i file di trasformazione delle operazioni viene creata per il formato standard. Poiché le banche divergono spesso da questo formato e si potrebbe essere necessario aggiornare il file di trasformazione per mappare al formato di rendiconto bancario. <!--- For details about the expected format for BAI2, see [Dynamics AX BAI2 Layout](./media/dynamicsaxbai2layout1.xlsx).-->
13. Click **New**.
14. Per il numero di sequenza 3, fare clic su **Carica file** e selezionare il file **BankReconciliation-to-Composite.xslt** salvato in precedenza.
15. Fare clic su **Applica trasformazioni**.
