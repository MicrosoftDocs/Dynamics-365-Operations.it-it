---
title: Home page Gestione cassa e banche
...
-   [Panoramica sulla riconciliazione bancaria avanzata](advanced-bank-reconciliation-overview.md)
-   [Configure advanced bank reconciliation](configure-advanced-bank-reconciliation.md)
-   [Impostare l'importazione di riconciliazione bancaria avanzata](set-up-advanced-bank-reconciliation-import-process.md)
-   [Riconciliare rendiconti bancari utilizzando la riconciliazione bancaria avanzata](reconcile-bank-statements-advanced-bank-reconciliation.md)
-   [Impostare le regole di abbinamento della riconciliazione estratti conto](set-up-bank-reconciliation-matching-rules.md)
-   [Impostare pagamenti centralizzati](set-up-centralized-payments.md)
...
-   [Creare fatture fornitore mediante una proposta di pagamento (]. /accounts-payable/create-vendor-payments-payment-proposal.md)
...
-   [Panoramica delle fatture e pagamenti anticipati di pagamento anticipato (]. /accounts-payable/prepayments-invoices-vs-prepayments.md)
...
-   [Scenario: Gestione automatica sconto di cassa per le eccedenze (]. /cash-bank-management/cash-discount-handling-overpayments.md)
...
-   [Scenario: Utilizzare un pagamento cliente per liquidare la fattura più periodi di sconto più definizioni di fuso orario (portata]. /accounts-receivable/customer-payment-settle-multiple-invoices-multiple-discount-periods.md)
