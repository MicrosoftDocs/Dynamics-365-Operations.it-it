...
| Operazioni di configurazione correlate | Nella pagina **Intervalli date** impostare un intervallo di date utilizzato per calcolare la data di scadenza emissione fattura. Fare clic su ** contabilità generale ** &gt; ** contabilità generale impostata ** &gt; ** intervalli di date **). ** Parametri per il commercio estero ** nella pagina, impostare le proprietà del commercio estero di impostazione per diversi paesi. Fare clic su ** imposta ** &gt; ** impostazione ** &gt; ** commercio estero ** &gt; ** parametri per il commercio estero **). |
...
Per impostare Microsoft Dynamics 365 per le operazioni si desidera calcolare le date di scadenza dell'uscita della fattura per le spedizioni intra-ue il quindicesimo giorno del mese dopo il rifornimento viene consegnato, creare un codice intervallo date e una regola di calcolo con le seguenti impostazioni.
...
-   **Ordini cliente**: quando si crea un ordine cliente e si registra un documento di trasporto, la data di scadenza per l'emissione della fattura viene calcolata e aggiornata nel documento di trasporto. La data di scadenza viene calcolata in base all'intervallo di date associato al paese specificato nell'indirizzo di consegna dell'ordine cliente. Dopo aver registrato il documento di trasporto, è possibile verificare che la fine dell'uscita della fattura in ** libero la fine dell'uscita ** sistemi ** giornale di registrazione documenti di trasporto ** nella pagina. Fare clic su ** Vendite e marketing ** &gt; ** ordine cliente ** &gt; ** spedizione dell'ordine ** &gt; ** documento di trasporto **). È possibile visualizzare tutti i documenti di trasporto che non fatturate e le relative date di scadenza dell'uscita della fattura, ** documenti di trasporto non fatturati ** nella pagina. Fare clic su ** Vendite e marketing ** &gt; ** ordine cliente ** &gt; ** spedizione dell'ordine ** &gt; ** documenti di trasporto non fatturati **).
-   **Ordini acquisto**: quando si crea un ordine acquisto e si registra un'entrata prodotti, la data di scadenza per l'emissione della fattura viene calcolata e aggiornata all'entrata prodotti. La data di scadenza viene calcolata in base all'intervallo di date associato al paese specificato nell'indirizzo principale del fornitore. Dopo aver registrato l'entrata prodotti, è possibile verificare la data di scadenza emissione fattura nel campo **Data di scadenza emissione fattura** della pagina **Giornale di registrazione entrata prodotti**. Fare clic su ** Approvvigionamento ** &gt; ** ordini fornitore ** &gt; ** ricevono i prodotti ** &gt; ** entrata prodotti **). È possibile visualizzare tutte le entrate prodotti non fatturate e le relative date di scadenza dell'uscita della fattura, ** entrate prodotti non fatturate ** nella pagina. Fare clic su ** Approvvigionamento ** &gt; ** ordini fornitore ** &gt; ** ricevono i prodotti ** &gt; ** entrate prodotti non fatturate **).
...
<td>Fare <strong>Amministrazione sistema</strong> &gt; <strong>Impostazione</strong> &gt; <strong>Autorizzazione</strong> &gt; <strong>Configurazione licenza</strong>clic su. Fare clic sulla chiave di configurazione <strong>Contabilità generale</strong>.</td>
</tr>
<tr class="even">
