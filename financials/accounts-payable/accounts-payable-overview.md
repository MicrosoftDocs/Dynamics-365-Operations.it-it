...
description: "Questo articolo descrive le pagine utilizzate per impostare le funzionalità di base e facoltative per la contabilità fornitori in Microsoft Dynamics 365 for Operations. Vengono descritti i passaggi di configurazione da completare prima di iniziare a impostare la contabilità fornitori."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Questo articolo descrive le pagine utilizzate per impostare le funzionalità di base e facoltative per la contabilità fornitori in Microsoft Dynamics 365 for Operations. Vengono descritti i passaggi di configurazione da completare prima di iniziare a impostare la contabilità fornitori.
