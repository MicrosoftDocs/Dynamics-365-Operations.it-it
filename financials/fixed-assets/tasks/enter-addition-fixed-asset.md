...
8. Impostare la data di acquisto o del servizio del componente aggiuntivo.
9. Immettere il costo dell'articolo, della manutenzione o di un altro miglioramento per il cespite.
10. Nel campo Quantità immettere un numero.
    * Il costo totale non avrà impatto sul valore del cespite e viene fornito solo per tenere traccia e per scopi informativi. Se il costo verrà capitalizzato, una transazione di rettifica di rivalutazione deve essere registrata separatamente.  
11. Fare clic sulla scheda Generale.
    * Impostare Aumenta la vita utile se il componente aggiuntivo aumenta la vita utile del cespite.  
