...
> [!NOTE]
> In genere, quando l'importo calcolato utilizzando i 150% metodi di ammortamento a saldi decrescenti diventa inferiore all'importo che viene calcolato utilizzando il metodo a quote costanti, è presente una conversione al metodo a quote costanti per la vita utile rimanente.
