...
Nella mappa di apprendimento vengono visualizzati i concetti e le attività principali con i binari di raccordo tra le attività correlate per descrivere la natura del modulo Contabilità industriale.

![Mappa di apprendimento per la contabilità industriale](./media/cost-accounting-map.png)

## <a name="get-started-videos"></a>Video introduttivi
