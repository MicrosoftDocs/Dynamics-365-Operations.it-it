...
ms.locfileid: "1865018"
---
# <a name="electronic-signatures-overview"></a>Panoramica delle firme elettroniche
...
> [!NOTE]
> Finance and Operations utilizza le funzionalità di Microsoft SQL Server per creare certificati e abilitare la firma elettronica. Non è richiesto alcun certificato aggiuntivo o infrastruttura a chiave pubblica (PKI).
