...
---
# <a name="create-operating-units"></a>Creare unità operative
...
1. Fare clic su Amministrazione organizzazione > Organizzazioni > Unità operative.
2. Fare clic su Nuovo per aprire la finestra di dialogo a discesa.
3. Nell'elenco trovare e selezionare il record desiderato.
    * Selezionare il tipo di unità operativa che si desidera creare.  
