...
## <a name="select-which-bookmarks-to-use-in-your-email-templates"></a>Selezionare i segnalibri da utilizzare nei modelli di messaggio di posta elettronica
1. Andare a Segnalibri per domande di lavoro.
2. Nell'elenco trovare e selezionare l'azione di corrispondenza desiderata.
3. Fare clic su Modifica.
4. Nell'elenco trovare e selezionare il record desiderato.
    * Selezionare i campi da utilizzare in un modello di messaggio di posta elettronica per l'azione di corrispondenza selezionata e spostarli nei campi di segnalibro.  
5. Chiudere la pagina.

## <a name="create-an-email-template"></a>Creare un modello di messaggio di posta elettronica
1. Andare a Risorse umane > Selezione del personale > Comunicazioni > Modelli di messaggio di posta elettronica per domande di lavoro.
2. Fare clic su Nuovo.
3. Nel campo Azione corrispondenza selezionare "Colloquio".
    * Selezionare l'azione di corrispondenza che contiene i segnalibri da utilizzare per questo tipo di comunicazione di posta elettronica.  
4. Digitare un valore nel campo Modello di messaggio di posta elettronica.
5. Digitare un valore nel campo Oggetto.
6. Digitare un valore nel campo Testo.
7. Trovare e selezionare il campo segnalibro desiderato nell'elenco.
8. Continuare a immettere il messaggio di posta elettronica inserendo i campi segnalibro necessari.
    * Continuare a immettere il messaggio di posta elettronica inserendo i campi segnalibro dove si desidera.  
