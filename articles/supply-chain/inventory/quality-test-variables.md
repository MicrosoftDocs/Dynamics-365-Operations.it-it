---
title: Variabili dei test per la gestione della qualità
description: Questo articolo descrive come creare variabili di test che possano essere utilizzati per i test qualitativi in ordini di controllo qualità in Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857636"
---
# <a name="quality-management-test-variables"></a>Variabili dei test per la gestione della qualità

[!include [banner](../includes/banner.md)]

Questo articolo descrive come creare variabili di test che possano essere utilizzati per i test qualitativi in ordini di controllo qualità in Microsoft Dynamics 365 Supply Chain Management.
