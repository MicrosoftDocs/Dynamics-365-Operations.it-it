...
description: In questo articolo viene fornita una panoramica del processo in uscita in Gestione articoli.
author: yufeihuang
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8852478"
---
# <a name="outbound-process-overview"></a>Panoramica del processo in uscita

[!include [banner](../includes/banner.md)]

In questo articolo viene fornita una panoramica del processo in uscita in Gestione articoli.
