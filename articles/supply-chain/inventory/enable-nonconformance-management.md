...
[Creare ed elaborare una non conformità (guida attività)](/dynamics365/unified-operations/supply-chain/inventory/tasks/create-process-non-conformance)

[Processi di gestione qualità](quality-management-processes.md)

[Impostare prerequisiti per la gestione di non conformità (guida attività)](/dynamics365/unified-operations/supply-chain/inventory/tasks/set-up-prerequisites-nonconformance-management)
