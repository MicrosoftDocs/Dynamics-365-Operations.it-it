---
title: Test per la gestione della qualità
description: Questo articolo descrive come creare test che possano essere utilizzati per gli ordini di controllo qualità in Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857607"
---
# <a name="quality-management-tests"></a>Test per la gestione della qualità

[!include [banner](../includes/banner.md)]

Questo articolo descrive come creare test che possano essere utilizzati per gli ordini di controllo qualità in Microsoft Dynamics 365 Supply Chain Management.
