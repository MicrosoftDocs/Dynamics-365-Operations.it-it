...
description: In questo articolo viene descritto come trovare e utilizzare vari tipi di richieste di informazioni disponibili per il modulo Costo sbarcato.
author: Weijiesa
ms.date: 02/01/2021
ms.topic: article
ms.prod: ''
