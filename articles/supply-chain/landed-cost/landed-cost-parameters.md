...
description: In questo articolo viene descritto come definire impostazioni di configurazione e relative a informazioni utilizzate nel modulo Costo sbarcato per registrazione, aggiornamenti dello stato, sequenze numeriche e comportamento.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
