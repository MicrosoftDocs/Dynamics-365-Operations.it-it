...
description: In questo articolo viene descritto come impostare le informazioni di consegna per il modulo Costo sbarcato.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8895614"
---
# <a name="delivery-information-setup"></a>Impostazione informazioni di consegna

[!include [banner](../../includes/banner.md)]

In questo articolo viene descritto come impostare le informazioni di consegna per il modulo **Costo di spedizione**.
