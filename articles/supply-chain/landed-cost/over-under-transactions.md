...
description: Questo articolo fornisce informazioni che consentono di impostare i dettagli dei criteri relativi alle transazioni in eccesso/in difetto, di modo che il sistema possa determinare come gestire l'elaborazione in eccesso e in difetto delle merci al momento del ricevimento.
author: Weijiesa
ms.date: 01/13/2021
ms.topic: article
ms.prod: ''
