...
description: Questo argomento fornisce informazioni sulle entità fattura fornitore, che consentono di configurare i codici del tipo di costo per i costi interni o per i costi derivati esternamente.
author: yufeihuang
ms.date: 05/27/2022
ms.topic: article
ms.search.form: ''
