...
description: In questo articolo viene descritto come impostare i gruppi di gestione degli sconti. I gruppi di gestione degli sconti possono essere utilizzati durante i calcoli degli sconti e possono essere allegati a un record di dati master.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
