---
title: Principi di riduzione sconti
description: In questo articolo viene descritto come impostare i principi di riduzione. I principi di riduzione controllano il comportamento quando più sconti si applicano allo stesso articolo o transazione.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
