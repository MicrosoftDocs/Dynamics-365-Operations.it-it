...
Nella tabella seguente sono elencati i ruoli di sicurezza predefiniti che possono accedere ai fogli di calcolo dei costi, incluso il livello di accesso concesso a ciascun ruolo dalle impostazioni predefinite.

| Ruolo | Accesso
|---|---|
| Direttore amministrativo | Modifica |
| Addetto contabilità inventario | Visualizza |
| Contabile inventario | Visualizza |
