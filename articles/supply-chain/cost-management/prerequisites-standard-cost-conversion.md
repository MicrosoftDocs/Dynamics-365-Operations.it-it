...
description: In questo articolo vengono illustrate le attività da completare prima di eseguire una conversione in costo standard.
author: JennySong-SH
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8887560"
---
# <a name="prerequisites-for-a-standard-cost-conversion"></a>Prerequisiti per la conversione in costo standard

[!include [banner](../includes/banner.md)]

In questo articolo vengono illustrate le attività da completare prima di eseguire una conversione in costo standard. 
