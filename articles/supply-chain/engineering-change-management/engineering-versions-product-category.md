...
description: Questo articolo fornisce informazioni sul concetto di versioni di progettazione. Le versioni di progettazione garantiscono che i diversi stati di un prodotto e dei dati siano aggiornati e cancellati e che possano essere visualizzati nel sistema.
author: t-benebo
ms.date: 04/07/2022
ms.topic: article
ms.prod: ''
