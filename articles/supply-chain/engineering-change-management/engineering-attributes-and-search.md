...
#### <a name="turn-engineering-attribute-inheritance-on-or-off"></a>Attivare o disattivare l'ereditarietà degli attributi di progettazione

Questa funzionalità richiede che entrambe le funzionalità *Gestione modifiche di progettazione* ed *Ereditarietà degli attributi migliorata per la gestione modifiche di progettazione* siano attivate per il sistema. Per dettagli su come attivare o disattivare queste funzionalità, vedere [Panoramica della gestione delle modifiche di progettazione](product-engineering-overview.md).
