...
5. Selezionare un'opzione nel campo Tipo di gerarchia di categorie.
    * Selezionare il tipo Gerarchia di codici di voce doganale per la classificazione di prodotto.  
