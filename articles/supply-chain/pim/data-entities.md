...
description: Questo articolo fornisce informazioni sulle diverse entità che possono essere utilizzate per importare ed esportare i dati di prodotto.
author: t-benebo
ms.date: 01/07/2020
ms.topic: article
ms.prod: ''
