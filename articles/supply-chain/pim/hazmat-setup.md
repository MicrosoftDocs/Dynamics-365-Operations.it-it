...
description: Questo articolo spiega come impostare i dati necessari per classificare gli articoli come materiali pericolosi. Quando crei un ordine cliente che include un articolo classificato come materiale pericoloso, il sistema genera la documentazione relativa ai materiali pericolosi per l'ordine cliente quando viene spedito.
author: t-benebo
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
