...
description: In questo articolo viene descritto come gestire le traduzioni per i prodotti, i valori di dimensione prodotto e gli attributi del prodotto.
author: t-benebo
ms.date: 08/06/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9015408"
---
# <a name="product-related-translations-faq"></a>Domande frequenti sulle traduzioni relative ai prodotti

[!include [banner](../includes/banner.md)]

In questo articolo viene descritto come gestire le traduzioni per i prodotti, i valori di dimensione prodotto e gli attributi del prodotto. 
