...
description: In questo articolo viene descritto il controllo dei costi relativi agli errori di cespite in Gestione cespiti.
...
Per informazioni su come impostare gli errori, fare riferimento all'articolo [Gestione errori](../setup-for-work-orders/fault-management.md).
