...
>[!NOTE]
>Per tutti e tre i tipi di registrazione, viene convalidata la combinazione di dimensioni finanziarie e le combinazioni non valide vengono lasciate vuote. Questa è una configurazione standard con altre app per la finanza e le operazioni.
