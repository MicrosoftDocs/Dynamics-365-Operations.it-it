...
7. Dopo aver registrato i giornali di registrazione del consumo, è possibile aggiornare lo stato del ciclo di vita di ordine di lavoro, ad esempio a "Finito", per indicare che l'ordine di lavoro è stato completato.

- Nel campo **Mostra** situato nella parte superiore della pagina **Giornali di registrazione ordine di lavoro**, selezionare le righe dei giornali di registrazione che si desidera visualizzare: Tutto, Non registrato o Registrato. I giornali di registrazione registrati presentano un segno di spunta nella casella di controllo **Registrato**.  
