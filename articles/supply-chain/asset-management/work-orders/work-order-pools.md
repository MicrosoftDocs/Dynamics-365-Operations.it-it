...
description: In questo articolo viene descritto come utilizzare pool di ordini di lavoro in Gestione cespiti.
...
1. Seleziona **Gestione cespiti** > **Pool di ordini di lavoro** > **Tutti i pool di ordini di lavoro** o **Pool di ordini di lavoro attivi**.
