...
- Quando un tipo di processo è stato utilizzato l'ultima volta su un cespite
- Quando un lavoratore specifico ha immesso un'osservazione in un processo di ordine di lavoro

La sequenza temporale viene aggiornata ogni volta che la pagina viene aperta. Sono incluse le seguenti informazioni:

- Modifiche eseguite al cespite: l'ubicazione del cespite, ID del cespite, nome e garanzia fornitore
- Cespite padre
- Distinta base (DBA) del cespite
- Registro degli stati del ciclo di vita cespite
- Unità funzionale
