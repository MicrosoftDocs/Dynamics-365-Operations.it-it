...
1. Selezionare **Gestione cespiti** \> **Richieste di informazioni** \> **Cespiti** \> **Panoramica attributi cespiti**.
2. Nel campo **Tipo di cespite**, selezionare un tipo di cespite.
