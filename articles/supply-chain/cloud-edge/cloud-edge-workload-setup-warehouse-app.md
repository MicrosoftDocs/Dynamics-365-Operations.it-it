...
description: Questo argomento spiega come configurare le app per dispositivi mobili Warehouse Management per i magazzini serviti da un'unità di scala cloud o perimetrale.
author: perlynne
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
...
Questo argomento spiega come configurare le app per dispositivi mobili Warehouse Management in modo da poter essere utilizzate nei magazzini serviti da un'unità di scala cloud o perimetrale.
