...
description: Questo articolo spiega come creare account utente del portale clienti e impostare le relative autorizzazioni.
author: Henrikan
ms.date: 07/31/2020
ms.topic: article
ms.prod: ''
...
Il video su come [invitare i clienti a registrarsi e utilizzare il portale per i clienti](https://youtu.be/drGUYHX9QIQ) (mostrato in precedenza) è incluso nella [playlist delle app per la finanza e le operazioni](https://www.youtube.com/playlist?list=PLcakwueIHoT_SYfIaPGoOhloFoCXiUSyW) disponibile su YouTube.
