...
description: L'articolo descrive i modelli e le attività sottostanti che vengono utilizzati per sincronizzare le righe e le intestazioni delle fatture di vendita direttamente da Dynamics 365 Supply Chain Management a Dynamics 365 Sales.
author: Henrikan
ms.date: 10/26/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9103277"
---
# <a name="synchronize-sales-invoice-headers-and-lines-directly-from-finance-and-operations-to-sales"></a>Sincronizzare intestazioni e righe di fatture di vendita direttamente dalle app per la finanza e le operazioni alla vendita

[!include [banner](../includes/banner.md)]

L'articolo descrive i modelli e le attività sottostanti che vengono utilizzati per sincronizzare le righe e le intestazioni delle fatture di vendita direttamente da Dynamics 365 Supply Chain Management a Dynamics 365 Sales.
