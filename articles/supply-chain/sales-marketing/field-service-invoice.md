...
description: Questo articolo descrive i modelli e le attività sottostanti utilizzati per sincronizzare le fatture di contratto in Dynamics 365 Field Service con le fatture a testo libero in Dynamics 365 Supply Chain Management.
author: Henrikan
ms.date: 04/10/2018
ms.topic: article
ms.prod: ''
...
Questo articolo descrive i modelli e le attività sottostanti che vengono utilizzati per sincronizzare le fatture di contratto in Dynamics 365 Field Service con le fatture a testo libero in Dynamics 365 Supply Chain Management.
...
[![Mapping modello in Integrazione dati per le intestazioni delle fatture.](./media/FSFreeTextInvoice1.png)](./media/FSFreeTextInvoice1.png)
...
[![Mapping modello in Integrazione dati per le righe delle fatture.](./media/FSFreeTextInvoice2.png)](./media/FSFreeTextInvoice2.png)
