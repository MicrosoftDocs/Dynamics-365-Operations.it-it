...
description: In questo articolo viene descritto un flusso di lavoro che consente la registrazione del consumo di materie prime nella produzione tramite un dispositivo portatile.
...
In questo articolo viene descritto un flusso di lavoro che consente la registrazione del consumo di materie prime nella produzione tramite un dispositivo portatile.
