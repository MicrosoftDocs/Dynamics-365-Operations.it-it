...
## <a name="create-property"></a>Proprietà Create
1. Fare clic su Nuovo.
2. Digitare un valore nel campo Proprietà.
3. Digitare un valore nel campo Nome.

## <a name="create-property-values"></a>Valori della proprietà Create
