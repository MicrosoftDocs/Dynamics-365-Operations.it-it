...
Nella figura seguente, (a) è la DBA per il prodotto H e le parti F e G e (b) è la scheda cicli di lavorazione per i prodotti H e la parte F.

![Esempio di struttura DBA su due livelli.](media/product-H-part-F.png)
...
![La DBA progettazione per il prodotto H.](media/product-H-part-B.png)
...
![Il tipo di voce fittizia utilizzato in strutture DBA multilivello.](media/product-G-route-sheet-G.png)
...
![Esempio di una rete di cicli di lavorazione utilizzata in una DBA multilivello.](media/product-G-part-F.png)
...
![La DBA per il prodotto G e la parte F e il foglio del ciclo di lavorazione per il prodotto G e la parte F.](media/product-G-part-F-with-route-sheet.png)
