...
È possibile impostare i codici smaltimento per specificare la modalità di elaborazione di un articolo che viene restituito da un cliente. Ad esempio, è possibile creare un codice smaltimento denominato **Riparazione e reso** per indicare che il reso verrà riparato e verrà restituito al cliente. Per ulteriori esempi dei codici smaltimento che in genere vengono utilizzati per gli articoli restituiti dai clienti, vedere [Specificare la modalità di smaltimento dei resi](specify-how-to-dispose-of-returned-items.md).
...
[Codici smaltimento e codici motivo reso](disposition-and-return-reason-codes.md)

[Codici smaltimento (modulo)](https://technet.microsoft.com/en-us/library/hh597113\(v=ax.60\))

[Spese varie automatiche (modulo)](https://technet.microsoft.com/en-us/library/aa582856\(v=ax.60\))

[Codici esterni (modulo)](https://technet.microsoft.com/en-us/library/aa583814\(v=ax.60\))
