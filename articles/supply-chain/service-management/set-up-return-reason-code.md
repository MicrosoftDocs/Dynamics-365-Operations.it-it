...
4.  Nel campo **Descrizione** digitare una frase descrittiva dell'uso previsto per il gruppo.
...
3.  Nel campo **Codice motivo reso** immettere il testo per identificare questo.

4.  Nel campo **Descrizione** immettere il testo descrittivo del codice motivo reso.

5.  Utilizzare l'elenco a discesa **Gruppo di codici motivo reso** per aggiungere il codice a un gruppo di codici motivo reso.

## <a name="see-also"></a>Vedere anche

[Gruppi codici motivo reso (modulo)](https://technet.microsoft.com/en-us/library/hh209604\(v=ax.60\))

[Codici motivo reso (modulo)](https://technet.microsoft.com/en-us/library/hh227372\(v=ax.60\))
