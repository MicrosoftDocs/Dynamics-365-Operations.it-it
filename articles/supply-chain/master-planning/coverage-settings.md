...
description: In questo articolo vengono fornite informazioni sulle impostazioni di copertura utilizzate dalla programmazione generale per calcolare le richieste articolo.
author: t-benebo
ms.date: 09/13/2019
ms.topic: article
ms.prod: ''
