...
description: Questo articolo spiega come escludere i prodotti in base al loro stato del ciclo di vita quando viene utilizzata la funzionalità Ottimizzazione pianificazione.
author: t-benebo
ms.date: 11/13/2020
ms.topic: article
ms.prod: ''
