...
description: In questo articolo viene descritto come viene pianificato un articolo con dimensione sito come copertura. La dimensione magazzino è obbligatoria.
author: t-benebo
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
In questo articolo viene descritto come viene pianificato un articolo con dimensione sito come copertura. La dimensione magazzino è obbligatoria.
