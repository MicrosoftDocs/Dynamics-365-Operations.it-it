...
description: In questo articolo viene descritto come configurare un dispositivo mobile per visualizzare un elenco di ubicazioni con batch meno recenti rispetto a quelli dell'ubicazione corrente di una riga di lavoro.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
