...
|---|---|
| Elemento | Gli articoli devono essere abilitati per i processi di gestione del magazzino (WMS).<p>**Nota:** gli articoli abilitati per il peso variabile non possono essere inclusi nei processi di cross-docking.</p> |
| Magazzino | Il magazzino deve essere abilitato per i processi di gestione del magazzino (WMS). |
