...
### <a name="set-up-a-wave-template"></a><span data-ttu-id="a086c-123">Impostare un modello di ondata</span><span class="sxs-lookup"><span data-stu-id="a086c-123">Set up a wave template</span></span>
...
1. <span data-ttu-id="a086c-139">Nella Scheda dettaglio **Utenti** , selezionare **Nuovo** per creare un account per dispositivo mobile e impostarne i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-139">On the **Users** FastTab, select **New** to create a mobile device account, and set the following values for it:</span></span>
    ...
    - <span data-ttu-id="a086c-140">**ID utente:** immettere un ID univoco.</span><span class="sxs-lookup"><span data-stu-id="a086c-140">**User ID:** Enter a unique ID.</span></span>
...
1. <span data-ttu-id="a086c-158">Fare clic su **Gestione magazzino \> Impostazione \> Parametri di gestione magazzino**.</span><span class="sxs-lookup"><span data-stu-id="a086c-158">Go to **Warehouse management \> Setup \> Warehouse management parameters**.</span></span>
...
1. <span data-ttu-id="a086c-174">Vai a **Gestione magazzino \> Impostazione \> Magazzino \> Ubicazioni**.</span><span class="sxs-lookup"><span data-stu-id="a086c-174">Go to **Warehouse management \> Setup \> Warehouse \> Locations**.</span></span>
...
1. <span data-ttu-id="a086c-192">Nella Scheda dettaglio **Generale** , imposta i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-192">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="a086c-202">Nella finestra di dialogo dell'editor di query, nella scheda **Ordinamento** , aggiungere una riga con i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-202">In the query editor, on the **Sorting** tab, add a line that has the following values:</span></span>
    ...
    - <span data-ttu-id="a086c-209">**Direzione di ricerca:** *Crescente*</span><span class="sxs-lookup"><span data-stu-id="a086c-209">**Search direction:** *Ascending*</span></span>
...
1. <span data-ttu-id="a086c-226">Nella Scheda dettaglio **Panoramica** , impostare i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-226">On the **Overview** FastTab, set the following values:</span></span>
...
### <a name="set-up-work-classes"></a><span data-ttu-id="a086c-244">Impostare classi di lavoro</span><span class="sxs-lookup"><span data-stu-id="a086c-244">Set up work classes</span></span>
...
1. <span data-ttu-id="a086c-262">Nella Scheda dettaglio **Generale** , imposta i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-262">On the **General** FastTab, set the following values:</span></span>
...
1. <span data-ttu-id="a086c-279">Nella Scheda dettaglio **Classi di lavoro** , selezionare **Nuovo** , quindi impostare i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-279">On the **Work classes** FastTab, select **New** , and then set the following values:</span></span>
    ...
    - <span data-ttu-id="a086c-280">**ID classe lavoro:** *ORDINAMENTO*</span><span class="sxs-lookup"><span data-stu-id="a086c-280">**Work class ID:** *SORT*</span></span>
...
#### <a name="set-up-a-single-sku-directive"></a><span data-ttu-id="a086c-296">Configurare una direttiva per una singola SKU</span><span class="sxs-lookup"><span data-stu-id="a086c-296">Set up a single-SKU directive</span></span>
...
1. <span data-ttu-id="a086c-315">Nella Scheda dettaglio **Azioni direttiva ubicazione** , selezionare **Nuovo** , quindi impostare i seguenti valori per la nuova riga.</span><span class="sxs-lookup"><span data-stu-id="a086c-315">On the **Location Directive Actions** FastTab, select **New** , and then set the following values on the new line.</span></span> <span data-ttu-id="a086c-316">Accettare i valori predefiniti per tutti gli altri campi.</span><span class="sxs-lookup"><span data-stu-id="a086c-316">Accept the default values for all the other fields.</span></span>
    ...
    - <span data-ttu-id="a086c-317">**Sequenza:** *1*</span><span class="sxs-lookup"><span data-stu-id="a086c-317">**Sequence:** *1*</span></span>
...
1. <span data-ttu-id="a086c-336">Selezionare **Salva** per rendere disponibile la barra degli strumenti nella Scheda dettaglio **Righe**.</span><span class="sxs-lookup"><span data-stu-id="a086c-336">Select **Save** to make the toolbar on the **Lines** FastTab available.</span></span>
...
1. <span data-ttu-id="a086c-353">Accedere a **Gestione magazzino \> Impostazione \> Lavoro \> Modelli di lavoro**.</span><span class="sxs-lookup"><span data-stu-id="a086c-353">Go to **Warehouse management \> Setup \> Work \> Work templates**.</span></span>
...
### <a name="create-sales-orders-and-picking-work"></a><span data-ttu-id="a086c-371">Creare ordini cliente e lavoro di prelievo</span><span class="sxs-lookup"><span data-stu-id="a086c-371">Create sales orders and picking work</span></span>
...
1. <span data-ttu-id="a086c-407">Nella scheda dettaglio **Dettagli riga** , nella scheda **Consegna** , impostare il campo **Modalità di consegna** su *Flowe-STD*.</span><span class="sxs-lookup"><span data-stu-id="a086c-407">On the **Line details** FastTab, on the **Delivery** tab, set the **Mode of delivery** field to *Flowe-STD*.</span></span>
...
#### <a name="get-the-work-ids-from-the-work-details"></a><span data-ttu-id="a086c-423">Ottenere gli ID lavoro dai dettagli del lavoro</span><span class="sxs-lookup"><span data-stu-id="a086c-423">Get the work IDs from the work details</span></span>
...
1. <span data-ttu-id="a086c-479">Accettare tutte le impostazioni predefinite e selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-479">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="a086c-480">Prendere nota dell'ID contenitore.</span><span class="sxs-lookup"><span data-stu-id="a086c-480">Make a note of the container ID.</span></span>
...
1. <span data-ttu-id="a086c-489">Nel riquadro azioni selezionare **Nuovo contenitore**.</span><span class="sxs-lookup"><span data-stu-id="a086c-489">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="a086c-490">Accettare tutte le impostazioni predefinite e selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-490">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="a086c-491">Prendere nota dell'ID contenitore.</span><span class="sxs-lookup"><span data-stu-id="a086c-491">Make a note of the container ID.</span></span>
1. <span data-ttu-id="a086c-492">Nella Scheda dettaglio **Imballaggio articolo** , impostare i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-492">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="a086c-493">**Quantità:** *1*</span><span class="sxs-lookup"><span data-stu-id="a086c-493">**Quantity:** *1*</span></span>
    - <span data-ttu-id="a086c-494">**Identificatore:** articolo *A0001*</span><span class="sxs-lookup"><span data-stu-id="a086c-494">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="a086c-495">Nel riquadro azioni selezionare **Chiudi contenitore**.</span><span class="sxs-lookup"><span data-stu-id="a086c-495">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="a086c-496">Nella finestra di dialogo **Chiudi contenitore** , selezionare **Ottieni peso sistema** di modo che il sistema aggiorni il campo **Peso lordo**.</span><span class="sxs-lookup"><span data-stu-id="a086c-496">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="a086c-497">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-497">Select **OK**.</span></span> <span data-ttu-id="a086c-498">Il contenitore viene spostato nell'ubicazione *ORDINAMENTO* ed è pronto per l'ordinamento.</span><span class="sxs-lookup"><span data-stu-id="a086c-498">The container is moved to the *SORT* location and is ready for sorting.</span></span>

#### <a name="pack-sales-order-2-into-containers"></a><span data-ttu-id="a086c-499">Imballare l'ordine cliente 2 in contenitori</span><span class="sxs-lookup"><span data-stu-id="a086c-499">Pack sales order 2 into containers</span></span>

1. <span data-ttu-id="a086c-500">Nella pagina **Imballaggio** , nel campo **Targa o spedizione** , immettere la targa di destinazione per la riga 1 dell'ordine cliente 2.</span><span class="sxs-lookup"><span data-stu-id="a086c-500">On the **Pack** page, in the **License plate or shipment** field, enter the target LP for line 1 of sales order 2.</span></span> <span data-ttu-id="a086c-501">Quindi premere il tasto **TAB** o **INVIO** della tastiera per uscire dal campo.</span><span class="sxs-lookup"><span data-stu-id="a086c-501">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="a086c-502">Nel riquadro azioni selezionare **Nuovo contenitore**.</span><span class="sxs-lookup"><span data-stu-id="a086c-502">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="a086c-503">Accettare tutte le impostazioni predefinite e selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-503">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="a086c-504">Prendere nota dell'ID contenitore.</span><span class="sxs-lookup"><span data-stu-id="a086c-504">Make a note of the container ID.</span></span>
1. <span data-ttu-id="a086c-505">Nella Scheda dettaglio **Imballaggio articolo** , impostare i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-505">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="a086c-506">**Quantità:** *1*</span><span class="sxs-lookup"><span data-stu-id="a086c-506">**Quantity:** *1*</span></span>
    - <span data-ttu-id="a086c-507">**Identificatore:** articolo *A0001*</span><span class="sxs-lookup"><span data-stu-id="a086c-507">**Identifier:** Item *A0001*</span></span>

1. <span data-ttu-id="a086c-508">Nel riquadro azioni selezionare **Chiudi contenitore**.</span><span class="sxs-lookup"><span data-stu-id="a086c-508">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="a086c-509">Nella finestra di dialogo **Chiudi contenitore** , selezionare **Ottieni peso sistema** di modo che il sistema aggiorni il campo **Peso lordo**.</span><span class="sxs-lookup"><span data-stu-id="a086c-509">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="a086c-510">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-510">Select **OK**.</span></span> <span data-ttu-id="a086c-511">Il contenitore viene spostato nell'ubicazione *ORDINAMENTO* ed è pronto per l'ordinamento.</span><span class="sxs-lookup"><span data-stu-id="a086c-511">The container is moved to the *SORT* location and is ready for sorting.</span></span>
1. <span data-ttu-id="a086c-512">Nel campo **Targa o spedizione** , immettere la targa di destinazione per la riga 2 dell'ordine cliente 2.</span><span class="sxs-lookup"><span data-stu-id="a086c-512">In the **License plate or shipment** field, enter the target LP for line 2 of the sales order 2.</span></span> <span data-ttu-id="a086c-513">Quindi premere il tasto **TAB** o **INVIO** della tastiera per uscire dal campo.</span><span class="sxs-lookup"><span data-stu-id="a086c-513">Then select the **Tab** or **Enter** key on your keyboard to move out of the field.</span></span>
1. <span data-ttu-id="a086c-514">Nel riquadro azioni selezionare **Nuovo contenitore**.</span><span class="sxs-lookup"><span data-stu-id="a086c-514">On the Action Pane, select **New container**.</span></span>
1. <span data-ttu-id="a086c-515">Accettare tutte le impostazioni predefinite e selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-515">Accept all the default settings, and select **OK**.</span></span> <span data-ttu-id="a086c-516">Prendere nota dell'ID contenitore.</span><span class="sxs-lookup"><span data-stu-id="a086c-516">Make a note of the container ID.</span></span>
1. <span data-ttu-id="a086c-517">Nella Scheda dettaglio **Imballaggio articolo** , impostare i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="a086c-517">On the **Item packing** FastTab, set the following values:</span></span>

    - <span data-ttu-id="a086c-518">**Quantità:** *1*</span><span class="sxs-lookup"><span data-stu-id="a086c-518">**Quantity:** *1*</span></span>
    - <span data-ttu-id="a086c-519">**Identificatore:** articolo *A0002*</span><span class="sxs-lookup"><span data-stu-id="a086c-519">**Identifier field:** Item *A0002*</span></span>

1. <span data-ttu-id="a086c-520">Nel riquadro azioni selezionare **Chiudi contenitore**.</span><span class="sxs-lookup"><span data-stu-id="a086c-520">On the Action Pane, select **Close container**.</span></span>
1. <span data-ttu-id="a086c-521">Nella finestra di dialogo **Chiudi contenitore** , selezionare **Ottieni peso sistema** di modo che il sistema aggiorni il campo **Peso lordo**.</span><span class="sxs-lookup"><span data-stu-id="a086c-521">In the **Close container** dialog box, select **Get system weight** to have the system update the **Gross weight** field.</span></span>
1. <span data-ttu-id="a086c-522">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-522">Select **OK**.</span></span> <span data-ttu-id="a086c-523">Il contenitore viene spostato nell'ubicazione *ORDINAMENTO* ed è pronto per l'ordinamento.</span><span class="sxs-lookup"><span data-stu-id="a086c-523">The container is moved to the *SORT* location and is ready for sorting.</span></span>

<span data-ttu-id="a086c-524">Per visualizzare i dettagli del contenitore, selezionare **Gestione magazzino \> Imballaggio e containerizzazione \> Contenitori** e cercare gli ID contenitore creati durante l'imballaggio.</span><span class="sxs-lookup"><span data-stu-id="a086c-524">To view the container details, go to **Warehouse management \> Packing and containerization \> Containers** , and search for the container IDs that were created during packing.</span></span>

### <a name="sort-the-containers"></a><span data-ttu-id="a086c-525">Ordinare i contenitori</span><span class="sxs-lookup"><span data-stu-id="a086c-525">Sort the containers</span></span>

> [!IMPORTANT]
> <span data-ttu-id="a086c-526">Quando si accede alla voce di menu **Creazione pallet** nell'app per dispositivi mobili per eseguire l'ordinamento in uscita, viene visualizzato il pulsante **Completo**.</span><span class="sxs-lookup"><span data-stu-id="a086c-526">When you access the **Pallet build** menu item on the mobile app to do outbound sorting, you will see a button that is labeled **Full**.</span></span> <span data-ttu-id="a086c-527">*Non utilizzare il pulsante **Completo** per ordinare o chiudere la posizione.*</span><span class="sxs-lookup"><span data-stu-id="a086c-527">*Don't use the **Full** button to sort or close the position.*</span></span>
>
> <span data-ttu-id="a086c-528">Il pulsante **Completo** è disponibile per impostazione predefinita e non può essere disabilitato o rimosso dalla pagina.</span><span class="sxs-lookup"><span data-stu-id="a086c-528">The **Full** button is provided by default and can't be disabled or removed from the page.</span></span> <span data-ttu-id="a086c-529">Non è utilizzato per la funzionalità *Ordinamento in uscita*.</span><span class="sxs-lookup"><span data-stu-id="a086c-529">It isn't used for the *Outbound sorting* feature.</span></span>

#### <a name="sort-the-first-container"></a><span data-ttu-id="a086c-530">Ordinare il primo contenitore</span><span class="sxs-lookup"><span data-stu-id="a086c-530">Sort the first container</span></span>

1. <span data-ttu-id="a086c-531">Nel dispositivo mobile, accedere al magazzino *62* utilizzando l'ID utente creato per questo scenario (o l'ID utente di un utente di dati dimostrativi esistente).</span><span class="sxs-lookup"><span data-stu-id="a086c-531">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="a086c-532">Nel menu principale, selezionare **In uscita**.</span><span class="sxs-lookup"><span data-stu-id="a086c-532">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="a086c-533">Nel menu **In uscita** , selezionare **Creazione pallet**.</span><span class="sxs-lookup"><span data-stu-id="a086c-533">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="a086c-534">Nel campo **Targa/Con** , immettere il primo ID contenitore associato all'ordine cliente 1.</span><span class="sxs-lookup"><span data-stu-id="a086c-534">In the **LP/Con** field, enter the first container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="a086c-535">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-535">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-536">Poiché al momento non esistono posizioni di ordinamento, è necessario specificarne una.</span><span class="sxs-lookup"><span data-stu-id="a086c-536">Because no sort positions currently exist, you must specify one.</span></span> <span data-ttu-id="a086c-537">Nel campo **ID posizione ordinamento** , immettere *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a086c-537">In the **Sort position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="a086c-538">Poiché nessuna targa è attualmente associata alla posizione di ordinamento *SP01* , è necessario specificarne una.</span><span class="sxs-lookup"><span data-stu-id="a086c-538">Because no LP is currently associated with sort position *SP01* , you must specify one.</span></span> <span data-ttu-id="a086c-539">Nel campo **TARGA** , immettere *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="a086c-539">In the **LP** field, enter *PLP01*.</span></span>
1. <span data-ttu-id="a086c-540">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-540">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-541">Poiché la convalida della posizione di ordinamento è attivata, è necessario immettere nuovamente l'ID posizione di ordinamento.</span><span class="sxs-lookup"><span data-stu-id="a086c-541">Because sort position validation is turned on, you must enter the sort position ID again.</span></span> <span data-ttu-id="a086c-542">Nel campo **ID posizione ordinamento** , immettere *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a086c-542">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="a086c-543">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-543">Select **OK**.</span></span>

    <span data-ttu-id="a086c-544">Viene visualizzato il messaggio "Lavoro completato".</span><span class="sxs-lookup"><span data-stu-id="a086c-544">You receive a "Work completed" message.</span></span>

> [!TIP]
> <span data-ttu-id="a086c-545">Per visualizzare la posizione di ordinamento e la targa nella stessa, selezionare **Gestione magazzino \> Imballaggio e containerizzazione \> Assegnazioni di posizioni di ordinamento in uscita**.</span><span class="sxs-lookup"><span data-stu-id="a086c-545">To view the sort position and the LP in it, go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
>
> <span data-ttu-id="a086c-546">La pagina **Assegnazioni di posizioni di ordinamento in uscita** mostra tutte le posizioni di ordinamento attualmente attive.</span><span class="sxs-lookup"><span data-stu-id="a086c-546">The **Outbound sorting position assignments** page shows all the sort positions that are currently active.</span></span> <span data-ttu-id="a086c-547">Il campo **Transazioni posizioni di ordinamento** mostra la targa associata a ciascuna posizione di ordinamento e i contenitori che si trovano nella posizione di ordinamento.</span><span class="sxs-lookup"><span data-stu-id="a086c-547">The **Sort position transactions** field shows the LP that is associated with each sort position, and the containers that are in the sort position.</span></span> <span data-ttu-id="a086c-548">Si noti che esiste attualmente una posizione di ordinamento e che la Scheda dettaglio **Criteri di posizione di ordinamento** mostra un criterio di **Spedizione - Servizio trasporto - Aereo**.</span><span class="sxs-lookup"><span data-stu-id="a086c-548">Notice that one sort position currently exists, and that the **Sort position criteria** FastTab shows a criterion of **Shipment – Carrier service - Air**.</span></span>

#### <a name="sort-the-remaining-containers"></a><span data-ttu-id="a086c-549">Ordinare i contenitori rimanenti</span><span class="sxs-lookup"><span data-stu-id="a086c-549">Sort the remaining containers</span></span>

1. <span data-ttu-id="a086c-550">Nel dispositivo mobile, accedere al magazzino *62* utilizzando l'ID utente creato per questo scenario (o l'ID utente di un utente di dati dimostrativi esistente).</span><span class="sxs-lookup"><span data-stu-id="a086c-550">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="a086c-551">Nel menu principale, selezionare **In uscita**.</span><span class="sxs-lookup"><span data-stu-id="a086c-551">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="a086c-552">Nel menu **In uscita** , selezionare **Creazione pallet**.</span><span class="sxs-lookup"><span data-stu-id="a086c-552">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="a086c-553">Nel campo **Targa/Con** , immettere il secondo ID contenitore associato all'ordine cliente 1.</span><span class="sxs-lookup"><span data-stu-id="a086c-553">In the **LP/Con** field, enter the second container ID that is associated with sales order 1.</span></span>
1. <span data-ttu-id="a086c-554">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-554">Select **OK**.</span></span> <span data-ttu-id="a086c-555">Poiché il modello di ordinamento è configurato per l'ordinamento automatico ed esiste già una posizione di ordinamento con criteri corrispondenti, si viene automaticamente indirizzati alla posizione di ordinamento corretta.</span><span class="sxs-lookup"><span data-stu-id="a086c-555">Because the sorting template is set up to sort automatically, and a sort position that has matching criteria already exists, you're automatically directed to the correct sort position.</span></span>
1. <span data-ttu-id="a086c-556">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-556">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-557">Confermare l'ID posizione di ordinamento per indicare che le scorte sono nell'ubicazione corretta.</span><span class="sxs-lookup"><span data-stu-id="a086c-557">Confirm the sort position ID to indicate that the inventory is in the correct place.</span></span> <span data-ttu-id="a086c-558">Nel campo **ID posizione ordinamento** , immettere *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a086c-558">In the **Sort Position ID** field, enter *SP01*.</span></span>
1. <span data-ttu-id="a086c-559">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-559">Select **OK**.</span></span>

    <span data-ttu-id="a086c-560">Il lavoro è completato per il secondo contenitore dell'ordine cliente 1.</span><span class="sxs-lookup"><span data-stu-id="a086c-560">Work is completed on the second container from sales order 1.</span></span> <span data-ttu-id="a086c-561">Ora si ordineranno i contenitori rimanenti dell'ordine di vendita 2.</span><span class="sxs-lookup"><span data-stu-id="a086c-561">You will now sort the remaining containers from sales order 2.</span></span>

1. <span data-ttu-id="a086c-562">Nel campo **Targa/Con** , immettere l'ID contenitore del contenitore dell'ordine cliente 2 che contiene l'articolo *A0001*.</span><span class="sxs-lookup"><span data-stu-id="a086c-562">In the **LP/Con** field, enter the container ID of the container from sales order 2 that holds item *A0001*.</span></span> <span data-ttu-id="a086c-563">Poiché il servizio di trasporto differisce, viene richiesto di immettere una nuova posizione di ordinamento e di assegnare una targa a quella posizione.</span><span class="sxs-lookup"><span data-stu-id="a086c-563">Because the carrier service differs, you're prompted to enter a new sort position and assign an LP to that position.</span></span> <span data-ttu-id="a086c-564">Utilizzare la posizione ordinamento *SP02* e la targa *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="a086c-564">Use sort position *SP02* and LP *PLP02*.</span></span>
1. <span data-ttu-id="a086c-565">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-565">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-566">Confermare la posizione di ordinamento immettendo *SP02* nel campo **ID posizione di ordinamento**.</span><span class="sxs-lookup"><span data-stu-id="a086c-566">Confirm the sort position by entering *SP02* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="a086c-567">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-567">Select **OK**.</span></span>

    <span data-ttu-id="a086c-568">Il lavoro è completato per il contenitore.</span><span class="sxs-lookup"><span data-stu-id="a086c-568">Work is completed on the container.</span></span>

1. <span data-ttu-id="a086c-569">Nel campo **Targa/Con** , immettere l'ID contenitore per il contenitore rimanente dell'ordine cliente 2 che contiene l'articolo *A0002*.</span><span class="sxs-lookup"><span data-stu-id="a086c-569">In the **LP/Con** field, enter the container ID for the remaining container from sales order 2 that holds item *A0002*.</span></span> <span data-ttu-id="a086c-570">Poiché il servizio di trasporto è uguale a quello dell'ordine cliente 1, il sistema mostra la posizione di ordinamento esistente che ha criteri corrispondenti.</span><span class="sxs-lookup"><span data-stu-id="a086c-570">Because the carrier service is the same as the carrier service for sales order 1, the system shows the existing sort position that has matching criteria.</span></span>
1. <span data-ttu-id="a086c-571">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-571">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-572">Confermare la posizione di ordinamento immettendo *SP01* nel campo **ID posizione di ordinamento**.</span><span class="sxs-lookup"><span data-stu-id="a086c-572">Confirm the sort position by entering *SP01* in the **Sort Position ID** field.</span></span>
1. <span data-ttu-id="a086c-573">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-573">Select **OK**.</span></span>

    <span data-ttu-id="a086c-574">Il lavoro è completato per il contenitore.</span><span class="sxs-lookup"><span data-stu-id="a086c-574">Work is completed on the container.</span></span>

### <a name="close-the-outbound-sorting-positions"></a><span data-ttu-id="a086c-575">Chiudere le posizioni di ordinamento in uscita</span><span class="sxs-lookup"><span data-stu-id="a086c-575">Close the outbound sorting positions</span></span>

<span data-ttu-id="a086c-576">Quando tutte le scorte sono state ordinate, la posizione deve essere chiusa prima di poter creare il lavoro.</span><span class="sxs-lookup"><span data-stu-id="a086c-576">When all inventory has been sorted, the position must be closed before work can be created.</span></span> <span data-ttu-id="a086c-577">Verrà creato un lavoro di prelievo delle scorte ordinate per portare le scorte al portellone.</span><span class="sxs-lookup"><span data-stu-id="a086c-577">Sorted inventory picking work will be created to take the inventory to the bay door.</span></span>

#### <a name="close-a-position-from-the-mobile-device"></a><span data-ttu-id="a086c-578">Chiudere una posizione dal dispositivo mobile</span><span class="sxs-lookup"><span data-stu-id="a086c-578">Close a position from the mobile device</span></span>

1. <span data-ttu-id="a086c-579">Nel dispositivo mobile, accedere al magazzino *62* utilizzando l'ID utente creato per questo scenario (o l'ID utente di un utente di dati dimostrativi esistente).</span><span class="sxs-lookup"><span data-stu-id="a086c-579">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="a086c-580">Nel menu principale, selezionare **In uscita**.</span><span class="sxs-lookup"><span data-stu-id="a086c-580">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="a086c-581">Nel menu **In uscita** , selezionare **Creazione pallet**.</span><span class="sxs-lookup"><span data-stu-id="a086c-581">On the **Outbound** menu, select **Pallet build**.</span></span>
1. <span data-ttu-id="a086c-582">Nel campo **Targa/Con** , immettere un ID contenitore che è stato ordinato per ordinare la posizione *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a086c-582">In the **LP/Con** field, enter a container ID that was sorted to sort position *SP01*.</span></span>
1. <span data-ttu-id="a086c-583">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-583">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-584">Viene visualizzato il seguente messaggio: "Il contenitore è già ordinato nella posizione SP01.</span><span class="sxs-lookup"><span data-stu-id="a086c-584">You receive the following message: "The container is already sorted to position SP01.</span></span> <span data-ttu-id="a086c-585">Chiudere la posizione?".</span><span class="sxs-lookup"><span data-stu-id="a086c-585">Close the position?"</span></span> <span data-ttu-id="a086c-586">Selezionare **Chiudi**.</span><span class="sxs-lookup"><span data-stu-id="a086c-586">Select **Close**.</span></span>

    <span data-ttu-id="a086c-587">Il lavoro è completato.</span><span class="sxs-lookup"><span data-stu-id="a086c-587">Work is completed.</span></span>

#### <a name="close-a-position-from-outbound-sorting-position-assignments"></a><span data-ttu-id="a086c-588">Chiudere una posizione dalle assegnazioni delle posizioni di ordinamento in uscita</span><span class="sxs-lookup"><span data-stu-id="a086c-588">Close a position from outbound sorting position assignments</span></span>

1. <span data-ttu-id="a086c-589">Selezionare **Gestione magazzino \> Imballaggio e containerizzazione \> Assegnazioni di posizioni di ordinamento in uscita**.</span><span class="sxs-lookup"><span data-stu-id="a086c-589">Go to **Warehouse management \> Packing and containerization \> Outbound sorting position assignments**.</span></span>
1. <span data-ttu-id="a086c-590">Nella colonna sinistra selezionare **SP02**.</span><span class="sxs-lookup"><span data-stu-id="a086c-590">In the left column, select **SP02**.</span></span> <span data-ttu-id="a086c-591">Questa riga della posizione di ordinamento in uscita è quella che verrà chiusa.</span><span class="sxs-lookup"><span data-stu-id="a086c-591">This outbound sorting position row is the one that you will close.</span></span>
1. <span data-ttu-id="a086c-592">Nel riquadro azioni selezionare **Chiudi posizione**.</span><span class="sxs-lookup"><span data-stu-id="a086c-592">On the Action Pane, select **Close position**.</span></span> <span data-ttu-id="a086c-593">Il record della posizione di ordinamento viene chiuso e non è più visualizzato.</span><span class="sxs-lookup"><span data-stu-id="a086c-593">The sorting position record is closed and is no longer shown.</span></span>

    > [!TIP]
    > <span data-ttu-id="a086c-594">Per visualizzare tutti i record della posizione chiusa, selezionare la casella di controllo **Mostra chiuso**.</span><span class="sxs-lookup"><span data-stu-id="a086c-594">To show all closed position records, select the **Show closed** check box.</span></span>

### <a name="sorted-inventory-picking"></a><span data-ttu-id="a086c-595">Prelievo scorte ordinate</span><span class="sxs-lookup"><span data-stu-id="a086c-595">Sorted inventory picking</span></span>

<span data-ttu-id="a086c-596">È necessario completare il lavoro di prelievo dell'inventario ordinato.</span><span class="sxs-lookup"><span data-stu-id="a086c-596">You must complete the sorted inventory picking work.</span></span> <span data-ttu-id="a086c-597">Al termine, le scorte saranno prelevate nell'ordine cliente.</span><span class="sxs-lookup"><span data-stu-id="a086c-597">When it's completed, the inventory will be picked to the sales order.</span></span> <span data-ttu-id="a086c-598">A quel punto, si applicano tutti gli altri processi di magazzino.</span><span class="sxs-lookup"><span data-stu-id="a086c-598">At that point, all other warehouse processes apply.</span></span>

1. <span data-ttu-id="a086c-599">Nel dispositivo mobile, accedere al magazzino *62* utilizzando l'ID utente creato per questo scenario (o l'ID utente di un utente di dati dimostrativi esistente).</span><span class="sxs-lookup"><span data-stu-id="a086c-599">On the mobile device, sign in to warehouse *62* by using the user ID that you created for this scenario (or the user ID of an existing demo data user).</span></span>
1. <span data-ttu-id="a086c-600">Nel menu principale, selezionare **In uscita**.</span><span class="sxs-lookup"><span data-stu-id="a086c-600">On the main menu, select **Outbound**.</span></span>
1. <span data-ttu-id="a086c-601">Nel menu **In uscita** , selezionare **Carica da ordinamento**.</span><span class="sxs-lookup"><span data-stu-id="a086c-601">On the **Outbound** menu, select **Load from Sorting**.</span></span>
1. <span data-ttu-id="a086c-602">Immettere l'ID targa di destinazione dalla prima posizione di ordinamento, *SP01*.</span><span class="sxs-lookup"><span data-stu-id="a086c-602">Enter the target LP ID from the first sort position, *SP01*.</span></span> <span data-ttu-id="a086c-603">Impostare il campo **ID** su *PLP01*.</span><span class="sxs-lookup"><span data-stu-id="a086c-603">Set the **ID** field to *PLP01*.</span></span>
1. <span data-ttu-id="a086c-604">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-604">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-605">La pagina **Prelievo scorte ordinate: Prelievo** mostra il lavoro di prelievo che deve essere eseguito.</span><span class="sxs-lookup"><span data-stu-id="a086c-605">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="a086c-606">Prelevare dall'ubicazione *ORDINAMENTO* e dalla targa di destinazione *PLP01* , che ha più articoli e una quantità pari a *3*.</span><span class="sxs-lookup"><span data-stu-id="a086c-606">Pick from the *SORT* location and target LP *PLP01* , which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="a086c-607">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-607">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-608">La pagina **Prelievo scorte ordinate: Stoccaggio** mostra il lavoro di stoccaggio che deve essere eseguito.</span><span class="sxs-lookup"><span data-stu-id="a086c-608">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="a086c-609">Stoccare nell'ubicazione *Portellone* e nella targa di destinazione *PLP01* , che ha più articoli e una quantità pari a *3*.</span><span class="sxs-lookup"><span data-stu-id="a086c-609">Put to the *Baydoor* location and target LP *PLP01* , which has multiple items and a quantity of *3*.</span></span>
1. <span data-ttu-id="a086c-610">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-610">Select **OK**.</span></span>

    <span data-ttu-id="a086c-611">Il lavoro è completato.</span><span class="sxs-lookup"><span data-stu-id="a086c-611">Work is completed.</span></span>

1. <span data-ttu-id="a086c-612">Immettere l'ID targa di destinazione della seconda posizione di ordinamento, *SP02*.</span><span class="sxs-lookup"><span data-stu-id="a086c-612">Enter the target license plate ID from the second sort position, *SP02*.</span></span> <span data-ttu-id="a086c-613">Impostare il campo **ID** su *PLP02*.</span><span class="sxs-lookup"><span data-stu-id="a086c-613">Set the **ID** field to *PLP02*.</span></span>
1. <span data-ttu-id="a086c-614">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-614">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-615">La pagina **Prelievo scorte ordinate: Prelievo** mostra il lavoro di prelievo che deve essere eseguito.</span><span class="sxs-lookup"><span data-stu-id="a086c-615">The **Sorted inventory picking: Pick** page shows the pick work that must be done.</span></span> <span data-ttu-id="a086c-616">Prelevare dall'ubicazione *ORDINAMENTO* e dalla targa di destinazione *PLP02* , che ha più articoli e una quantità pari a *1*.</span><span class="sxs-lookup"><span data-stu-id="a086c-616">Pick from the *SORT* location and target LP *PLP02* , which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="a086c-617">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-617">Select **OK**.</span></span>
1. <span data-ttu-id="a086c-618">La pagina **Prelievo scorte ordinate: Stoccaggio** mostra il lavoro di stoccaggio che deve essere eseguito.</span><span class="sxs-lookup"><span data-stu-id="a086c-618">The **Sorted inventory picking: Put** page shows the put work that must be done.</span></span> <span data-ttu-id="a086c-619">Stoccare nell'ubicazione *Portellone* e nella targa di destinazione *PLP02* , che ha più articoli e una quantità pari a *1*.</span><span class="sxs-lookup"><span data-stu-id="a086c-619">Put to the *Baydoor* location and target LP *PLP02* , which has multiple items and a quantity of *1*.</span></span>
1. <span data-ttu-id="a086c-620">Selezionare **OK**.</span><span class="sxs-lookup"><span data-stu-id="a086c-620">Select **OK**.</span></span>

    <span data-ttu-id="a086c-621">Il lavoro è completato.</span><span class="sxs-lookup"><span data-stu-id="a086c-621">Work is completed.</span></span>

<span data-ttu-id="a086c-622">Da questo momento, si applicano tutti gli altri processi di magazzino.</span><span class="sxs-lookup"><span data-stu-id="a086c-622">From this point forward, all other warehouse processes apply.</span></span>
