...
description: Questo articolo fornisce informazioni sull'ordinamento in uscita. Questa funzionalità semplifica la gestione di piccoli contenitori e aiuta i lavoratori a pianificare e organizzare meglio la capacità dei pallet nel camion.
author: Mirzaab
ms.date: 07/15/2020
ms.topic: article
ms.prod: ''
