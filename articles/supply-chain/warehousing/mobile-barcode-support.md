...
description: In questo articolo viene descritto come gestire l'app di scansione Magazzino nei dispositivi Android.
author: Mirzaab
ms.date: 05/26/2017
ms.topic: article
ms.prod: ''
...
L'app per dispositivi mobili Gestione magazzino è stata testata con una selezione di dispositivi Android per la scansione di codici a barre. Questi test coprono solo una parte dei dispositivi disponibili sul mercato.
