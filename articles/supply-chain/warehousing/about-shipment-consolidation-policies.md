...
| Il seguente campo di consolidamento definisce la combinazione univoca di valori utilizzata per consolidare le spedizioni per una *riga di trasferimento*. Tutti gli altri campi vengono ignorati.<ul><li>Numero ordine (OrderNum)</li></ul> | I seguenti campi di consolidamento definiscono la combinazione univoca di valori utilizzata per consolidare le spedizioni per una *riga di trasferimento*. Tutti gli altri campi vengono ignorati.<ul><li>Numero ordine (OrderNum)</li><li>Destinatario consegna (DeliveryName)</li><li>Indirizzo postale (DeliveryPostalAddress)</li><li>Codice paese ISO (CountryRegionISOCode)</li><li>Indirizzo (Address)</li><li>Sito (InventSiteId)</li><li>Magazzino (InventLocationId)</li><li>Vettore spedizione (CarrierCode)</li><li>Servizio trasporto (CarrierServiceCode)</li><li>Modalità di consegna (ModeCode)</li><li>Gruppo vettore (CarrierGroupCode)</li><li>Termini di consegna (DlvTermId)</li></ul>Questi campi sono gli unici campi disponibili e inizializzati quando viene creata una nuova spedizione. |
