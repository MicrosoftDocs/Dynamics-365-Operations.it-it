...
- <span data-ttu-id="6bc77-124">Annullamento delle etichette (ad esempio, in scenari di prelievo in difetto) e ristampa delle stesse.</span><span class="sxs-lookup"><span data-stu-id="6bc77-124">Void labels (for example, in short pick scenarios), and reprint them.</span></span>
...
- <span data-ttu-id="6bc77-137">**Modulo:** *Gestione Magazzino*</span><span class="sxs-lookup"><span data-stu-id="6bc77-137">**Module:** *Warehouse management*</span></span>
...
1. <span data-ttu-id="6bc77-166">Aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-166">Add a row that has the following settings:</span></span>
...
1. <span data-ttu-id="6bc77-180">Nella finestra di dialogo dell'editor di query, nella scheda **Intervallo**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-180">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    <span data-ttu-id="6bc77-185">Questa query garantisce che sull'etichetta vengano stampate solo le righe di lavoro di tipo prelievo, non le righe di lavoro di tipo stoccaggio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-185">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>
...
1. <span data-ttu-id="6bc77-218">Nella Scheda dettaglio **Generale**, impostare il campo **Tipo di etichetta ondata** su *Cartone*.</span><span class="sxs-lookup"><span data-stu-id="6bc77-218">On the **General** FastTab, set the **Wave label type** field to *Carton*.</span></span>
...
1. <span data-ttu-id="6bc77-233">Nella finestra di dialogo dell'editor di query, nella scheda **Ordinamento**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-233">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="6bc77-234">**Tabella:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-234">**Table:** *Work lines*</span></span>
...
### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="6bc77-249">Creare un ordine cliente e rilasciarlo nel magazzino</span><span class="sxs-lookup"><span data-stu-id="6bc77-249">Create a sales order and release it to the warehouse</span></span>
...
<span data-ttu-id="6bc77-296">Questo scenario mostra il flusso end-to-end.</span><span class="sxs-lookup"><span data-stu-id="6bc77-296">This scenario shows the end-to-end flow.</span></span>
...
### <a name="create-a-wave-label-layout"></a><span data-ttu-id="6bc77-311">Creare un layout di etichetta ondata</span><span class="sxs-lookup"><span data-stu-id="6bc77-311">Create a wave label layout</span></span>
...
1. <span data-ttu-id="6bc77-320">Aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-320">Add a row that has the following settings:</span></span>
    ...
    - <span data-ttu-id="6bc77-328">**Righe per pagina:** *5*</span><span class="sxs-lookup"><span data-stu-id="6bc77-328">**Rows per page:** *5*</span></span>
        ...
        <span data-ttu-id="6bc77-329">Questo campo definisce il numero di righe che è possibile stampare su ciascuna etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-329">This field defines the number of rows that can be printed on each label.</span></span>
...
1. <span data-ttu-id="6bc77-354">Andare a **Gestione magazzino \> Impostazioni \> Distribuzione documenti \> Modelli di etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-354">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
...
1. <span data-ttu-id="6bc77-365">Facoltativo: se si sta progettando un'etichetta specifica per il cliente, è necessario creare una query per trovare il conto del cliente.</span><span class="sxs-lookup"><span data-stu-id="6bc77-365">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="6bc77-366">Nella scheda dettaglio **Dettagli modello di etichette ondata**, selezionare **Modifica query**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-366">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="6bc77-367">Quindi, nella finestra di dialogo dell'editor di query, nella scheda **Intervallo**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-367">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>
    ...
    <span data-ttu-id="6bc77-372">Al termine, selezionare **OK** per chiudere la finestra di dialogo dell'editor di query.</span><span class="sxs-lookup"><span data-stu-id="6bc77-372">When you've finished, select **OK** to close the query editor dialog box.</span></span>
...
1. <span data-ttu-id="6bc77-382">Aggiungere cinque righe ordine cliente:</span><span class="sxs-lookup"><span data-stu-id="6bc77-382">Add five sales order lines:</span></span>
    ...
    - <span data-ttu-id="6bc77-389">Riga ordine cliente 3:</span><span class="sxs-lookup"><span data-stu-id="6bc77-389">Sales order line 3:</span></span>
...
<span data-ttu-id="6bc77-410">È possibile ristampare queste etichette ondata selezionando **Gestione magazzino \> Richieste e rapporti \>Storico etichetta ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-410">You can reprint these wave labels by going to **Warehouse management \> Inquiries and reports \> Wave label history**.</span></span>
...
<span data-ttu-id="6bc77-422">Questo scenario mostra il flusso end-to-end.</span><span class="sxs-lookup"><span data-stu-id="6bc77-422">This scenario shows the end-to-end flow.</span></span>
...
### <a name="create-three-wave-label-layouts"></a><span data-ttu-id="6bc77-439">Creare tre layout di etichetta ondata</span><span class="sxs-lookup"><span data-stu-id="6bc77-439">Create three wave label layouts</span></span>

1. <span data-ttu-id="6bc77-440">Andare a **Gestione magazzino \> Impostazioni \> Distribuzione documenti \> Layout etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-440">Go to **Warehouse management \> Setup \> Document routing \> Wave label layouts**.</span></span>
1. <span data-ttu-id="6bc77-441">Crea un record con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-441">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-442">**ID layout etichetta:** *Cartone*</span><span class="sxs-lookup"><span data-stu-id="6bc77-442">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="6bc77-443">**Descrizione:** *Cartone (SSCC)*</span><span class="sxs-lookup"><span data-stu-id="6bc77-443">**Description:** *Carton (SSCC)*</span></span>

1. <span data-ttu-id="6bc77-444">Nel riquadro azioni selezionare **Salva**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-444">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="6bc77-445">Nel riquadro azioni selezionare **Impostazioni di riga delle etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-445">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="6bc77-446">Viene visualizzata la pagina **Impostazioni di riga delle etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-446">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="6bc77-447">Qui è possibile configurare la parte dinamica dell'etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-447">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="6bc77-448">Aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-448">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-449">**ID riga:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="6bc77-449">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="6bc77-450">**Nome tabella di righe:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="6bc77-450">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="6bc77-451">**Posizione di inizio riga:** *0*</span><span class="sxs-lookup"><span data-stu-id="6bc77-451">**Row start position:** *0*</span></span>

        <span data-ttu-id="6bc77-452">Questo campo definisce la posizione verticale iniziale della riga sull'etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-452">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="6bc77-453">**Altezza riga:** *0*</span><span class="sxs-lookup"><span data-stu-id="6bc77-453">**Row height:** *0*</span></span>

        <span data-ttu-id="6bc77-454">Questo campo definisce l'altezza di ogni riga (in punti), secondo lo standard ZPL.</span><span class="sxs-lookup"><span data-stu-id="6bc77-454">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="6bc77-455">L'altezza della riga è positiva per le etichette orizzontali e negativa per le etichette verticali.</span><span class="sxs-lookup"><span data-stu-id="6bc77-455">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="6bc77-456">Poiché in questo esempio c'è una sola riga, è possibile impostare il valore su *0* (zero).</span><span class="sxs-lookup"><span data-stu-id="6bc77-456">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="6bc77-457">**Righe per pagina:** *1*</span><span class="sxs-lookup"><span data-stu-id="6bc77-457">**Rows per page:** *1*</span></span>

        <span data-ttu-id="6bc77-458">Questo campo definisce il numero di righe che è possibile stampare su ciascuna etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-458">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="6bc77-459">Questa impostazione causerà la stampa di un'etichetta ZPL separata per ciascun record nella tabella delle etichette ondata.</span><span class="sxs-lookup"><span data-stu-id="6bc77-459">This setup will cause a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="6bc77-460">Chiudere la pagina.</span><span class="sxs-lookup"><span data-stu-id="6bc77-460">Close the page.</span></span>
1. <span data-ttu-id="6bc77-461">Nel riquadro azioni, seleziona **Modifica query**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-461">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="6bc77-462">Nella finestra di dialogo dell'editor di query, nella scheda **Intervallo**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-462">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-463">**Tabella:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-463">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-464">**Tabella derivata:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-464">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-465">**Campo:** *Tipo di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-465">**Field:** *Work type*</span></span>
    - <span data-ttu-id="6bc77-466">**Criteri:** *Prelievo*</span><span class="sxs-lookup"><span data-stu-id="6bc77-466">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="6bc77-467">Questa query garantisce che sull'etichetta vengano stampate solo le righe di lavoro di tipo prelievo, non le righe di lavoro di tipo stoccaggio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-467">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="6bc77-468">Se si desidera poter stampare l'ID polizza di carico, nella scheda **Join**, selezionare la tabella **Righe lavoro** e unirvi la tabella **Spedizioni**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-468">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span> 
1. <span data-ttu-id="6bc77-469">Chiudere la finestra di dialogo dell'editor di query.</span><span class="sxs-lookup"><span data-stu-id="6bc77-469">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="6bc77-470">La Scheda dettaglio **Layout testo stampante** ha tre sezioni in cui è possibile scrivere il codice della stampante: **Sezione di intestazione**, **Sezione del corpo** e **Sezione piè di pagina**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-470">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="6bc77-471">Nella sezione **Sezione di intestazione**, nel campo **Intestazione etichetta**, immettere il codice per l'intestazione necessaria.</span><span class="sxs-lookup"><span data-stu-id="6bc77-471">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="6bc77-472">Ad esempio, se si utilizzano stampanti Zebra, è possibile utilizzare il codice seguente.</span><span class="sxs-lookup"><span data-stu-id="6bc77-472">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="6bc77-473">Nella sezione **Sezione del corpo**, nel campo **Corpo etichetta**, immettere il codice ZPL per il corpo necessario.</span><span class="sxs-lookup"><span data-stu-id="6bc77-473">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="6bc77-474">Ecco un esempio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-474">Here is an example.</span></span>
...
1. <span data-ttu-id="6bc77-475">Nella sezione **Sezione del corpo**, nel campo **Piè di pagina etichetta**, immettere il codice ZPL per il piè di pagina necessario.</span><span class="sxs-lookup"><span data-stu-id="6bc77-475">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="6bc77-476">Ecco un esempio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-476">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="6bc77-477">Questa configurazione stamperà una copia di ciascuna etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-477">This setup will print one copy of each label.</span></span> <span data-ttu-id="6bc77-478">Se sono necessarie più copie (ad esempio una copia per ciascun lato del pallet), impostare il valore **n** per la sezione **\^PQn** nel piè di pagina sul numero di copie necessarie.</span><span class="sxs-lookup"><span data-stu-id="6bc77-478">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="6bc77-479">Ad esempio, per stampare quattro copie di ciascuna etichetta, specificare **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-479">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="6bc77-480">La prima etichetta è ora pronta per l'uso.</span><span class="sxs-lookup"><span data-stu-id="6bc77-480">The first label is now ready to use.</span></span>
1. <span data-ttu-id="6bc77-481">Crea un secondo record di layout con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-481">Create a second layout record that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-482">**ID layout etichetta:** *Pallet*</span><span class="sxs-lookup"><span data-stu-id="6bc77-482">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="6bc77-483">**Descrizione:** *Pallet*</span><span class="sxs-lookup"><span data-stu-id="6bc77-483">**Description:** *Pallet*</span></span>

1. <span data-ttu-id="6bc77-484">Nel riquadro azioni selezionare **Salva**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-484">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="6bc77-485">Nel riquadro azioni selezionare **Impostazioni di riga delle etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-485">On the Action Pane, select **Wave label row settings**.</span></span>

    <span data-ttu-id="6bc77-486">Viene visualizzata la pagina **Impostazioni di riga delle etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-486">The **Wave label row settings** page appears.</span></span> <span data-ttu-id="6bc77-487">Qui è possibile configurare la parte dinamica dell'etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-487">Here, you can configure the dynamic part of the label.</span></span>

1. <span data-ttu-id="6bc77-488">Aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-488">Add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-489">**ID riga:** *WaveLabel*</span><span class="sxs-lookup"><span data-stu-id="6bc77-489">**Row Id:** *WaveLabel*</span></span>
    - <span data-ttu-id="6bc77-490">**Nome tabella di righe:** *WHSWaveLabel*</span><span class="sxs-lookup"><span data-stu-id="6bc77-490">**Row table name:** *WHSWaveLabel*</span></span>
    - <span data-ttu-id="6bc77-491">**Posizione di inizio riga:** *0*</span><span class="sxs-lookup"><span data-stu-id="6bc77-491">**Row start position:** *0*</span></span>

        <span data-ttu-id="6bc77-492">Questo campo definisce la posizione verticale iniziale della riga sull'etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-492">This field defines the vertical position where the row will begin on the label.</span></span>

    - <span data-ttu-id="6bc77-493">**Altezza riga:** *0*</span><span class="sxs-lookup"><span data-stu-id="6bc77-493">**Row height:** *0*</span></span>

        <span data-ttu-id="6bc77-494">Questo campo definisce l'altezza di ogni riga (in punti), secondo lo standard ZPL.</span><span class="sxs-lookup"><span data-stu-id="6bc77-494">This field defines the height of each row (in points), according to the ZPL standard.</span></span> <span data-ttu-id="6bc77-495">L'altezza della riga è positiva per le etichette orizzontali e negativa per le etichette verticali.</span><span class="sxs-lookup"><span data-stu-id="6bc77-495">The row height is positive for horizontal labels and negative for vertical labels.</span></span> <span data-ttu-id="6bc77-496">Poiché in questo esempio c'è una sola riga, è possibile impostare il valore su *0* (zero).</span><span class="sxs-lookup"><span data-stu-id="6bc77-496">Because there is just one row in this example, you can set the value to *0* (zero).</span></span>

    - <span data-ttu-id="6bc77-497">**Righe per pagina:** *1*</span><span class="sxs-lookup"><span data-stu-id="6bc77-497">**Rows per page:** *1*</span></span>

        <span data-ttu-id="6bc77-498">Questo campo definisce il numero di righe che è possibile stampare su ciascuna etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-498">This field defines the number of rows that can be printed on each label.</span></span>

        > [!NOTE]
        > <span data-ttu-id="6bc77-499">Questa impostazione causa la stampa di un'etichetta ZPL separata per ciascun record nella tabella di etichette ondata.</span><span class="sxs-lookup"><span data-stu-id="6bc77-499">This setup causes a separate ZPL label to be printed for each record in the wave labels table.</span></span>

1. <span data-ttu-id="6bc77-500">Chiudere la pagina.</span><span class="sxs-lookup"><span data-stu-id="6bc77-500">Close the page.</span></span>
1. <span data-ttu-id="6bc77-501">Nel riquadro azioni, seleziona **Modifica query**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-501">On the Action Pane, select **Edit query**.</span></span>
1. <span data-ttu-id="6bc77-502">Nella finestra di dialogo dell'editor di query, nella scheda **Intervallo**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-502">In the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-503">**Tabella:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-503">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-504">**Tabella derivata:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-504">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-505">**Campo:** *Tipo di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-505">**Field:** *Work type*</span></span>
    - <span data-ttu-id="6bc77-506">**Criteri:** *Prelievo*</span><span class="sxs-lookup"><span data-stu-id="6bc77-506">**Criteria:** *Pick*</span></span>

    <span data-ttu-id="6bc77-507">Questa query garantisce che sull'etichetta vengano stampate solo le righe di lavoro di tipo prelievo, non le righe di lavoro di tipo stoccaggio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-507">This query ensures that only pick-type work lines will be printed on the label, not put-type work lines.</span></span>

1. <span data-ttu-id="6bc77-508">Se si desidera poter stampare l'ID polizza di carico, nella scheda **Join**, selezionare la tabella **Righe lavoro** e unirvi la tabella **Spedizioni**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-508">If you want to be able to print the bill of lading ID, on the **Joins** tab, select the **Work lines** table, and join the **Shipments** table to it.</span></span>
1. <span data-ttu-id="6bc77-509">Chiudere la finestra di dialogo dell'editor di query.</span><span class="sxs-lookup"><span data-stu-id="6bc77-509">Close the query editor dialog box.</span></span>
1. <span data-ttu-id="6bc77-510">La Scheda dettaglio **Layout testo stampante** ha tre sezioni in cui è possibile scrivere il codice della stampante: **Sezione di intestazione**, **Sezione del corpo** e **Sezione piè di pagina**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-510">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="6bc77-511">Nella sezione **Sezione di intestazione**, nel campo **Intestazione etichetta**, immettere il codice per l'intestazione necessaria.</span><span class="sxs-lookup"><span data-stu-id="6bc77-511">In the **Header section** section, in the **Label header** field, enter code for the required header.</span></span> <span data-ttu-id="6bc77-512">Ad esempio, se si utilizzano stampanti Zebra, è possibile utilizzare il codice seguente.</span><span class="sxs-lookup"><span data-stu-id="6bc77-512">For example, if you're using Zebra printers, you can use the following code.</span></span>
...
1. <span data-ttu-id="6bc77-513">Nella sezione **Sezione del corpo**, nel campo **Corpo etichetta**, immettere il codice ZPL per il corpo necessario.</span><span class="sxs-lookup"><span data-stu-id="6bc77-513">In the **Body section** section, in the **Label body** field, enter ZPL code for the required body.</span></span> <span data-ttu-id="6bc77-514">Ecco un esempio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-514">Here is an example.</span></span>
...
1. <span data-ttu-id="6bc77-515">Nella sezione **Sezione del corpo**, nel campo **Piè di pagina etichetta**, immettere il codice ZPL per il piè di pagina necessario.</span><span class="sxs-lookup"><span data-stu-id="6bc77-515">In the **Body section** section, in the **Label footer** field, enter ZPL code for the required footer.</span></span> <span data-ttu-id="6bc77-516">Ecco un esempio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-516">Here is an example.</span></span>
    ...
    > [!NOTE]
    > <span data-ttu-id="6bc77-517">Questa configurazione stamperà una copia di ciascuna etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-517">This setup will print one copy of each label.</span></span> <span data-ttu-id="6bc77-518">Se sono necessarie più copie (ad esempio una copia per ciascun lato del pallet), impostare il valore **n** per la sezione **\^PQn** nel piè di pagina sul numero di copie necessarie.</span><span class="sxs-lookup"><span data-stu-id="6bc77-518">If you require more copies (for example, one copy for each side of the pallet), set the **n** value for the **\^PQn** section in the footer to the required number of copies.</span></span> <span data-ttu-id="6bc77-519">Ad esempio, per stampare quattro copie di ciascuna etichetta, specificare **\^PQ4**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-519">For example, to print four copies of each label, specify **\^PQ4**.</span></span>

1. <span data-ttu-id="6bc77-520">La seconda etichetta è ora pronta per l'uso.</span><span class="sxs-lookup"><span data-stu-id="6bc77-520">The second label is now ready to use.</span></span>
1. <span data-ttu-id="6bc77-521">Creare un terzo record di layout con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-521">Create a third layout record that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-522">**ID layout etichetta:** *Interruzione*</span><span class="sxs-lookup"><span data-stu-id="6bc77-522">**Label layout ID:** *Break*</span></span>
    - <span data-ttu-id="6bc77-523">**Descrizione:** *Etichetta di interruzione*</span><span class="sxs-lookup"><span data-stu-id="6bc77-523">**Description:** *Break label*</span></span>

1. <span data-ttu-id="6bc77-524">Nel riquadro azioni selezionare **Salva**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-524">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="6bc77-525">La Scheda dettaglio **Layout testo stampante** ha tre sezioni in cui è possibile scrivere il codice della stampante: **Sezione di intestazione**, **Sezione del corpo** e **Sezione piè di pagina**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-525">The **Printer text Layout** FastTab has three sections where you can write printer code: **Header section**, **Body section**, and **Footer section**.</span></span> <span data-ttu-id="6bc77-526">Nella sezione **Sezione di intestazione**, nel campo **Intestazione etichetta**, immettere il codice ZPL per l'intestazione necessaria.</span><span class="sxs-lookup"><span data-stu-id="6bc77-526">In the **Header section** section, in the **Label header** field, enter ZPL code for the required header.</span></span> <span data-ttu-id="6bc77-527">Ecco un esempio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-527">Here is an example.</span></span>
...
1. <span data-ttu-id="6bc77-528">Questa volta, non è necessario un corpo.</span><span class="sxs-lookup"><span data-stu-id="6bc77-528">This time, no body is required.</span></span> <span data-ttu-id="6bc77-529">Pertanto, immettere il testo necessario nella sezione **Sezione piè di pagina**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-529">Therefore, just enter the required text in the **Footer section** section.</span></span> <span data-ttu-id="6bc77-530">Ecco un esempio.</span><span class="sxs-lookup"><span data-stu-id="6bc77-530">Here is an example.</span></span>

    ```plaintext
    ^XZ
    ```

    <span data-ttu-id="6bc77-531">La terza etichetta è ora pronta per l'uso.</span><span class="sxs-lookup"><span data-stu-id="6bc77-531">The third label is now ready to use.</span></span>

    > [!NOTE]
    > <span data-ttu-id="6bc77-532">Questa terza etichetta è un'etichetta di interruzione che verrà utilizzata come divisore tra i rotoli di etichette.</span><span class="sxs-lookup"><span data-stu-id="6bc77-532">This third label is a break label that will be used as a divider between label rolls.</span></span>

### <a name="create-two-wave-label-types"></a><span data-ttu-id="6bc77-533">Creare due tipi di etichetta ondata</span><span class="sxs-lookup"><span data-stu-id="6bc77-533">Create two wave label types</span></span>

1. <span data-ttu-id="6bc77-534">Andare a **Gestione magazzino \> Impostazioni \> Distribuzione documenti \> Tipi di etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-534">Go to **Warehouse management \> Setup \> Document routing \> Wave label types**.</span></span>
1. <span data-ttu-id="6bc77-535">Crea un record con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-535">Create a record that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-536">**Tipo di etichetta:** *Cartone*</span><span class="sxs-lookup"><span data-stu-id="6bc77-536">**Label type:** *Carton*</span></span>
    - <span data-ttu-id="6bc77-537">**Descrizione:** *Cartone*</span><span class="sxs-lookup"><span data-stu-id="6bc77-537">**Description:** *Carton*</span></span>

1. <span data-ttu-id="6bc77-538">Crea un secondo record con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-538">Create a second record that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-539">**Tipo di etichetta:** *Pallet*</span><span class="sxs-lookup"><span data-stu-id="6bc77-539">**Label type:** *Pallet*</span></span>
    - <span data-ttu-id="6bc77-540">**Descrizione:** *Pallet*</span><span class="sxs-lookup"><span data-stu-id="6bc77-540">**Description:** *Pallet*</span></span>

### <a name="set-up-unit-sequence-groups"></a><span data-ttu-id="6bc77-541">Imposta gruppi di sequenze unità</span><span class="sxs-lookup"><span data-stu-id="6bc77-541">Set up unit sequence groups</span></span>

1. <span data-ttu-id="6bc77-542">Fare clic su **Gestione magazzino \> Impostazione \> Magazzino \> Gruppi di sequenze unità**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-542">Go to **Warehouse management \> Setup \> Warehouse \> Unit sequence groups**.</span></span>
1. <span data-ttu-id="6bc77-543">Selezionare o creare un gruppo **unità scatola pallet**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-543">Select or create an **Ea Box PL** group.</span></span>
1. <span data-ttu-id="6bc77-544">Per la riga **Scatola**, impostare il campo **Tipo di livello ondata** su *Scatola*.</span><span class="sxs-lookup"><span data-stu-id="6bc77-544">For the **Box** line, set the **Wave level type** field to *Carton*.</span></span>
1. <span data-ttu-id="6bc77-545">Per la riga **PALLET**, impostare il campo **Tipo di livello ondata** su *Pallet*.</span><span class="sxs-lookup"><span data-stu-id="6bc77-545">For the **PL** line, set the **Wave level type** field to *Pallet*.</span></span>

### <a name="create-wave-label-templates"></a><span data-ttu-id="6bc77-546">Creare modelli di etichetta ondata</span><span class="sxs-lookup"><span data-stu-id="6bc77-546">Create wave label templates</span></span>

1. <span data-ttu-id="6bc77-547">Andare a **Gestione magazzino \> Impostazioni \> Distribuzione documenti \> Modelli di etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-547">Go to **Warehouse management \> Setup \> Document routing \> Wave label templates**.</span></span>
1. <span data-ttu-id="6bc77-548">Creare un modello di etichetta con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-548">Create a label template that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-549">**Nome modello etichetta:** *Etichette cartoni*</span><span class="sxs-lookup"><span data-stu-id="6bc77-549">**Label template name:** *Carton labels*</span></span>
    - <span data-ttu-id="6bc77-550">**Descrizione:** *Etichette cartoni*</span><span class="sxs-lookup"><span data-stu-id="6bc77-550">**Description:** *Carton labels*</span></span>
    - <span data-ttu-id="6bc77-551">**Codice passaggio ondata:** *Cartone*</span><span class="sxs-lookup"><span data-stu-id="6bc77-551">**Wave step code:** *Carton*</span></span>
    - <span data-ttu-id="6bc77-552">**Magazzino:** *62*</span><span class="sxs-lookup"><span data-stu-id="6bc77-552">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="6bc77-553">Nella Scheda dettaglio **Generale**, nel campo **Tipo di etichetta ondata**, selezionare un valore, ad esempio *Cartone*.</span><span class="sxs-lookup"><span data-stu-id="6bc77-553">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Carton*.</span></span>
1. <span data-ttu-id="6bc77-554">Nella Scheda dettaglio **Dettagli modello di etichette ondata**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-554">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-555">**ID layout etichetta:** *Cartone*</span><span class="sxs-lookup"><span data-stu-id="6bc77-555">**Label layout ID:** *Carton*</span></span>
    - <span data-ttu-id="6bc77-556">**Nome stampante:** selezionare una stampante ZPL appropriata.</span><span class="sxs-lookup"><span data-stu-id="6bc77-556">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="6bc77-557">**Esegui query:** *Sì* (questa impostazione è facoltativa, ma è consigliata per prestazioni ottimali).</span><span class="sxs-lookup"><span data-stu-id="6bc77-557">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="6bc77-558">Nel riquadro azioni selezionare **Salva**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-558">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="6bc77-559">Facoltativo: se si sta progettando un'etichetta specifica per il cliente, è necessario creare una query per trovare il conto del cliente.</span><span class="sxs-lookup"><span data-stu-id="6bc77-559">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="6bc77-560">Nella scheda dettaglio **Dettagli modello di etichette ondata**, selezionare **Modifica query**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-560">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="6bc77-561">Quindi, nella finestra di dialogo dell'editor di query, nella scheda **Intervallo**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-561">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-562">**Tabella:** *Spedizioni*</span><span class="sxs-lookup"><span data-stu-id="6bc77-562">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="6bc77-563">**Tabella derivata:** *Spedizioni*</span><span class="sxs-lookup"><span data-stu-id="6bc77-563">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="6bc77-564">**Campo:** *Numero di conto*</span><span class="sxs-lookup"><span data-stu-id="6bc77-564">**Field:** *Account number*</span></span>
    - <span data-ttu-id="6bc77-565">**Criteri:** Immettere il numero di conto cliente pertinente.</span><span class="sxs-lookup"><span data-stu-id="6bc77-565">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="6bc77-566">Al termine, selezionare **OK** per chiudere la finestra di dialogo dell'editor di query.</span><span class="sxs-lookup"><span data-stu-id="6bc77-566">When you've finished, select **OK** to close the query editor dialog box.</span></span>

1. <span data-ttu-id="6bc77-567">Nel riquadro azioni, selezionare **Modifica query** per aprire la finestra di dialogo dell'editor di query per l'intero modello di etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-567">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="6bc77-568">Nella finestra di dialogo dell'editor di query, nella scheda **Ordinamento**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-568">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-569">**Tabella:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-569">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-570">**Tabella derivata:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-570">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-571">**Campo:** *ID riga di carico di riferimento (ID record)*</span><span class="sxs-lookup"><span data-stu-id="6bc77-571">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="6bc77-572">**Direzione di ricerca:** *Crescente*</span><span class="sxs-lookup"><span data-stu-id="6bc77-572">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="6bc77-573">Aggiungere una seconda riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-573">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-574">**Tabella:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-574">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-575">**Tabella derivata:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-575">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-576">**Campo:** *ID spedizione*</span><span class="sxs-lookup"><span data-stu-id="6bc77-576">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="6bc77-577">**Direzione di ricerca:** *Crescente*</span><span class="sxs-lookup"><span data-stu-id="6bc77-577">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="6bc77-578">Selezionare **OK** per chiudere la finestra di dialogo dell'editor di query.</span><span class="sxs-lookup"><span data-stu-id="6bc77-578">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="6bc77-579">Viene visualizzato un messaggio che richiede di confermare l'operazione di ripristino del raggruppamento.</span><span class="sxs-lookup"><span data-stu-id="6bc77-579">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="6bc77-580">Selezionare **Sì** per continuare.</span><span class="sxs-lookup"><span data-stu-id="6bc77-580">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="6bc77-581">Nel riquadro azioni selezionare **Gruppo di modelli di etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-581">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="6bc77-582">Nella finestra di dialogo **Gruppo di modelli di etichette ondata**, per la riga in cui il campo **Nome campo di riferimento** è impostato su *ID spedizione*, impostare i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="6bc77-582">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="6bc77-583">**Stampa etichetta di interruzione:** selezionare questa casella di controllo.</span><span class="sxs-lookup"><span data-stu-id="6bc77-583">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="6bc77-584">**ID layout etichetta:** selezionare un'etichetta di interruzione.</span><span class="sxs-lookup"><span data-stu-id="6bc77-584">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="6bc77-585">(ad esempio, selezionare il layout di etichetta *Interruzione* creato in precedenza in questo scenario).</span><span class="sxs-lookup"><span data-stu-id="6bc77-585">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="6bc77-586">**Nome stampante:** selezionare la stampante per l'etichetta di interruzione</span><span class="sxs-lookup"><span data-stu-id="6bc77-586">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="6bc77-587">(in genere, per lo scopo di suddividere i rotoli di etichette, è necessario selezionare la stessa stampante selezionata nella Scheda dettagli **Dettagli modello di etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-587">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="6bc77-588">Sono tuttavia possibili altri scenari).</span><span class="sxs-lookup"><span data-stu-id="6bc77-588">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="6bc77-589">Per la riga in cui il campo **Nome campo di riferimento** è impostato su *ID riga di carico di riferimento*, seleziona la casella di controllo **ID build etichetta**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-589">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="6bc77-590">Questa configurazione creerà una sequenza di etichette ("Cartone 1 di X") per riga di carico in tutta l'ondata, indipendentemente dall'impostazione del raggruppamento di lavoro.</span><span class="sxs-lookup"><span data-stu-id="6bc77-590">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="6bc77-591">Questa sequenza di etichette può essere stampata su un layout di etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-591">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="6bc77-592">Inoltre, le etichette di diverse spedizioni saranno separate dall'etichetta di interruzione selezionata.</span><span class="sxs-lookup"><span data-stu-id="6bc77-592">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

1. <span data-ttu-id="6bc77-593">Selezionare **OK** per chiudere la finestra di dialogo **Gruppo di modelli di etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-593">Select **OK** to close the **Wave label template group** dialog box.</span></span>
1. <span data-ttu-id="6bc77-594">Creare un secondo modello di etichetta con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-594">Create a second label template that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-595">**Nome modello etichetta:** *Etichette pallet*</span><span class="sxs-lookup"><span data-stu-id="6bc77-595">**Label template name:** *Pallet labels*</span></span>
    - <span data-ttu-id="6bc77-596">**Descrizione:** *Etichette pallet*</span><span class="sxs-lookup"><span data-stu-id="6bc77-596">**Description:** *Pallet labels*</span></span>
    - <span data-ttu-id="6bc77-597">**Codice passaggio ondata:** *Pallet*</span><span class="sxs-lookup"><span data-stu-id="6bc77-597">**Wave step code:** *Pallet*</span></span>
    - <span data-ttu-id="6bc77-598">**Magazzino:** *62*</span><span class="sxs-lookup"><span data-stu-id="6bc77-598">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="6bc77-599">Nella Scheda dettaglio **Generale**, nel campo **Tipo di etichetta ondata**, selezionare un valore, ad esempio *Pallet*.</span><span class="sxs-lookup"><span data-stu-id="6bc77-599">On the **General** FastTab, in the **Wave label type** field, select a value, such as *Pallet*.</span></span>
1. <span data-ttu-id="6bc77-600">Nella Scheda dettaglio **Dettagli modello di etichette ondata**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-600">On the **Wave label template details** FastTab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-601">**ID layout etichetta:** *Pallet*</span><span class="sxs-lookup"><span data-stu-id="6bc77-601">**Label layout ID:** *Pallet*</span></span>
    - <span data-ttu-id="6bc77-602">**Nome stampante:** selezionare una stampante ZPL appropriata.</span><span class="sxs-lookup"><span data-stu-id="6bc77-602">**Printer name:** Select an appropriate ZPL printer.</span></span>
    - <span data-ttu-id="6bc77-603">**Esegui query:** *Sì* (questa impostazione è facoltativa, ma è consigliata per prestazioni ottimali).</span><span class="sxs-lookup"><span data-stu-id="6bc77-603">**Run query:** *Yes* (This setting is optional, but it's recommended for optimal performance.)</span></span>

1. <span data-ttu-id="6bc77-604">Nel riquadro azioni selezionare **Salva**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-604">On the Action Pane, select **Save**.</span></span>
1. <span data-ttu-id="6bc77-605">Facoltativo: se si sta progettando un'etichetta specifica per il cliente, è necessario creare una query per trovare il conto del cliente.</span><span class="sxs-lookup"><span data-stu-id="6bc77-605">Optional: If you're setting up a customer-specific label design, you must create a query to find the customer's account.</span></span> <span data-ttu-id="6bc77-606">Nella scheda dettaglio **Dettagli modello di etichette ondata**, selezionare **Modifica query**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-606">On the **Wave label template details** FastTab, select **Edit query**.</span></span> <span data-ttu-id="6bc77-607">Quindi, nella finestra di dialogo dell'editor di query, nella scheda **Intervallo**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-607">Then, in the query editor dialog box, on the **Range** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-608">**Tabella:** *Spedizioni*</span><span class="sxs-lookup"><span data-stu-id="6bc77-608">**Table:** *Shipments*</span></span>
    - <span data-ttu-id="6bc77-609">**Tabella derivata:** *Spedizioni*</span><span class="sxs-lookup"><span data-stu-id="6bc77-609">**Derived table:** *Shipments*</span></span>
    - <span data-ttu-id="6bc77-610">**Campo:** *Numero di conto*</span><span class="sxs-lookup"><span data-stu-id="6bc77-610">**Field:** *Account number*</span></span>
    - <span data-ttu-id="6bc77-611">**Criteri:** Immettere il numero di conto cliente pertinente.</span><span class="sxs-lookup"><span data-stu-id="6bc77-611">**Criteria:** Enter the relevant customer account number.</span></span>

    <span data-ttu-id="6bc77-612">Al termine, selezionare **OK** per chiudere la finestra di dialogo dell'editor di query.</span><span class="sxs-lookup"><span data-stu-id="6bc77-612">When you've finished, select **OK** to close the query editor dialog box.</span></span> 

1. <span data-ttu-id="6bc77-613">Nel riquadro azioni, selezionare **Modifica query** per aprire la finestra di dialogo dell'editor di query per l'intero modello di etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-613">On the Action Pane, select **Edit query** to open the query editor dialog box for the whole label template.</span></span>
1. <span data-ttu-id="6bc77-614">Nella finestra di dialogo dell'editor di query, nella scheda **Ordinamento**, aggiungere una riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-614">In the query editor dialog box, on the **Sorting** tab, add a row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-615">**Tabella:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-615">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-616">**Tabella derivata:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-616">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-617">**Campo:** *ID riga di carico di riferimento (ID record)*</span><span class="sxs-lookup"><span data-stu-id="6bc77-617">**Field:** *Reference load line id (Record-ID)*</span></span>
    - <span data-ttu-id="6bc77-618">**Direzione di ricerca:** *Crescente*</span><span class="sxs-lookup"><span data-stu-id="6bc77-618">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="6bc77-619">Aggiungere una seconda riga con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-619">Add a second row that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-620">**Tabella:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-620">**Table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-621">**Tabella derivata:** *Righe di lavoro*</span><span class="sxs-lookup"><span data-stu-id="6bc77-621">**Derived table:** *Work lines*</span></span>
    - <span data-ttu-id="6bc77-622">**Campo:** *ID spedizione*</span><span class="sxs-lookup"><span data-stu-id="6bc77-622">**Field:** *Shipment ID*</span></span>
    - <span data-ttu-id="6bc77-623">**Direzione di ricerca:** *Crescente*</span><span class="sxs-lookup"><span data-stu-id="6bc77-623">**Search direction:** *Ascending*</span></span>

1. <span data-ttu-id="6bc77-624">Selezionare **OK** per chiudere la finestra di dialogo dell'editor di query.</span><span class="sxs-lookup"><span data-stu-id="6bc77-624">Select **OK** to close the query editor dialog box.</span></span>
1. <span data-ttu-id="6bc77-625">Viene visualizzato un messaggio che richiede di confermare l'operazione di ripristino del raggruppamento.</span><span class="sxs-lookup"><span data-stu-id="6bc77-625">A message box prompts you to confirm the grouping reset operation.</span></span> <span data-ttu-id="6bc77-626">Selezionare **Sì** per continuare.</span><span class="sxs-lookup"><span data-stu-id="6bc77-626">Select **Yes** to continue.</span></span>
1. <span data-ttu-id="6bc77-627">Nel riquadro azioni selezionare **Gruppo di modelli di etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-627">On the Action Pane, select **Wave label template group**.</span></span>
1. <span data-ttu-id="6bc77-628">Nella finestra di dialogo **Gruppo di modelli di etichette ondata**, per la riga in cui il campo **Nome campo di riferimento** è impostato su *ID spedizione*, impostare i seguenti valori:</span><span class="sxs-lookup"><span data-stu-id="6bc77-628">In the **Wave label template group** dialog box, for the row where the **Reference field name** field is set to *Shipment ID*, set the following values:</span></span>

    - <span data-ttu-id="6bc77-629">**Stampa etichetta di interruzione:** selezionare questa casella di controllo.</span><span class="sxs-lookup"><span data-stu-id="6bc77-629">**Print break label:** Select this check box.</span></span>
    - <span data-ttu-id="6bc77-630">**ID layout etichetta:** selezionare un'etichetta di interruzione.</span><span class="sxs-lookup"><span data-stu-id="6bc77-630">**Label layout ID:** Select a break label.</span></span> <span data-ttu-id="6bc77-631">(ad esempio, selezionare il layout di etichetta *Interruzione* creato in precedenza in questo scenario).</span><span class="sxs-lookup"><span data-stu-id="6bc77-631">(For example, select the *Break* label layout that you created earlier in this scenario.)</span></span>
    - <span data-ttu-id="6bc77-632">**Nome stampante:** selezionare la stampante per l'etichetta di interruzione</span><span class="sxs-lookup"><span data-stu-id="6bc77-632">**Printer name:** Select the printer for the break label.</span></span> <span data-ttu-id="6bc77-633">(in genere, per lo scopo di suddividere i rotoli di etichette, è necessario selezionare la stessa stampante selezionata nella Scheda dettagli **Dettagli modello di etichette ondata**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-633">(Typically, for the purpose of splitting label rolls, you should select the same printer that is selected on the **Wave label template details** FastTab.</span></span> <span data-ttu-id="6bc77-634">Sono tuttavia possibili altri scenari).</span><span class="sxs-lookup"><span data-stu-id="6bc77-634">However, other scenarios are possible.)</span></span>

1. <span data-ttu-id="6bc77-635">Per la riga in cui il campo **Nome campo di riferimento** è impostato su *ID riga di carico di riferimento*, seleziona la casella di controllo **ID build etichetta**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-635">For the row where the **Reference field name** field is set to *Reference load line id*, select the **Label build ID** check box.</span></span>

    > [!NOTE]
    > <span data-ttu-id="6bc77-636">Questa configurazione creerà una sequenza di etichette ("Cartone 1 di X") per riga di carico in tutta l'ondata, indipendentemente dall'impostazione del raggruppamento di lavoro.</span><span class="sxs-lookup"><span data-stu-id="6bc77-636">This setup will create one label sequence ("Carton 1 of X") per load line throughout the wave, regardless of the work grouping setup.</span></span> <span data-ttu-id="6bc77-637">Questa sequenza di etichette può essere stampata su un layout di etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-637">This label sequence can be printed on a label layout.</span></span> <span data-ttu-id="6bc77-638">Inoltre, le etichette di diverse spedizioni saranno separate dall'etichetta di interruzione selezionata.</span><span class="sxs-lookup"><span data-stu-id="6bc77-638">Additionally, labels for different shipments will be separated by the selected break label.</span></span>

### <a name="configure-number-sequence-extensions"></a><span data-ttu-id="6bc77-639">Configurare le estensioni di sequenza numerica</span><span class="sxs-lookup"><span data-stu-id="6bc77-639">Configure number sequence extensions</span></span>

<span data-ttu-id="6bc77-640">Le estensioni di sequenza numerica controllano la conformità GS1 delle sequenze numeriche specifiche.</span><span class="sxs-lookup"><span data-stu-id="6bc77-640">Number sequence extensions control the GS1 compliance of specific number sequences.</span></span> <span data-ttu-id="6bc77-641">Questa configurazione è facoltativa per lo scenario corrente.</span><span class="sxs-lookup"><span data-stu-id="6bc77-641">This configuration is optional for the current scenario.</span></span> <span data-ttu-id="6bc77-642">Per ulteriori informazioni e istruzioni sulla configurazione, vedere [Configurare le estensioni di sequenza numerica](../warehousing/configure-number-sequence-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="6bc77-642">For more information and configuration instructions, see [Configure number sequence extensions](../warehousing/configure-number-sequence-extensions.md).</span></span>

### <a name="create-a-sales-order-and-release-it-to-the-warehouse"></a><span data-ttu-id="6bc77-643">Creare un ordine cliente e rilasciarlo nel magazzino</span><span class="sxs-lookup"><span data-stu-id="6bc77-643">Create a sales order and release it to the warehouse</span></span>

1. <span data-ttu-id="6bc77-644">Andare a **Vendite e marketing \> Ordine cliente \> Tutti gli ordini cliente**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-644">Go to **Sales and marketing \> Sales order \> All sales orders**.</span></span>
1. <span data-ttu-id="6bc77-645">Crea un ordine cliente con le seguenti impostazioni:</span><span class="sxs-lookup"><span data-stu-id="6bc77-645">Create a sales order that has the following settings:</span></span>

    - <span data-ttu-id="6bc77-646">**Conto cliente:** *US-001*</span><span class="sxs-lookup"><span data-stu-id="6bc77-646">**Customer account:** *US-001*</span></span>
    - <span data-ttu-id="6bc77-647">**Magazzino:** *62*</span><span class="sxs-lookup"><span data-stu-id="6bc77-647">**Warehouse:** *62*</span></span>

1. <span data-ttu-id="6bc77-648">Aggiungere due righe ordine cliente:</span><span class="sxs-lookup"><span data-stu-id="6bc77-648">Add two sales order lines:</span></span>

    - <span data-ttu-id="6bc77-649">Riga ordine cliente 1:</span><span class="sxs-lookup"><span data-stu-id="6bc77-649">Sales order line 1:</span></span>

        - <span data-ttu-id="6bc77-650">**Numero articolo:** *A0001*</span><span class="sxs-lookup"><span data-stu-id="6bc77-650">**Item number:** *A0001*</span></span>
        - <span data-ttu-id="6bc77-651">**Quantità:** *9024*</span><span class="sxs-lookup"><span data-stu-id="6bc77-651">**Quantity:** *9024*</span></span>
        - <span data-ttu-id="6bc77-652">**Unità:** *unità* (9024 unità = 376 scatole = 47 pallet)</span><span class="sxs-lookup"><span data-stu-id="6bc77-652">**Unit:** *ea* (9024 ea = 376 Box = 47 PL)</span></span>

    - <span data-ttu-id="6bc77-653">Riga ordine cliente 2:</span><span class="sxs-lookup"><span data-stu-id="6bc77-653">Sales order line 2:</span></span>

        - <span data-ttu-id="6bc77-654">**Numero articolo:** *A0002*</span><span class="sxs-lookup"><span data-stu-id="6bc77-654">**Item number:** *A0002*</span></span>
        - <span data-ttu-id="6bc77-655">**Quantità:** *9016*</span><span class="sxs-lookup"><span data-stu-id="6bc77-655">**Quantity:** *9016*</span></span>
        - <span data-ttu-id="6bc77-656">**Unità:** *unità* (9016 unità = 322 scatole = 46 pallet)</span><span class="sxs-lookup"><span data-stu-id="6bc77-656">**Unit:** *ea* (9016 ea = 322 Box = 46 PL)</span></span>

    > [!NOTE]
    > <span data-ttu-id="6bc77-657">Gli articoli e le quantità forniti qui sono solo esempi.</span><span class="sxs-lookup"><span data-stu-id="6bc77-657">The items and quantities that are provided here are only examples.</span></span> <span data-ttu-id="6bc77-658">Devono utilizzare il gruppo di sequenze di unità definito in precedenza, conversioni di unità appropriate da *unità* a *scatola* a *pallet* devono essere definite per gli stessi e devono avere stock nel magazzino *62*.</span><span class="sxs-lookup"><span data-stu-id="6bc77-658">They must use the unit sequence group that you defined earlier, appropriate unit conversions from *ea* to *Box* to *PL* must be defined for them, and they must have stock in warehouse *62*.</span></span> <span data-ttu-id="6bc77-659">Per ulteriori informazioni, vedere [Unità di misura e politiche di stoccaggio](unit-measure-stocking-policies.md).</span><span class="sxs-lookup"><span data-stu-id="6bc77-659">For more information, see [Unit of measure and stocking policies](unit-measure-stocking-policies.md).</span></span>

1. <span data-ttu-id="6bc77-660">Selezionare la riga ordine cliente 1.</span><span class="sxs-lookup"><span data-stu-id="6bc77-660">Select sales order line 1.</span></span> <span data-ttu-id="6bc77-661">Nella sezione **Riga ordine cliente**, nel menu **Scorte**, selezionare **Prenotazioni**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-661">Then, in the **Sales order line** section, on the **Inventory** menu, select **Reservations**.</span></span>
1. <span data-ttu-id="6bc77-662">Nella pagina **Prenotazione** del riquadro azioni, selezionare **Prenota lotto** e chiudere la pagina.</span><span class="sxs-lookup"><span data-stu-id="6bc77-662">On the **Reservation** page, on the Action Pane, select **Reserve lot**, and then close the page.</span></span>
1. <span data-ttu-id="6bc77-663">Ripetere i passaggi 4 e 5 per la riga ordine cliente 2.</span><span class="sxs-lookup"><span data-stu-id="6bc77-663">Repeat steps 4 and 5 for sales order line 2.</span></span>
1. <span data-ttu-id="6bc77-664">Nel riquadro azioni, nella scheda **Magazzino**, seleziona **Rilascia in magazzino**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-664">On the Action Pane, on the **Warehouse** tab, select **Release to warehouse**.</span></span>

    <span data-ttu-id="6bc77-665">Si verificano gli eventi seguenti:</span><span class="sxs-lookup"><span data-stu-id="6bc77-665">The following events occur:</span></span> 

    - <span data-ttu-id="6bc77-666">Il sistema elabora la spedizione creata utilizzando il modello che include il passaggio di stampa dell'etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-666">The system processes the created shipment by using the template that includes the label printing step.</span></span> <span data-ttu-id="6bc77-667">Il layout di etichetta verrà utilizzato per definire il formato dell'etichetta e il risultato sarà un'etichetta stampata sulla stampante selezionata nel modello di etichetta.</span><span class="sxs-lookup"><span data-stu-id="6bc77-667">The label layout will be used to define the format of the label, and the result will be a label that is printed on the printer that is selected in the label template.</span></span>
    - <span data-ttu-id="6bc77-668">Le etichette ondata vengono generate e stampate.</span><span class="sxs-lookup"><span data-stu-id="6bc77-668">Wave labels are generated and printed.</span></span> <span data-ttu-id="6bc77-669">Il numero di etichette sarà uguale al numero di cartoni (in questo esempio, 376 etichette scatola per la riga 1, 322 etichette scatola per la riga 2, 47 etichette pallet per la riga 1, 47 etichette pallet per la riga 2 e due etichette di interruzione che hanno l'ID spedizione).</span><span class="sxs-lookup"><span data-stu-id="6bc77-669">The number of labels will equal the number of cartons (in this example, 376 Box labels for line 1, 322 Box labels for line 2, 47 PL labels for line 1, 47 PL labels for line 2, and two break labels that have the shipment ID).</span></span>
    - <span data-ttu-id="6bc77-670">Viene generato un nuovo ID polizza di carico per le spedizioni.</span><span class="sxs-lookup"><span data-stu-id="6bc77-670">A new bill of lading ID is generated for the shipments.</span></span> <span data-ttu-id="6bc77-671">Se sono state configurate le estensioni della sequenza numerica, gli ID etichetta ondata avranno il formato numerico **SSCC-18**.</span><span class="sxs-lookup"><span data-stu-id="6bc77-671">If you configured the number sequence extensions, the wave label IDs will follow the **SSCC-18** number format.</span></span> 

<span data-ttu-id="6bc77-672">È possibile visualizzare e ristampare le etichette ondata dalle seguenti pagine:</span><span class="sxs-lookup"><span data-stu-id="6bc77-672">You can view and reprint wave labels from the following pages:</span></span>

- <span data-ttu-id="6bc77-673">Tutte le spedizioni \> Dettagli spedizione</span><span class="sxs-lookup"><span data-stu-id="6bc77-673">All shipments \> Shipment details</span></span>
- <span data-ttu-id="6bc77-674">Tutti i carichi \> Dettagli carico</span><span class="sxs-lookup"><span data-stu-id="6bc77-674">All loads \> Load details</span></span>
- <span data-ttu-id="6bc77-675">Tutte le ondate</span><span class="sxs-lookup"><span data-stu-id="6bc77-675">All waves</span></span>
- <span data-ttu-id="6bc77-676">Etichette ondata</span><span class="sxs-lookup"><span data-stu-id="6bc77-676">Wave labels</span></span>
- <span data-ttu-id="6bc77-677">Storico etichette ondata</span><span class="sxs-lookup"><span data-stu-id="6bc77-677">Wave label history</span></span>

<span data-ttu-id="6bc77-678">Per la maggior parte di queste pagine, è possibile trovare la funzione pertinente selezionando **Etichette ondata** nel gruppo **Informazioni correlate** della scheda **Spedizioni** del riquadro azioni.</span><span class="sxs-lookup"><span data-stu-id="6bc77-678">For most of these pages, you can find the relevant function by selecting **Wave labels** in the **Related information** group on the **Shipments** tab of the Action Pane.</span></span>
