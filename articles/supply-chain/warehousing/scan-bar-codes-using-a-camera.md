---
title: Eseguire la scansione dei codici a barre utilizzando una fotocamera nell'app per dispositivi mobili Warehouse Management
description: In questo articolo viene descritto come installare l'app per dispositivi mobili Gestione magazzino per eseguire la scansione dei codici a barre utilizzando una fotocamera su un dispositivo mobile.
author: Mirzaab
ms.date: 01/03/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8862339"
---
# <a name="scan-bar-codes-using-a-camera-in-the-warehouse-management-mobile-app"></a>Eseguire la scansione dei codici a barre utilizzando una fotocamera nell'app per dispositivi mobili Warehouse Management

[!include [banner](../includes/banner.md)]

In questo articolo viene descritto come installare l'app per dispositivi mobili Gestione magazzino per eseguire la scansione dei codici a barre utilizzando una fotocamera su un dispositivo mobile.
