...
Se usi i dati Contoso predefiniti, la query per l'azione della direttiva ubicazione non richiederà modifiche. Tuttavia, per assicurarti che le direttive di ubicazione acquisiscano gli articoli negli ordini cliente quando applichi la funzionalità in un ambiente non Contoso, crea una nuova direttiva di ubicazione. Per verificare le impostazioni nell'ambiente demo, attieniti alla seguente procedura.
