...
description: Questo articolo fornisce una panoramica della funzionalità che fornisce estensioni di sequenza numerica per ID targa, ID etichetta ondata, ID contenitore e ID polizza di carico.
author: Mirzaab
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
