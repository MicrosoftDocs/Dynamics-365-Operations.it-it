...
description: In questo articolo viene descritto come spedire parzialmente un carico e posticipare la pianificazione della capacità del carico.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
