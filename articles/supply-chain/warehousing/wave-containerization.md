...
description: In questo articolo viene descritto come automatizzare la containerizzazione dei carichi. La containerizzazione automatica consente di creare contenitori e il lavoro di prelievo per le spedizioni al momento dell'elaborazione del ciclo.
author: Mirzaab
ms.date: 03/08/2021
ms.topic: article
ms.prod: ''
...
In questo articolo viene descritto come automatizzare la containerizzazione dei carichi. La containerizzazione automatica consente di creare contenitori e il lavoro di prelievo per le spedizioni al momento dell'elaborazione del ciclo.
