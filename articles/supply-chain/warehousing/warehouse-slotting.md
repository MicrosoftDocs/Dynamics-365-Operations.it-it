...
Successivamente, devi impostare l'intestazione del modello, le specifiche di assegnazione e le direttive di ubicazione, come spiegato nelle sottosezioni seguenti.

#### <a name="set-up-a-slotting-template-header"></a>Impostare un'intestazione del modello di assegnazione
...
1. Nell'intestazione del modello, imposta i seguenti valori:
    ...
    - **Tipo di domanda:** *Ordine cliente*
        ...
        Attualmente, l'unico tipo di domanda supportato è *Ordine cliente*.
