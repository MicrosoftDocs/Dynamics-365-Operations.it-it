---
title: Elaborazione prodotti a peso variabile con gestione magazzino
description: Questo articolo descrive come utilizzare i modelli di lavoro e le direttive di ubicazione per stabilire come e dove il lavoro viene effettuato nel magazzino.
author: perlynne
ms.date: 08/13/2020
ms.topic: article
ms.prod: ''
...
Per ulteriori informazioni, vedere [Configurazione e gestione di articoli a peso variabile](/dynamicsax-2012/appuser-itpro/setting-up-and-maintaining-catch-weight-items).
