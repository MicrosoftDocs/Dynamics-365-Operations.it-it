...
description: Questo articolo fornisce le risposte alle domande frequenti (FAQ) sulla funzionalità di approvvigionamento di Supply Chain Management.
...
ms.locfileid: "8869577"
---
# <a name="procurement-faq"></a>Approvvigionamento - Domande frequenti

[!include [banner](../includes/banner.md)]

Questo articolo fornisce le risposte alle domande frequenti (FAQ) sulla funzionalità di approvvigionamento di Supply Chain Management.
