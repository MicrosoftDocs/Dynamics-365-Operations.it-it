...
-   [Consente di creare una richiesta di offerta](tasks/create-request-quotation.md)
...
-   [Creazione di un conto fornitore](tasks/create-vendor-account.md)
...
-   [Creare un catalogo di approvvigionamento](tasks/create-procurement-catalog.md)
...
-   [Creazione di un ordine fornitore](tasks/create-purchase-order.md)
-   [Creare un ordine fornitore ripetuto](tasks/create-repeat-purchase-order.md)
-   [Creazione di un ordine fornitore da un ordine cliente](../sales-marketing/tasks/create-purchase-order-sales-order.md)
