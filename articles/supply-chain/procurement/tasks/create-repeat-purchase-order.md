...
2. Selezionare **Da tutto**. La pagina che si apre è identica a quella indicata prima, ma opzioni differenti sono selezionate quando viene aperta dalla visualizzazione righe ordine. Esaminiamo i parametri.   
3. Espandere la sezione **Parametri**.
    ...
    - Anche l'opzione **Copia intestazione ordine** non è selezionata, poiché stiamo solo aggiungendo righe supplementari all'ordine.   
    - Per questo esempio, copieremo le righe da un ordine fornitore esistente.   

4. Selezionare la riga per l'ordine fornitore desiderato. Notare che la singola riga ordine che è su questo PO è anche selezionata.  
