...
1. Scegliere **Pannello di navigazione > Moduli > Approvvigionamento > Richieste di offerta > Tutte le richieste di offerta**.
...
5. Nel campo **Magazzino** immettere o selezionare un valore. L'indirizzo di consegna sarà l'indirizzo del magazzino, per impostazione predefinita.  
6. Fare clic su **OK**.
...
1. Nel campo **Numero articolo** immettere o selezionare un valore. Se si utilizza USMF, sarà possibile selezionare T0020.  
2. Nel campo **Quantità** immettere un numero.
3. Fare clic su **Aggiungi riga**.
4. Nel campo **Tipo di riga** selezionare 'Categoria'. È possibile utilizzare il tipo di riga Categoria per creare RdO per le merci o i servizi non in magazzino. Sarà quindi necessario selezionare il tipo di merci o servizi da una gerarchia di categorie di approvvigionamento.  
...
3. Fare clic su **Aggiungi automaticamente fornitori**. È possibile aggiungere fornitori alla RdO automaticamente in base alla categoria di approvvigionamento degli articoli richiesti. Se non sono presenti fornitori approvati per le categorie incluse nelle righe, sarà possibile aggiungerli manualmente.  
