...
description: In questo articolo viene descritto il processo per l'integrazione di nuovi fornitori. Descrive le azioni necessarie per diversi ruoli durante il processo.
...
Per una dimostrazione rapida del processo di onboarding del fornitore, vedere questo breve video su YouTube: [Come eseguire l'onboarding di un nuovo fornitore in finanza e operazioni](https://www.youtube.com/watch?v=0KUc3AGaTKk).
