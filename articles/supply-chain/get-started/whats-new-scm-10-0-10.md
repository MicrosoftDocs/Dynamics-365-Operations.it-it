...
description: Questo articolo descrive le funzionalità nuove o modificate in Dynamics 365 Supply Chain Management 10.0.10.
author: kamaybac
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
...
Questo articolo elenca le funzionalità nuove o modificate di Microsoft Dynamics 365 Supply Chain Management 10.0.10. Questa versione ha il numero di build 10.0.420 ed è disponibile come segue:
...
Dynamics 365 Supply Chain Management 10.0.10 include gli aggiornamenti della piattaforma. Per ulteriori informazioni, vedi [Aggiornamenti della piattaforma per la versione 10.0.10 delle app per finanza e operazioni](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-34.md).
