...
description: Questo articolo descrive le funzionalità nuove o modificate in Dynamics 365 Supply Chain Management 10.0.18.
author: kamaybac
ms.date: 03/01/2021
ms.topic: article
ms.prod: ''
...
Questo articolo elenca le funzionalità nuove o modificate di Microsoft Dynamics 365 Supply Chain Management 10.0.18. Questa versione ha il numero di build 10.0.793 ed è disponibile come segue:

- **Anteprima della versione:** marzo 2021
- **Disponibilità generale della versione (aggiornamento automatico):** aprile 2021
- **Disponibilità generale della versione (aggiornamento automatico):** maggio 2021
...
- [Componente aggiuntivo Visibilità magazzino](../inventory/inventory-visibility.md)
- [Modulo Costo sbarcato](../landed-cost/landed-cost-overview.md)
- [Interfaccia attrezzatura movimentazione materiali](../warehousing/mhax.md)
- [Analisi corrispondenza Ottimizzazione pianificazione](../master-planning/planning-optimization/planning-optimization-fit-analysis.md)
...
Microsoft Dynamics 365 Supply Chain Management 10.0.18 include gli aggiornamenti della piattaforma. Per ulteriori informazioni, vedi [Aggiornamenti della piattaforma per la versione 10.0.18 delle app per la finanza e le operazioni (maggio 2021)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-18.md).

### <a name="bug-fixes"></a>Correzioni di bug

Per informazioni sulle correzioni di bug incluse in ciascuno degli aggiornamenti che fanno parte di 10.0.18, accedere a Lifecycle Services (LCS) e visualizzare l'[articolo KB](https://fix.lcs.dynamics.com/Issue/Details?bugId=561679&dbType=3&qc=13bb1641c1be430ead8b21ae3d4e0f800d5b81c39b3a56e890db1de7ede59e46).
