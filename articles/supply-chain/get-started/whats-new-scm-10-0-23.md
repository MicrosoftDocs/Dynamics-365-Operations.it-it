...
Questo argomento elenca le funzionalità nuove o modificate nell'anteprima della versione 10.0.23. di Microsoft Dynamics 365 Supply Chain Management. Questa versione ha il numero di build 10.0.1037 ed è disponibile come segue:
...
| Vendite e marketing | Pulisci storico aggiornamento ordini cliente | Questa funzione consente di ripulire i record storici temporanei relativi agli aggiornamenti degli ordini cliente. Aggiunge un nuovo pulsante chiamato **Pulisci storico aggiornamento vendite** al riquadro azioni delle pagine di dettaglio ed elenco per gli ordini cliente. |
