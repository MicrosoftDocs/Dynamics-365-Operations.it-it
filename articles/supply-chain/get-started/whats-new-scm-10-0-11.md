...
description: Questo articolo descrive le funzionalità nuove o modificate in Dynamics 365 Supply Chain Management 10.0.11.
author: kamaybac
ms.date: 04/17/2020
ms.topic: article
ms.prod: ''
...
Questo articolo elenca le funzionalità nuove o modificate di Microsoft Dynamics 365 Supply Chain Management 10.0.11. Questa versione ha il numero di build 10.0.464 ed è disponibile come segue:
...
Microsoft Dynamics 365 Supply Chain Management 10.0.11 include gli aggiornamenti della piattaforma. Per altre informazioni, vedere [Aggiornamenti della piattaforma per la versione 10.0.11 delle app per la finanza e le operazioni (luglio 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-update-35.md).
