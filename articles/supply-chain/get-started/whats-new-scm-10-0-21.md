...
**Messaggio di avviso:** Impossibile eseguire lo script [SetupDiagnostics] nella VM

La distribuzione funzionerà nonostante l'avviso, tuttavia, potrebbero verificarsi i seguenti problemi noti in Lifecycle Services (LCS):
...
| Inventario&nbsp;e&nbsp;logistica | [Scansiona i codici a barre nel magazzino utilizzando gli standard di formato GS1](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/scan-barcodes-warehouse-using-gs1-format-standards) | *Presto disponibile*<!-- KFM: Add doc link when ready. --> |
| Inventario&nbsp;e&nbsp;logistica | Offerta nascosta <!-- KFM: Add RP link when available --> | *Presto disponibile*<!-- KFM: Add doc link when ready. --> |
...
| Inventario&nbsp;e&nbsp;logistica | [Istruzioni del passaggio dell'app di magazzino](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/warehouse-management-mobile-app-step-instructions) | *Presto disponibile*<!-- KFM: Add doc link when ready --> |
...
| Pianificazione generale | (Anteprima) Supporto MRP basato sulla priorità per Ottimizzazione pianificazione | Questa funzionalità di anteprima Ottimizzazione pianificazione consente la pianificazione generale guidata dalla priorità di pianificazione con punto di riordino. Le modifiche evidenziate includono: campo **Priorità di pianificazione** nelle righe dell'ordine cliente, nelle righe dell'ordine fornitore, nella previsione della domanda e negli ordini pianificati; una nuova opzione per il codice di copertura; campo **Copertura articolo** per punto di riordino; moduli di impostazione della pianificazione principale per controllare l'impostazione della priorità di pianificazione e Logica di calcolo Ottimizzazione pianificazione per impostare e rispettare la priorità di pianificazione. |
