...
---
# <a name="preview-features-in-dynamics-365-supply-chain-management-10014-november-2020"></a>Funzionalità di anteprima in Dynamics 365 Supply Chain Management 10.0.14 (novembre 2020)

[!include [banner](../includes/banner.md)]
[!include [preview banner](../includes/preview-banner.md)]

Questo argomento elenca le funzionalità nuove o modificate di Microsoft Dynamics 365 Supply Chain Management versione di anteprima 10.0.14. Questa versione ha il numero di build 10.0.605 ed è disponibile come segue:

- **Versione di anteprima:** settembre 2020
- **Disponibilità generale (aggiornamento automatico):** ottobre 2020
- **Aggiornamento automatico:** novembre 2020

## <a name="features-included-in-this-release"></a>Funzionalità incluse in questa versione

Questa versione include una piattaforma aggiornata e miglioramenti generali, ma non include nuove funzionalità specifiche per Supply Chain Management. Per ulteriori informazioni sulle funzionalità imminenti, visitare il sito [Piani di rilascio](https://docs.microsoft.com/dynamics365/release-plans/).
...
Per informazioni sulle correzioni di bug incluse in ciascuno degli aggiornamenti che fanno parte di 10.0.14, accedere a Lifecycle Services (LCS) e visualizzare l'[articolo KB](https://fix.lcs.dynamics.com/Issue/Details?bugId=488609&dbType=3&qc=8251e8e1d5e2386de850599926c1adc3fec8e2ba25308036d22cdfe0a1c28fc7).
