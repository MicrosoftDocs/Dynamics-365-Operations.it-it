...
| [Migrazione dei dati e lavorare in tempo reale nelle app Finance and Operations](/learn/paths/migrate-data-go-live-finance-operations/) | Come consulente funzionale, è necessario comprendere come preparare i dati del cliente per la migrazione, lavorare con la gestione dei dati ed eseguire i test di accettazione degli utenti per lavorare in tempo reale con le app Finance and Operations. | Percorso di apprendimento online gratuito autonomo | 4 ore |
...
|---------|--------------|--------|-----------|
| [Aggiornare Dynamics AX 2012 alle app Finance and Operations](/learn/paths/upgrade-ax-2012-finance-operations/) | Apprendi gli elementi più importanti e le procedure consigliate per aggiornare con successo la soluzione Dynamics AX 2012 alle app Finance and Operations. Dai primi passaggi per scoprire le principali differenze architetturali, iniziare con il processo di aggiornamento e gli strumenti di aggiornamento di codice e dati, ai modi migliori di riprogettare integrazioni, analisi e report in base alle funzionalità più recenti. | Percorso di apprendimento online gratuito autonomo | 7 ore |
