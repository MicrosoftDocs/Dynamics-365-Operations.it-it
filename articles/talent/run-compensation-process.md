...
description: In questo argomento viene descritto come risolvere un problema in cui il cliente tenta di eseguire il processo retributivo in Microsoft Dynamics 365 for Talent ma senza riuscirvi.
...
Il cliente tenta di eseguire il processo retributivo in Microsoft Dynamics 365 for Talent ma senza riuscirvi.

**Causa**

Il cliente necessita della documentazione.

**Risoluzione**

La documentazione per la compensazione è elencata di seguito:

- Attrezzaggio:

    - [Piani di retribuzione](https://docs.microsoft.com/en-us/dynamics365/unified-operations/talent/compensation-plans)
