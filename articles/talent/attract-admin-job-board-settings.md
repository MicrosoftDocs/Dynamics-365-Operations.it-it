...
---
# <a name="enable-broadbean-integration-in-microsoft-dynamics-365-talent---attract"></a>Abilitare l'integrazione di Broadbean in Microsoft Dynamics 365 Talent - Attract
...
> - Per pubblicare annunci di lavoro tramite Attract, è necessario disporre di una sottoscrizione Broadbend.
...
3. Contattare Broadbean e immettere le informazioni nei campi **Nome utente**, **ID client** e **Token di crittografia**.
