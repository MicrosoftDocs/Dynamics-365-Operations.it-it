...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-november-12-2019"></a>Novità o modifiche in Dynamics 365 Talent (12 novembre 2019)
...
Le modifiche descritte in questo sezione sono valide per la build numero 8.1.2604. I numeri tra parentesi in alcune intestazioni si riferiscono ai numeri del supporto in Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Ubicazione ufficio non viene aggiornato mediante la cartella di lavoro di Excel (369727)

Con questa modifica, è ora possibile aggiornare l'ubicazione ufficio tramite il designer della cartella di lavoro di Office.
