...
---
# <a name="troubleshoot-integration-with-linkedin-and-attract"></a>Risolvere i problemi di integrazione con LinkedIn e Attract
...
## <a name="you-cant-sign-in-to-linkedin-from-attract"></a>Non è possibile accedere a LinkedIn da Attract

Se non si riesce ad accedere a LinkedIn da Attract, provare i passaggi seguenti:

1. Verificare che le credenziali di LinkedIn immesse in Attract siano valide e corrette.
2. Se le credenziali sono valide e corrette, contattare il [Supporto tecnico di LinkedIn](https://www.linkedin.com/help/linkedin).
3. Se il problema persiste, contattare il [supporto tecnico Microsoft](./talent-support.md).

## <a name="job-posts-from-attract-dont-appear-on-linkedin"></a>Le pubblicazioni delle posizioni da Attract non vengono visualizzate in LinkedIn
