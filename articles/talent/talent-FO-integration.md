...
ms.locfileid: "2622770"
---
# <a name="dynamics-365-talent-to-dynamics-365-finance-integration-faq"></a>Domande frequenti sull'integrazione di Dynamics 365 Talent con Dynamics 365 Finance

[!include [banner](includes/banner.md)]

In questo argomento vengono fornite le risposte a domande comuni relative ai dati che vengono sincronizzati durante l'integrazione di Dynamics 365 Talent con Dynamics 365 Finance.
...
Per Core HR viene sincronizzato un sottoinsieme di dati. Per un elenco di tutte le entità, vedere [Integrazione di Dynamics 365 Talent con Dynamics 365 Finance](talent-financeandoperations-integration.md).

Per Attract e Onboard, tutti i dati sono nativi a Common Data Service.
...
## <a name="can-i-map-financial-dimensions-to-transfer-between-talent-and-finance"></a>È possibile mappare le dimensioni finanziarie per il trasferimento tra Talent e Finance?
...
Per i dati in Finance ma non presenti in Talent, collegare due sistemi utilizzando **Configura collegamenti** in Talent. Per ulteriori informazioni su come configurare collegamenti tra Talent e Finance, vedere [Novità o modifiche in Dynamics 365 Talent: Core HR (31 ottobre 2018)](whats-new-talent-october-31.md).
...
No, l'integrazione è attualmente unidirezionale (da Talent a Finance and Operations). Tuttavia, è disponibile un modello predefinito per l'invio di dati da Talent a Finance.
...
## <a name="i-just-created-new-finance-and-talent-environments-and-im-getting-the-error-the-data-value-violates-integrity-constraints-why"></a>Dopo la creazione di nuovi ambienti Finance e Talent, viene visualizzato l'errore "Il valore dati viola i vincoli di integrità". Perché?
...
## <a name="after-integrating-talent-and-finance-i-dont-see-my-talent-data-in-finance-what-do-i-do"></a>Dopo l'integrazione di Talent con Finance, i dati di Talent non sono visibili in Finance. Cosa fare?

L'integrazione con Finance è un processo in due fasi. La prima consiste nel verificare che i dati di Talent vengano aggiornati e siano disponibili in Common Data Service. Questa fase è una sincronizzazione quasi in tempo reale e può essere verificata in PowerApps esaminando i dati nelle entità di dati.
...
La sequenza numerica di **ID ubicazione** utilizza lo stesso modello sia in Talent, sia in Finance. La sequenza numerica deve essere univoca su entrambi i lati di modo che non vi siano conflitti durante l'integrazione di dati da Common Data Service in Finance and Operations.

Durante l'implementazione di Talent, verificare che le sequenze numeriche non siano le stesse in Talent e in Finance. Verificare che tutte le sequenze numeriche non siano identiche quando i dati possono essere gestiti in entrambi i sistemi.
...
Assicurarsi di eseguire il mapping alle persone giuridiche corrette. La sincronizzazione delle persone giuridiche non fa parte del modello predefinito, pertanto è previsto che ogni persona giuridica presente in Talent e Common Data Service sia anche presente in Finance.
