...
Fare riferimento all'argomento [Definire nuovi processi](../fin-and-ops/hr/tasks/define-new-jobs.md) per la procedura dettagliata relativa alla creazione di un nuovo processo. 
