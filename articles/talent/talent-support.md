...
Per ottenere supporto per Talent, usare le risorse indicate nella tabella seguente. Tali risorse sono elencate nell'ordine in cui devono essere seguite durante la risoluzione dei problemi.
...
Per ottenere supporto per l'app autonoma Onboard, usare le risorse indicate nella tabella seguente. Tali risorse sono elencate nell'ordine in cui devono essere seguite durante la risoluzione dei problemi. È possibile trovare tutte queste opzioni di supporto selezionando il pulsante **Guida** (**?**) nell'angolo in alto a destra della pagina.
