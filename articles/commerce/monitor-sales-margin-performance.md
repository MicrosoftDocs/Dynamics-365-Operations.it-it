...
ms.locfileid: "4985888"
---
# <a name="monitor-sales-and-margin-performance"></a>Monitorare le prestazioni di vendite e margini

[!include [banner](includes/banner.md)]

È possibile monitorare le prestazioni di vendite e margine in tempo reale tramite Dynamics 365 Commerce.

Nell'ambito di Commerce, gli utenti possono monitorare le prestazioni di vendite e margine in tempo reale tra livelli diversi della gerarchia organizzativa per le seguenti dimensioni:
