...
description: In questo articolo vengono descritti i moduli Banner promozionale e la procedura per aggiungerli alle pagine di siti Web in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9279737"
---
# <a name="promo-banner-module"></a>Modulo banner promozionale

[!include [banner](includes/banner.md)]

In questo articolo vengono descritti i moduli Banner promozionale e la procedura per aggiungerli alle pagine di siti Web in Microsoft Dynamics 365 Commerce.
...
1. Nella finestra di dialogo **Nuovo modello**, sotto **Nome modello**, immetti **Modello banner promozionale**, quindi seleziona **OK**.
