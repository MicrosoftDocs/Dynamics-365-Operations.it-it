...
description: In questo argomento viene descritta la funzionalità per disabilitare le regole di convalida delle transazioni in Microsoft Dynamics 365 Commerce.
author: analpert
ms.date: 12/11/2021
ms.topic: index-page
ms.prod: ''
