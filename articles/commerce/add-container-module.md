...
description: Questo articolo tratta i moduli Contenitore e descrive come aggiungerli alle pagine del sito in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
1. Nella finestra di dialogo **Nuovo modello**, sotto **Nome modello**, immetti **Modello contenitore**, quindi seleziona **OK**.
...
1. Nella finestra di dialogo **Crea una nuova pagina**, sotto **Nome pagina**, immetti **Pagina contenitore**, quindi seleziona **Avanti**.
1. Sotto **Scegli un modello**, seleziona il **modello di contenitore** creato e seleziona **Avanti**.
