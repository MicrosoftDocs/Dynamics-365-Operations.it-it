...
## <a name="create-a-retail-channel-navigation-hierarchy"></a>Creare una gerarchia di navigazione nei canali di vendita al dettaglio

Per creare una gerarchia di navigazione nei canali di vendita al dettaglio, effettuare le seguenti operazioni.

1. Andare a **Vendita al dettaglio \> Prodotti e categorie \> Gestione categorie e prodotti**.
...
1. Selezionare **Nuovo**.
1. Nel campo **Tipo di gerarchia di categorie**, selezionare **Gerarchia di navigazione nei canali di vendita al dettaglio**.
...
1. Andare a **Vendita al dettaglio \> Impostazione canale \> Categorie canale e attributi del prodotto**.
1. Nell'albero a sinistra, selezionare il punto vendita online.
1. Selezionare **Pubblica aggiornamenti canale**.
1. Andare a **Vendita al dettaglio \> Vendita al dettaglio IT \> Programmazione della distribuzione**.
