---
title: Impostare l'evasione degli ordini nel punto vendita
description: In questo articolo viene fornita una panoramica su come impostare l'evasione ordini del punto vendita.
author: BrianShook
ms.date: 10/30/2017
ms.topic: article
ms.prod: ''
...
Per attivare l'accettazione manuale per le righe dell'ordine, passare a **Retail e Commerce** \> **Canali** \> **Punti vendita** \> **Tutti i punti vendita**. Selezionare il punto vendita e scegliere l'ID del punto vendita per visualizzare i dettagli del punto vendita. Fare clic su **Modifica**. Nella scheda dettaglio **Generale**, individuare l'intestazione secondaria **Evasione ordine** e modificare **Accettazione manuale** da **No** a **Sì**.
