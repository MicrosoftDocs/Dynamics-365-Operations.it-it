...
> [!NOTE]
> Prima di provare a integrare la gestione delle attività con Teams, assicurati di aver attivato l'integrazione di [Dynamics 365 Commerce e Microsoft Teams](enable-teams-integration.md). 
...
> [!NOTE]
> Dopo che l'elenco delle attività è stato pubblicato correttamente in Teams, le attività verranno visualizzate in POS. I responsabili POS e i cassieri devono quindi attivare l'accesso Azure AD al POS. Per ulteriori informazioni, fare riferimento all'articolo [Abilitare l'autenticazione Azure Active Directory per l'accesso al POS](aad-pos-logon.md). 
