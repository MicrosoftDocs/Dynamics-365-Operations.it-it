...
- **Indirizzo di fatturazione** - Questo modulo consente a un cliente di immettere le informazioni di fatturazione. Tali informazioni vengono elaborate da Adyen insieme alle informazioni sulla carta di credito, . Questo modulo include un'opzione che consente ai clienti di utilizzare il proprio indirizzo di fatturazione come indirizzo di spedizione.
    ...
    L'immagine seguente mostra un esempio di moduli Gift card, Punti fedeltà, Pagamento e Indirizzo di fatturazione in una pagina checkout.
...
1. Nella finestra di dialogo **Nuovo frammento pagina**, selezionare il modulo **Checkout**.
1. Sotto **Nome frammento pagina**, inserire il nome **Frammento checkout**, quindi selezionare **OK**.
...
1. Nello slot **Informazioni checkout** selezionare i puntini di sospensione (**...**), quindi selezionare **Aggiungi modulo**.
1. Nella finestra di dialogo **Aggiungi modulo**, selezionare i moduli **Indirizzo di spedizione**, **Opzioni di consegna**, **Contenitore sezione checkout** e **Informazioni di contatto**, quindi selezionare **OK**.
1. Nel modulo **Contenitore sezione checkout** selezionare i puntini di sospensione (**...**), quindi selezionare **Aggiungi modulo**.
1. Nella finestra di dialogo **Aggiungi modulo** selezionare i moduli **Gift card**, **Punti fedeltà** e **Pagamento**, quindi selezionare **OK**. In questo modo, si garantisce la visualizzazione di tutti i metodi di pagamento in un'unica sezione.
