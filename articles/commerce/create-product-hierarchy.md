...
In questo argomento viene descritto come creare un nuova gerarchia di prodotti in Microsoft Dynamics 365 Commerce.
...
[Gerarchie di punti vendita al dettaglio](retail-hierarchies.md)

[Gestire le categorie di prodotti e i prodotti](category-management-product-creation.md)

[Modificare l'ordinamento per entità di merchandising](custom-order-categories-nav-retail-prod-hierarchy.md)
