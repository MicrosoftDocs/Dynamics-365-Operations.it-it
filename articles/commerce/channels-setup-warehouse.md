...
description: Questo articolo descrive come impostare un magazzino da utilizzare con un nuovo canale in Microsoft Dynamics 365 Commerce.
author: samjarawan
ms.date: 01/27/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9273641"
---
# <a name="warehouse-set-up"></a>impostare un magazzino

[!include [banner](includes/banner.md)]

Questo articolo descrive come impostare un magazzino da utilizzare con un nuovo canale in Microsoft Dynamics 365 Commerce.
