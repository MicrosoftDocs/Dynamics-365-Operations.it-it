...
description: Questo articolo descrive i moduli elenco immagini e la procedura per aggiungerli alle pagine di siti Web in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9269837"
---
# <a name="image-list-module"></a>Modulo elenco immagini

[!include [banner](includes/banner.md)]

Questo articolo descrive i moduli elenco immagini e la procedura per aggiungerli alle pagine di siti Web in Microsoft Dynamics 365 Commerce.
