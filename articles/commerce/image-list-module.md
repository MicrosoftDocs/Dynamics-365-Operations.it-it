...
1. Nella finestra di dialogo **Aggiungi modulo** selezionare il modulo **Elenco immagini**, quindi selezionare **OK**.
...
1. Nella finestra di dialogo **Aggiungi modulo** selezionare **Elenco immagini**, quindi selezionare **OK**.
