...
description: In questo articolo viene descritto come impostare e utilizzare i turni in Commerce POS (POS).
author: josaw1
ms.date: 05/10/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9287459"
---
# <a name="shift-and-cash-drawer-management"></a>Gestione turni e cassetto della cassa

[!include [banner](includes/banner.md)]

In questo articolo viene descritto come impostare e utilizzare i turni in Commerce POS (POS).
