...
I rivenditori possono accettare diversi tipi di pagamento per i prodotti venduti e i servizi forniti in un canale di e-commerce. Ogni tipo di pagamento accettato da un rivenditore deve essere configurato in Microsoft Dynamics 365 Commerce quando si imposta il sistema. Il metodo di pagamento del conto cliente (o "in acconto") deve essere supportato sui siti di e-commerce B2B. 
