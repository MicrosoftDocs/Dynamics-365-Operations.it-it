...
3. In Commerce, utilizzare il processo batch **Sincronizza ordini** e la programmazione distribuzione **P-001** per creare gli ordini nel back office.
...
1. In Commerce, nella pagina **Servizio clienti**, immettere **Karen Berg** nella barra di ricerca, quindi selezionare **Cerca**. 
