...
In questo argomento viene descritto come collegare un esperimento in Commerce e apportare modifiche alle varianti in modo che siano in linea con l'ipotesi. Il diagramma seguente mostra tutti i passaggi relativi alla configurazione e all'esecuzione di un esperimento su un sito Web di e-commerce in Dynamics 365 Commerce. I passaggi aggiuntivi sono esposti in argomenti separati.
...
1. Per avviare la procedura guidata, seleziona la scheda **Esperimenti** in Creazione di siti Web e quindi seleziona **Collega**. In alternativa, puoi accedere alla procedura guidata da un editor di pagine o frammenti. In modalità di modifica, seleziona **Collega l'esperimento** nella barra dei comandi.
