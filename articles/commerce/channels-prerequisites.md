---
title: Prerequisiti dell'impostazione dei canali
description: Questo articolo fornisce una panoramica dei prerequisiti di impostazione dei canali in Microsoft Dynamics 365 Commerce.
author: samjarawan
ms.date: 02/21/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9282297"
---
# <a name="channel-setup-prerequisites"></a>Prerequisiti dell'impostazione dei canali

[!include [banner](includes/banner.md)]

Questo articolo fornisce una panoramica dei prerequisiti di impostazione del canale in Microsoft Dynamics 365 Commerce.
