...
description: In questo articolo viene descritta la configurazione dei costi per la gestione ordini distribuiti (DOM) in Dynamics 365 Commerce.
author: josaw1
ms.date: 12/05/2018
ms.topic: index-page
ms.prod: ''
