...
1. Creare un frammento denominato **Frammento carrello** e aggiungere un modulo Carrello al nuovo frammento.
1. Aggiungere un'intestazione al modulo Carrello.
1. Aggiungere un modulo Selettore punto vendita al modulo Carrello.
1. Salvare il frammento, finalizzare la modifica e quindi pubblicare il frammento.
1. Creare un modello denominato **Modello carrello** e aggiungere il frammento carrello appena creato.
1. Salvare il modello, finalizzare la modifica e quindi pubblicare il modello.
1. Creare una pagina che utilizza il nuovo modello.
1. Salvare la pagina e visualizzarne l'anteprima.
1. Finalizzare la modifica e pubblicare la pagina.
