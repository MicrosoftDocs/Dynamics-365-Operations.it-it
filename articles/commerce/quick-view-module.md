---
title: Modulo di visualizzazione rapida
description: In questo articolo vengono descritti i moduli visualizzazione rapida e la procedura per aggiungerli alle pagine di siti Web in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8847577"
---
# <a name="quick-view-module"></a>Modulo di visualizzazione rapida

[!include [banner](includes/banner.md)]

In questo articolo vengono descritti i moduli visualizzazione rapida e la procedura per aggiungerli alle pagine di siti Web in Microsoft Dynamics 365 Commerce.
