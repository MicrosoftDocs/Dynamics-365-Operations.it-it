...
Questo articolo fornisce le linee guida per la distribuzione dell'esempio di integrazione della stampante fiscale per la Polonia da Dynamics 365 Commerce Retail SDK in una macchina virtuale per sviluppatori (VM) in Microsoft Dynamics Lifecycle Services (LCS). Per maggiori informazioni sull'esempio di integrazione fiscale, vedi [Esempio di integrazione della stampante fiscale per la Polonia](emea-pol-fpi-sample.md). 
