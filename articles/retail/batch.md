...
Per definire l'ID batch utilizzato per la fatturazione degli ordini cliente tramite la registrazione rendiconti, nella scheda **Registrazione** della pagina **Parametri di vendita al dettaglio** impostare il campo **ID batch predefinito** nella Scheda dettaglio **Aggiornamento dell'inventario**.
