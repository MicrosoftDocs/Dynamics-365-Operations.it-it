...
description: In questo argomento viene fornita una panoramica dei pagamenti omnicanale in Microsoft Dynamics 365 for Retail.
author: rubendel
manager: AnnBe
ms.date: 05/12/2019
ms.topic: article
...
ms.locfileid: "1606194"
---
# <a name="omni-channel-payments-overview"></a>Panoramica sui pagamenti omnicanale

[!include [banner](../includes/banner.md)]

In questo argomento viene fornita una panoramica dei pagamenti omnicanale in Microsoft Dynamics 365 for Retail. Include un elenco completo degli scenari supportati, informazioni su funzionalità, impostazione e risoluzione dei problemi nonché descrizioni di problemi tipici.
