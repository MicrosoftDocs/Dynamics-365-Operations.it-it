...
1.  Fare clic su **Vendita al dettaglio** &gt; **Impostazione canale** &gt; **Impostazioni POS** &gt; **POS** &gt; **Formati ricevuta**.
...
5.  Dopo che l'installazione è stata completata, immettere nome utente e password di Dynamics 365 for Retail e quindi fare clic su **Accedi** per avviare la finestra di progettazione.
...
1.  Aprire il profilo hardware facendo clic su **Vendita al dettaglio** &gt; **Impostazione canale** &gt; **Impostazioni POS** &gt; **Profili POS** &gt; **Profilo hardware**.
