...
---
# <a name="configure-payment-method-settings-that-affect-retail-statements"></a>Configurare le impostazioni del metodo di pagamento che influiscono sui rendiconti al dettaglio
