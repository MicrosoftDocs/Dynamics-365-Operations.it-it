...
Utilizzare le informazioni in questo articolo per contattare Microsoft se è necessario porre domande tecniche su Retail.

### <a name="retail-support"></a>Supporto per Retail

Per ottenere supporto per Retail, usare le risorse indicate nella tabella seguente. Tali risorse sono elencate nell'ordine in cui devono essere seguite durante la risoluzione di problemi.
...
<blockquote>[!NOTE] I partner e i clienti di Microsoft Premier possono inviare ticket di supporto Premier utilizzando i passaggi precedenti.</blockquote>
</td>
</tr>
<tr>
...
<li>Errori che si verificano quando si utilizza Retail.</li>
</ul>
...
Per ulteriori informazioni sui piani di supporto di Microsoft Dynamics, vedere [Supporto Microsoft Dynamics Online](https://dynamics.microsoft.com/en-us/support/).
