...
|                                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|----------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|              <strong>Profilo</strong>              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <strong>Descrizione</strong>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| <strong>Valore predefinito impostato su cassiere, se disponibile</strong> |                                                                                                                                                                                                                                                                                                                                                                                                     Se l'opzione è abilitata, il POS popola automaticamente le righe di transazione con il gruppo vendite predefinito del cassiere corrente. Se un cassiere non ha un gruppo vendite predefinito specificato, il valore non verrà impostato. Un utente può comunque impostare manualmente il gruppo vendite tramite un pulsante della griglia dei pulsanti POS.                                                                                                                                                                                                                                                                                                                                                                                                      |
|  <strong>Richiesta per il rappresentante</strong>  | Questa opzione ha tre valori possibili: <strong>No**: se viene selezionata questa opzione, all'utente non viene chiesto di selezionare un gruppo vendite. Il valore può ancora essere impostato utilizzando un gruppo vendite predefinito del cassiere o manualmente utilizzando un pulsante griglia pulsanti POS. **Inizio della transazione</strong>: se viene selezionata questa opzione e l'opzione <strong>Valore predefinito impostato su cassiere</strong> non è attivata o il cassiere corrente non ha un gruppo vendite predefinito, all'utente viene chiesto di selezionare un gruppo vendite all'inizio di ogni transazione. Se si seleziona il gruppo di vendite da questo prompt, tutte le righe successive assumerano come valore predefinito il gruppo di vendite selezionato. Un utente può comunque impostare manualmente il gruppo vendite tramite un pulsante della griglia dei pulsanti POS. <strong>Per ogni riga</strong> - se questa opzione è selezionata e l'opzione <strong>Valore predefinito impostato su cassiere</strong> non è abilitata o il cassiere corrente non è associato a un gruppo di vendite predefinito, all'utente verrà chiesto di selezionare un gruppo vendite dopo l'aggiunta di ogni riga. Un utente può comunque impostare manualmente il gruppo vendite tramite un pulsante della griglia dei pulsanti POS. |
|              <strong>Richiedi</strong>              |                                                                                                                                                                                                                                                                                                                         Questa opzione può essere utilizzata solo quando il POS è configurato per richiedere un rappresentante. Se abilitata, all'utente verrà chiesto di selezionare un gruppo vendite prima di continuare. In caso contrario, all'utente verrà chiesto, ma può annullare e continuare senza effettuare una selezione. Dopo che la riga viene aggiunta, un utente con autorizzazioni sufficienti può comunque rimuovere il gruppo vendite dalla riga. "Richiedi rappresentante" non viene applicato in questo caso.                                                                                                                                                                                                                                                                                                                          |
