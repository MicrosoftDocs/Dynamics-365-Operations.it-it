...
### [Simulatore di periferica di vendita al dettaglio](dev-itpro/retail-peripheral-simulator.md)
...
## Ordini cliente
### [Panoramica degli ordini cliente](customer-orders-overview.md)
...
## [Gerarchie punti vendita al dettaglio](retail-hierarchies.md)
...
## [Ricerca di prodotti e varianti prodotto durante la registrazione ordine](../supply-chain/pim/search-products-product-variants.md)
...
## [ Configurare i suggerimenti sul prodotto basati su Machine Learning](tasks/configure-machine-learning-product-recommendations.md)
...
## [ Creare le dimensioni finanziarie per i canali di vendita al dettaglio e configurare i valori di dimensione nei punti vendita](tasks/create-financial-dimensions-retail-channels.md)
...
## [Definire le relazioni tra le unità organizzative](tasks/design-relationships-between-organizational-units.md)
## [ Gestire assortimenti ](tasks/manage-assortments-2016-11.md)
## [ Configurazioni dei parametri per rendiconti di vendita al dettaglio](tasks/parameter-configurations-retail-statements.md)
## [ Configurazioni dei pagamenti per rendiconti di vendita al dettaglio](tasks/payment-configurations-retail-statements.md)
...
## [ Rettifiche prezzi di vendita al dettaglio](tasks/retail-price-adjustments.md)
...
## [ Configurazioni dei punti vendita per rendiconti di vendita al dettaglio](tasks/store-configurations-retail-statements.md)
## [ Utilizzare un programma di continuità](tasks/use-continuity-program.md)
## [ Configurare un lavoratore](tasks/worker.md)

# [Amministrazione e sviluppo di vendita al dettaglio](dev-itpro/dev-retail-home-page.md)
...
### [Comunicazioni del canale di vendita al dettaglio](dev-itpro/define-retail-channel-communications-cdx.md)
...
### [Panoramica dell'unità di scala punto vendita al dettaglio](dev-itpro/retail-store-system-begin.md)
...
### [Aggiungere collegamenti alle note legali e all'Informativa sulla privacy dell'organizzazione](../dev-itpro/sysadmin/legal-terms-privacy-statement.md)
...
### [Creare un'app per l'esperienza di vendita al dettaglio](dev-itpro/create-retail-experience-app.md)
...
#### [Commerce Runtime ed estendibilità del server Retail ](dev-itpro/commerce-runtime-extensibility.md)
...
#### [Creare un Windows Installer per un connettore pagamenti](dev-itpro/create-windows-installer-payment-connector.md)

## Retail SDK
### [Panoramica di Retail SDK](dev-itpro/retail-sdk/retail-sdk-overview.md)
...
### [Proxy C# e TypeScript di vendita al dettaglio](dev-itpro/typescript-proxy-retail-pos.md)
