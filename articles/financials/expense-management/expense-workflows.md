...
[!include[banner](../includes/banner.md)] È possibile impostare un processo del flusso di lavoro utilizzato per rivedere e approvare i documenti viaggi e spese. I documenti per cui è possibile definire flussi di lavoro includono note spese, richieste di viaggio e richieste di anticipo contanti.
...
|------------------------------------|----------------------------------------------------------------------|
| **Nota spese**                 | Creare flussi di lavoro di approvazione per le note spese.                       |      
| **Registrazione automatica nota spese**    | Creare flussi di lavoro di registrazione automatica per le note spese.              |     
| **Voce di spesa**              | Creare flussi di lavoro di approvazione per le voci delle note spese.         |     
| **Registrazione automatica voce di spesa** | Creare flussi di lavoro di registrazione automatica per le voci delle note spese.|
| **Richiesta di acquisto viaggio**             | Creare flussi di lavoro di approvazione per le richieste di viaggio.                   |    
| **Richiesta di anticipo contanti**           | Creare flussi di lavoro di approvazione per richieste di anticipo contanti.                 |     
| **Recupero IVA**               | Creare flussi di lavoro di approvazione per il recupero dell'imposta sul valore aggiunto (IVA). |       
