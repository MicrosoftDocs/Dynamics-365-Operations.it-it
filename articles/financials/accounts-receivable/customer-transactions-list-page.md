...
La data di scadenza viene ora aggiunta alla pagina elenco **Transazioni cliente** ed è possibile modificare più facilmente la data di scadenza e le date di sconto di cassa per le transazioni.
