...
description: Questo articolo descrive l'API di integrazione retribuzioni di Dynamics 365 Human Resources.
author: twheeloc
ms.date: 02/03/2021
ms.topic: article
ms.prod: ''
...
- [Funzionalità per contrassegnare un dipendente come Pronto per il pagamento.](hr-compensation-payroll.md)
