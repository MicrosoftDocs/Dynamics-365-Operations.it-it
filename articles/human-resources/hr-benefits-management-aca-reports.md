...
description: Questo articolo descrive come la gestione dei benefici tiene traccia delle informazioni che sono riportate sul modulo 1095-B e sul modulo 1095-C per il mandato del datore di lavoro dell'Affordable Care Act (ACA).
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
