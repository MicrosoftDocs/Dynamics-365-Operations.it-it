...
| --- | --- |
| Platform Update 10.0.20 (44) | L'implementazione dell'aggiornamento della piattaforma 10.0.20 inizierà con la versione di servizio il 26 luglio 2021. Per ulteriori informazioni, vedi [Aggiornamenti della piattaforma per la versione 10.0.20 delle app Finance and Operations (agosto 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-20). |
