...
- <span data-ttu-id="af9a3-111">Dati di Risorse umane</span><span class="sxs-lookup"><span data-stu-id="af9a3-111">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="af9a3-141">Configurare i dati</span><span class="sxs-lookup"><span data-stu-id="af9a3-141">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="af9a3-158">Benefit</span><span class="sxs-lookup"><span data-stu-id="af9a3-158">Benefits</span></span>
...
<span data-ttu-id="af9a3-187">Per altre informazioni su come definire e gestire un programma di benefit, vedere gli articoli seguenti:</span><span class="sxs-lookup"><span data-stu-id="af9a3-187">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- [<span data-ttu-id="af9a3-204">Definire il processo retributivo e calcolare i risultati</span><span class="sxs-lookup"><span data-stu-id="af9a3-204">Define compensation process and calculate results</span></span>](https://docs.microsoft.com/dynamics365/unified-operations/fin-and-ops/hr/tasks/define-compensation-process-calculate-results)
...
- <span data-ttu-id="af9a3-226">Ciclo retributivo (obbligatorio).</span><span class="sxs-lookup"><span data-stu-id="af9a3-226">Pay cycle (required)</span></span>
...
#### <a name="pay-cycles-and-pay-periods"></a><span data-ttu-id="af9a3-241">Cicli e periodi retributivi</span><span class="sxs-lookup"><span data-stu-id="af9a3-241">Pay cycles and pay periods</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="af9a3-257">Codici di reddito</span><span class="sxs-lookup"><span data-stu-id="af9a3-257">Earning codes</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="af9a3-296">Informazioni contatto</span><span class="sxs-lookup"><span data-stu-id="af9a3-296">Contact information</span></span> 
...
- <span data-ttu-id="af9a3-358">Principale (obbligatorio)</span><span class="sxs-lookup"><span data-stu-id="af9a3-358">Primary (required)</span></span>
...
- <span data-ttu-id="af9a3-380">Principale (obbligatorio)</span><span class="sxs-lookup"><span data-stu-id="af9a3-380">Primary (required)</span></span>
...
<span data-ttu-id="af9a3-421">I seguenti codici motivo e le descrizioni sono obbligatori.</span><span class="sxs-lookup"><span data-stu-id="af9a3-421">The following reason codes and descriptions are required.</span></span>
...
| <span data-ttu-id="af9a3-458">Vedovo/a</span><span class="sxs-lookup"><span data-stu-id="af9a3-458">Widowed</span></span>                | <span data-ttu-id="af9a3-459">Vedovo/a</span><span class="sxs-lookup"><span data-stu-id="af9a3-459">Widowed</span></span>              |
...
- <span data-ttu-id="af9a3-491">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-491">2OFMTH</span></span>
...
| <span data-ttu-id="af9a3-516">Risorse umane</span><span class="sxs-lookup"><span data-stu-id="af9a3-516">Human Resources</span></span>          | <span data-ttu-id="af9a3-517">Dayforce</span><span class="sxs-lookup"><span data-stu-id="af9a3-517">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="af9a3-518">Paese/area geografica</span><span class="sxs-lookup"><span data-stu-id="af9a3-518">Country/Region</span></span>  | <span data-ttu-id="af9a3-519">Codice paese</span><span class="sxs-lookup"><span data-stu-id="af9a3-519">Country Code</span></span>          |
| <span data-ttu-id="af9a3-520">CAP/Codice postale</span><span class="sxs-lookup"><span data-stu-id="af9a3-520">Zip/Postal Code</span></span> | <span data-ttu-id="af9a3-521">CAP</span><span class="sxs-lookup"><span data-stu-id="af9a3-521">Postal Code</span></span>           |
| <span data-ttu-id="af9a3-522">Stato/regione</span><span class="sxs-lookup"><span data-stu-id="af9a3-522">State</span></span>           | <span data-ttu-id="af9a3-523">Codice stato</span><span class="sxs-lookup"><span data-stu-id="af9a3-523">State Code</span></span>            |
| <span data-ttu-id="af9a3-524">Città</span><span class="sxs-lookup"><span data-stu-id="af9a3-524">City</span></span>            | <span data-ttu-id="af9a3-525">Città</span><span class="sxs-lookup"><span data-stu-id="af9a3-525">City</span></span>                  |
| <span data-ttu-id="af9a3-526">Regione</span><span class="sxs-lookup"><span data-stu-id="af9a3-526">County</span></span>          | <span data-ttu-id="af9a3-527">Provincia (municipalità)</span><span class="sxs-lookup"><span data-stu-id="af9a3-527">County (Municipality)</span></span> |
| <span data-ttu-id="af9a3-528">Via</span><span class="sxs-lookup"><span data-stu-id="af9a3-528">Street</span></span>          | <span data-ttu-id="af9a3-529">Riga indirizzo 1</span><span class="sxs-lookup"><span data-stu-id="af9a3-529">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="af9a3-530">Regioni fiscali</span><span class="sxs-lookup"><span data-stu-id="af9a3-530">Tax regions</span></span>

<span data-ttu-id="af9a3-531">Le regioni fiscali vengono utilizzate per determinare l'imposta appropriata che deve essere applicata durante la generazione delle retribuzioni.</span><span class="sxs-lookup"><span data-stu-id="af9a3-531">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="af9a3-532">Le regioni fiscali vengono mappate in Dayforce come indirizzi di ubicazione.</span><span class="sxs-lookup"><span data-stu-id="af9a3-532">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="af9a3-533">La regione fiscale predefinita deve essere associata alla posizione attiva del lavoratore.</span><span class="sxs-lookup"><span data-stu-id="af9a3-533">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="af9a3-534">Regione fiscale (obbligatoria)</span><span class="sxs-lookup"><span data-stu-id="af9a3-534">Tax region (required)</span></span>
- <span data-ttu-id="af9a3-535">Paese/regione (obbligatorio)</span><span class="sxs-lookup"><span data-stu-id="af9a3-535">Country/Region (required)</span></span>
- <span data-ttu-id="af9a3-536">Stato (obbligatorio)</span><span class="sxs-lookup"><span data-stu-id="af9a3-536">State (required)</span></span>
- <span data-ttu-id="af9a3-537">Regione</span><span class="sxs-lookup"><span data-stu-id="af9a3-537">County</span></span> 
- <span data-ttu-id="af9a3-538">Città (obbligatoria)</span><span class="sxs-lookup"><span data-stu-id="af9a3-538">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="af9a3-539">Configurare i dati per generare le retribuzioni in Messico</span><span class="sxs-lookup"><span data-stu-id="af9a3-539">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="af9a3-540">Se si desidera generare la retribuzione per i dipendenti in Messico, i seguenti elementi devono essere configurati:</span><span class="sxs-lookup"><span data-stu-id="af9a3-540">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="af9a3-541">I reparti sono necessari nelle posizioni.</span><span class="sxs-lookup"><span data-stu-id="af9a3-541">Departments are required on positions.</span></span>
- <span data-ttu-id="af9a3-542">I centri di costo devono essere impostati come dimensioni finanziarie ed essere il primo elemento nella stringa della dimensione finanziaria predefinita.</span><span class="sxs-lookup"><span data-stu-id="af9a3-542">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="af9a3-543">Tipi di posizione lavorativa</span><span class="sxs-lookup"><span data-stu-id="af9a3-543">Job types</span></span>

<span data-ttu-id="af9a3-544">I tipi di mansione vengono utilizzati per raggruppare mansioni simili in categorie.</span><span class="sxs-lookup"><span data-stu-id="af9a3-544">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="af9a3-545">Tipi di mansione necessari per elaborare le retribuzioni in Messico.</span><span class="sxs-lookup"><span data-stu-id="af9a3-545">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="af9a3-546">Alcuni esempi di tipi di mansione includono il tempo pieno e il part-time o stipendio e retribuzione oraria.</span><span class="sxs-lookup"><span data-stu-id="af9a3-546">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="af9a3-547">I tipi di mansioni vengono mappati in Dayforce come tipi di retribuzione che indicano se un dipendente viene pagato a ore o è stipendiato.</span><span class="sxs-lookup"><span data-stu-id="af9a3-547">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="af9a3-548">I seguenti tipi di mansione e le descrizioni sono obbligatori.</span><span class="sxs-lookup"><span data-stu-id="af9a3-548">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="af9a3-549">Tipo di processo</span><span class="sxs-lookup"><span data-stu-id="af9a3-549">Job type</span></span>   | <span data-ttu-id="af9a3-550">Descrizione</span><span class="sxs-lookup"><span data-stu-id="af9a3-550">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="af9a3-551">Su base oraria</span><span class="sxs-lookup"><span data-stu-id="af9a3-551">Hourly</span></span>     | <span data-ttu-id="af9a3-552">Su base oraria MX</span><span class="sxs-lookup"><span data-stu-id="af9a3-552">MX Hourly</span></span>   |
| <span data-ttu-id="af9a3-553">Stipendiato</span><span class="sxs-lookup"><span data-stu-id="af9a3-553">Salaried</span></span>   | <span data-ttu-id="af9a3-554">Stipendiato MX</span><span class="sxs-lookup"><span data-stu-id="af9a3-554">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="af9a3-555">Tipi di posizione</span><span class="sxs-lookup"><span data-stu-id="af9a3-555">Position types</span></span> 

<span data-ttu-id="af9a3-556">Si utilizzano i tipi di posizione per descrivere se è la posizione è a tempo pieno, part-time o altro.</span><span class="sxs-lookup"><span data-stu-id="af9a3-556">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="af9a3-557">I tipi di posizione vengono mappati in Dayforce come classi di retribuzione che indicano se un dipendente viene pagato a tempo pieno o part-time.</span><span class="sxs-lookup"><span data-stu-id="af9a3-557">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="af9a3-558">I seguenti tipi di posizione e le descrizioni sono obbligatori.</span><span class="sxs-lookup"><span data-stu-id="af9a3-558">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="af9a3-559">Tipo di posizione</span><span class="sxs-lookup"><span data-stu-id="af9a3-559">Position type</span></span>   | <span data-ttu-id="af9a3-560">Descrizione</span><span class="sxs-lookup"><span data-stu-id="af9a3-560">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="af9a3-561">A tempo pieno</span><span class="sxs-lookup"><span data-stu-id="af9a3-561">Full-time</span></span>       | <span data-ttu-id="af9a3-562">Dipendente a tempo pieno</span><span class="sxs-lookup"><span data-stu-id="af9a3-562">Full time employee</span></span> |
| <span data-ttu-id="af9a3-563">A tempo parziale</span><span class="sxs-lookup"><span data-stu-id="af9a3-563">Part-time</span></span>       | <span data-ttu-id="af9a3-564">Dipendente a tempo parziale</span><span class="sxs-lookup"><span data-stu-id="af9a3-564">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="af9a3-565">Codici causale</span><span class="sxs-lookup"><span data-stu-id="af9a3-565">Reason codes</span></span>

<span data-ttu-id="af9a3-566">I codici motivo forniscono informazioni sullo stato di un dipendente.</span><span class="sxs-lookup"><span data-stu-id="af9a3-566">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="af9a3-567">I codici motivo vengono mappati in Dayforce come motivi di stato che indicano il motivo dei cambiamenti nella posizione del dipendente o nello stato di impiego.</span><span class="sxs-lookup"><span data-stu-id="af9a3-567">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="af9a3-568">I seguenti codici motivo e le descrizioni sono obbligatori.</span><span class="sxs-lookup"><span data-stu-id="af9a3-568">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="af9a3-569">Codice motivo</span><span class="sxs-lookup"><span data-stu-id="af9a3-569">Reason code</span></span>            | <span data-ttu-id="af9a3-570">Descrizione</span><span class="sxs-lookup"><span data-stu-id="af9a3-570">Description</span></span>                    | <span data-ttu-id="af9a3-571">Scenari applicabili</span><span class="sxs-lookup"><span data-stu-id="af9a3-571">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="af9a3-572">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="af9a3-572">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="af9a3-573">Partenza prima della prima retribuzione</span><span class="sxs-lookup"><span data-stu-id="af9a3-573">Departure before first payroll</span></span> | <span data-ttu-id="af9a3-574">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-574">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-575">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="af9a3-575">RESIGNATION</span></span>            | <span data-ttu-id="af9a3-576">Dimissioni</span><span class="sxs-lookup"><span data-stu-id="af9a3-576">Resignation</span></span>                    | <span data-ttu-id="af9a3-577">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-577">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-578">PENSION</span><span class="sxs-lookup"><span data-stu-id="af9a3-578">PENSION</span></span>                | <span data-ttu-id="af9a3-579">Pensionamento</span><span class="sxs-lookup"><span data-stu-id="af9a3-579">Pension</span></span>                        | <span data-ttu-id="af9a3-580">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-580">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-581">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="af9a3-581">TERMINATION</span></span>            | <span data-ttu-id="af9a3-582">Fine</span><span class="sxs-lookup"><span data-stu-id="af9a3-582">Termination</span></span>                    | <span data-ttu-id="af9a3-583">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-583">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-584">RETIREMENT</span><span class="sxs-lookup"><span data-stu-id="af9a3-584">RETIREMENT</span></span>             | <span data-ttu-id="af9a3-585">Pensione</span><span class="sxs-lookup"><span data-stu-id="af9a3-585">Retirement</span></span>                     | <span data-ttu-id="af9a3-586">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-586">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-587">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="af9a3-587">ABSENTEE</span></span>               | <span data-ttu-id="af9a3-588">Assente</span><span class="sxs-lookup"><span data-stu-id="af9a3-588">Absentee</span></span>                       | <span data-ttu-id="af9a3-589">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-589">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-590">OTHER</span><span class="sxs-lookup"><span data-stu-id="af9a3-590">OTHER</span></span>                  | <span data-ttu-id="af9a3-591">Altri motivi</span><span class="sxs-lookup"><span data-stu-id="af9a3-591">Other Reasons</span></span>                  | <span data-ttu-id="af9a3-592">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-592">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-593">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="af9a3-593">CLOSURE</span></span>                | <span data-ttu-id="af9a3-594">Chiusura attività</span><span class="sxs-lookup"><span data-stu-id="af9a3-594">Business Closure</span></span>               | <span data-ttu-id="af9a3-595">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-595">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-596">DEATH</span><span class="sxs-lookup"><span data-stu-id="af9a3-596">DEATH</span></span>                  | <span data-ttu-id="af9a3-597">Decesso</span><span class="sxs-lookup"><span data-stu-id="af9a3-597">Death</span></span>                          | <span data-ttu-id="af9a3-598">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-598">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-599">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="af9a3-599">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="af9a3-600">Congedo e assenza</span><span class="sxs-lookup"><span data-stu-id="af9a3-600">Leave of Absence</span></span>               | <span data-ttu-id="af9a3-601">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-601">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-602">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="af9a3-602">CONTRACTEND</span></span>            | <span data-ttu-id="af9a3-603">Fine di contratto</span><span class="sxs-lookup"><span data-stu-id="af9a3-603">End of Contract</span></span>                | <span data-ttu-id="af9a3-604">Termina rapporto con lavoratore</span><span class="sxs-lookup"><span data-stu-id="af9a3-604">Terminate worker</span></span>     |
| <span data-ttu-id="af9a3-605">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="af9a3-605">SALARYCHANGE</span></span>           | <span data-ttu-id="af9a3-606">Modifica dello stipendio</span><span class="sxs-lookup"><span data-stu-id="af9a3-606">Change of Salary</span></span>               | <span data-ttu-id="af9a3-607">Retribuzione</span><span class="sxs-lookup"><span data-stu-id="af9a3-607">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="af9a3-608">Condizioni di impiego</span><span class="sxs-lookup"><span data-stu-id="af9a3-608">Terms of employment</span></span>

<span data-ttu-id="af9a3-609">Le condizioni di impiego vengono utilizzate per creare categorie di termini di impiego.</span><span class="sxs-lookup"><span data-stu-id="af9a3-609">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="af9a3-610">I termini vengono mappati in Dayforce come valori degli indicatori di impiego.</span><span class="sxs-lookup"><span data-stu-id="af9a3-610">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="af9a3-611">I seguenti termini di impiego e le descrizioni sono obbligatori.</span><span class="sxs-lookup"><span data-stu-id="af9a3-611">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="af9a3-612">Condizioni di impiego</span><span class="sxs-lookup"><span data-stu-id="af9a3-612">Terms of employment</span></span>   | <span data-ttu-id="af9a3-613">Descrizione</span><span class="sxs-lookup"><span data-stu-id="af9a3-613">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="af9a3-614">Regolare</span><span class="sxs-lookup"><span data-stu-id="af9a3-614">Regular</span></span>               | <span data-ttu-id="af9a3-615">Regolare</span><span class="sxs-lookup"><span data-stu-id="af9a3-615">Regular</span></span>     |
| <span data-ttu-id="af9a3-616">Diretto</span><span class="sxs-lookup"><span data-stu-id="af9a3-616">Direct</span></span>                | <span data-ttu-id="af9a3-617">Diretto</span><span class="sxs-lookup"><span data-stu-id="af9a3-617">Direct</span></span>      |
| <span data-ttu-id="af9a3-618">Internato</span><span class="sxs-lookup"><span data-stu-id="af9a3-618">Internship</span></span>            | <span data-ttu-id="af9a3-619">Internato</span><span class="sxs-lookup"><span data-stu-id="af9a3-619">Internship</span></span>  |
| <span data-ttu-id="af9a3-620">Permanente</span><span class="sxs-lookup"><span data-stu-id="af9a3-620">Permanent</span></span>             | <span data-ttu-id="af9a3-621">Permanente</span><span class="sxs-lookup"><span data-stu-id="af9a3-621">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="af9a3-622">Stato civile</span><span class="sxs-lookup"><span data-stu-id="af9a3-622">Marital status</span></span>

<span data-ttu-id="af9a3-623">I valori dello stato civile vengono mappati in Dayforce e tradotti, come appropriato, nei valori accettati con l'integrazione.</span><span class="sxs-lookup"><span data-stu-id="af9a3-623">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="af9a3-624">Nella tabella seguente vengono illustrati in che modo i valori dello stato civile vengono mappati in Dayforce.</span><span class="sxs-lookup"><span data-stu-id="af9a3-624">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="af9a3-625">Risorse umane</span><span class="sxs-lookup"><span data-stu-id="af9a3-625">Human Resources</span></span>                 | <span data-ttu-id="af9a3-626">Dayforce</span><span class="sxs-lookup"><span data-stu-id="af9a3-626">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="af9a3-627">Sposato/a</span><span class="sxs-lookup"><span data-stu-id="af9a3-627">Married</span></span>                | <span data-ttu-id="af9a3-628">Sposato/a</span><span class="sxs-lookup"><span data-stu-id="af9a3-628">Married</span></span>                   |
| <span data-ttu-id="af9a3-629">Celibe/nubile</span><span class="sxs-lookup"><span data-stu-id="af9a3-629">Single</span></span>                 | <span data-ttu-id="af9a3-630">Celibe/nubile</span><span class="sxs-lookup"><span data-stu-id="af9a3-630">Single</span></span>                    |
| <span data-ttu-id="af9a3-631">Vedovo/a</span><span class="sxs-lookup"><span data-stu-id="af9a3-631">Widowed</span></span>                | <span data-ttu-id="af9a3-632">Vedovo/a</span><span class="sxs-lookup"><span data-stu-id="af9a3-632">Widowed</span></span>                   |
| <span data-ttu-id="af9a3-633">Divorziato/a</span><span class="sxs-lookup"><span data-stu-id="af9a3-633">Divorced</span></span>               | <span data-ttu-id="af9a3-634">Divorziato/a</span><span class="sxs-lookup"><span data-stu-id="af9a3-634">Divorced</span></span>                  |
| <span data-ttu-id="af9a3-635">Relazione registrata</span><span class="sxs-lookup"><span data-stu-id="af9a3-635">Registered Partnership</span></span> | <span data-ttu-id="af9a3-636">Relazione nazionale</span><span class="sxs-lookup"><span data-stu-id="af9a3-636">Domestic Partnership</span></span>      |
| <span data-ttu-id="af9a3-637">Nessuna</span><span class="sxs-lookup"><span data-stu-id="af9a3-637">None</span></span>                   | <span data-ttu-id="af9a3-638">*Non supportato in Messico*</span><span class="sxs-lookup"><span data-stu-id="af9a3-638">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="af9a3-639">Coabitazione</span><span class="sxs-lookup"><span data-stu-id="af9a3-639">Cohabiting</span></span>             | <span data-ttu-id="af9a3-640">*Non supportato in Messico*</span><span class="sxs-lookup"><span data-stu-id="af9a3-640">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="af9a3-641">Genere</span><span class="sxs-lookup"><span data-stu-id="af9a3-641">Gender</span></span>

<span data-ttu-id="af9a3-642">Le designazioni di sesso vengono mappate in Dayforce e tradotte, come appropriato, nei valori accettati con l'integrazione.</span><span class="sxs-lookup"><span data-stu-id="af9a3-642">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="af9a3-643">Nella tabella seguente vengono illustrati in che modo le designazioni di sesso vengono mappate in Dayforce.</span><span class="sxs-lookup"><span data-stu-id="af9a3-643">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="af9a3-644">Risorse umane</span><span class="sxs-lookup"><span data-stu-id="af9a3-644">Human Resources</span></span>       | <span data-ttu-id="af9a3-645">Dayforce</span><span class="sxs-lookup"><span data-stu-id="af9a3-645">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="af9a3-646">Maschio</span><span class="sxs-lookup"><span data-stu-id="af9a3-646">Male</span></span>         | <span data-ttu-id="af9a3-647">Maschio</span><span class="sxs-lookup"><span data-stu-id="af9a3-647">Male</span></span>                      |
| <span data-ttu-id="af9a3-648">Femmina</span><span class="sxs-lookup"><span data-stu-id="af9a3-648">Female</span></span>       | <span data-ttu-id="af9a3-649">Femmina</span><span class="sxs-lookup"><span data-stu-id="af9a3-649">Female</span></span>                    |
| <span data-ttu-id="af9a3-650">Non specifico</span><span class="sxs-lookup"><span data-stu-id="af9a3-650">Non-specific</span></span> | <span data-ttu-id="af9a3-651">*Non supportato in Messico*</span><span class="sxs-lookup"><span data-stu-id="af9a3-651">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="af9a3-652">Metodo di pagamento</span><span class="sxs-lookup"><span data-stu-id="af9a3-652">Payment method</span></span>

<span data-ttu-id="af9a3-653">I metodi di pagamento offrono al dipendente e all'azienda un modo per descrivere la modalità di pagamento dei dipendenti.</span><span class="sxs-lookup"><span data-stu-id="af9a3-653">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="af9a3-654">I metodi di pagamento vengono mappati in Dayforce e tradotti, come appropriato, nei valori accettati con l'integrazione.</span><span class="sxs-lookup"><span data-stu-id="af9a3-654">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="af9a3-655">Nella tabella seguente vengono illustrati in che modo i metodi di pagamento vengono mappati in Dayforce.</span><span class="sxs-lookup"><span data-stu-id="af9a3-655">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="af9a3-656">Risorse umane</span><span class="sxs-lookup"><span data-stu-id="af9a3-656">Human Resources</span></span>             | <span data-ttu-id="af9a3-657">Dayforce</span><span class="sxs-lookup"><span data-stu-id="af9a3-657">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="af9a3-658">Contanti</span><span class="sxs-lookup"><span data-stu-id="af9a3-658">Cash</span></span>               | <span data-ttu-id="af9a3-659">Contanti</span><span class="sxs-lookup"><span data-stu-id="af9a3-659">Cash</span></span>                      |
| <span data-ttu-id="af9a3-660">Pagamento elettronico</span><span class="sxs-lookup"><span data-stu-id="af9a3-660">Electronic Payment</span></span> | <span data-ttu-id="af9a3-661">Trasferimenti</span><span class="sxs-lookup"><span data-stu-id="af9a3-661">Transfer</span></span>                  |
| <span data-ttu-id="af9a3-662">Seleziona</span><span class="sxs-lookup"><span data-stu-id="af9a3-662">Check</span></span>              | <span data-ttu-id="af9a3-663">Assegno</span><span class="sxs-lookup"><span data-stu-id="af9a3-663">Cheque</span></span>                    |
| <span data-ttu-id="af9a3-664">Assegno circolare</span><span class="sxs-lookup"><span data-stu-id="af9a3-664">Bank Draft</span></span>         | <span data-ttu-id="af9a3-665">*Non supportato in Messico*</span><span class="sxs-lookup"><span data-stu-id="af9a3-665">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="af9a3-666">Altro</span><span class="sxs-lookup"><span data-stu-id="af9a3-666">Other</span></span>              | <span data-ttu-id="af9a3-667">*Non supportato in Messico*</span><span class="sxs-lookup"><span data-stu-id="af9a3-667">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="af9a3-668">Tipo di conto bancario</span><span class="sxs-lookup"><span data-stu-id="af9a3-668">Bank account type</span></span>

<span data-ttu-id="af9a3-669">I tipi di conto bancario vengono utilizzati per i pagamenti elettronici ai dipendenti.</span><span class="sxs-lookup"><span data-stu-id="af9a3-669">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="af9a3-670">I tipi di conto bancario vengono mappati in Dayforce come informazioni sul conto di trasferimento.</span><span class="sxs-lookup"><span data-stu-id="af9a3-670">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="af9a3-671">I tipi di conto bancario vengono convertiti, come appropriato, nei valori accettati per l'integrazione.</span><span class="sxs-lookup"><span data-stu-id="af9a3-671">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="af9a3-672">Risorse umane</span><span class="sxs-lookup"><span data-stu-id="af9a3-672">Human Resources</span></span>            | <span data-ttu-id="af9a3-673">Dayforce</span><span class="sxs-lookup"><span data-stu-id="af9a3-673">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="af9a3-674">Conto corrente</span><span class="sxs-lookup"><span data-stu-id="af9a3-674">Checking Account</span></span>  | <span data-ttu-id="af9a3-675">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="af9a3-675">CheckingAccount</span></span>           |
| <span data-ttu-id="af9a3-676">Conto retribuzioni</span><span class="sxs-lookup"><span data-stu-id="af9a3-676">Payroll Account</span></span>   | <span data-ttu-id="af9a3-677">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="af9a3-677">PayrollAccount</span></span>            |
| <span data-ttu-id="af9a3-678">Conto di risparmio</span><span class="sxs-lookup"><span data-stu-id="af9a3-678">Savings Account</span></span>   | <span data-ttu-id="af9a3-679">*Non supportato in Messico*</span><span class="sxs-lookup"><span data-stu-id="af9a3-679">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="af9a3-680">Conto Bankgirot</span><span class="sxs-lookup"><span data-stu-id="af9a3-680">BankGirot account</span></span> | <span data-ttu-id="af9a3-681">*Non supportato in Messico*</span><span class="sxs-lookup"><span data-stu-id="af9a3-681">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="af9a3-682">Conto PlusGirot</span><span class="sxs-lookup"><span data-stu-id="af9a3-682">PlusGirot account</span></span> | <span data-ttu-id="af9a3-683">*Non supportato in Messico*</span><span class="sxs-lookup"><span data-stu-id="af9a3-683">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="af9a3-684">Codici di reddito</span><span class="sxs-lookup"><span data-stu-id="af9a3-684">Earning codes</span></span>

<span data-ttu-id="af9a3-685">I codici di reddito identificano in modo univoco ogni tipo di reddito che i lavoratori ricevono.</span><span class="sxs-lookup"><span data-stu-id="af9a3-685">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="af9a3-686">I codici contengono vari parametri correlati ai ricavi, ad esempio regole contabili, leggi fiscali, requisiti di reporting e capacità di calcolo lordo.</span><span class="sxs-lookup"><span data-stu-id="af9a3-686">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="af9a3-687">Se una frequenza non supportata viene utilizzata, la frequenza **Ogni retribuzione** viene utilizzata per impostazione predefinita per il calcolo.</span><span class="sxs-lookup"><span data-stu-id="af9a3-687">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="af9a3-688">Frequenze supportate</span><span class="sxs-lookup"><span data-stu-id="af9a3-688">Supported frequencies</span></span>

- <span data-ttu-id="af9a3-689">Tutti</span><span class="sxs-lookup"><span data-stu-id="af9a3-689">All</span></span>
- <span data-ttu-id="af9a3-690">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="af9a3-690">EVERYPAY</span></span>
- <span data-ttu-id="af9a3-691">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="af9a3-691">EACHPAYPERIOD</span></span>
- <span data-ttu-id="af9a3-692">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="af9a3-692">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="af9a3-693">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="af9a3-693">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="af9a3-694">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-694">1OFMTH</span></span>
- <span data-ttu-id="af9a3-695">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-695">LASTOFMTH</span></span>
- <span data-ttu-id="af9a3-696">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-696">2OFMTH</span></span>
- <span data-ttu-id="af9a3-697">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-697">3OFMTH</span></span>
- <span data-ttu-id="af9a3-698">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-698">4OFMTH</span></span>
- <span data-ttu-id="af9a3-699">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-699">5OFMTH</span></span>
- <span data-ttu-id="af9a3-700">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-700">1N2OFMTH</span></span>
- <span data-ttu-id="af9a3-701">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-701">3N4OFMTH</span></span>
- <span data-ttu-id="af9a3-702">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-702">1N3OFMTH</span></span>
- <span data-ttu-id="af9a3-703">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-703">1N4OFMTH</span></span>
- <span data-ttu-id="af9a3-704">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-704">2N3OFMTH</span></span>
- <span data-ttu-id="af9a3-705">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-705">2N4OFMTH</span></span>
- <span data-ttu-id="af9a3-706">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-706">1N2N3OFMTH</span></span>
- <span data-ttu-id="af9a3-707">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-707">1N2N4OFMTH</span></span>
- <span data-ttu-id="af9a3-708">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-708">1N3N4OFMTH</span></span>
- <span data-ttu-id="af9a3-709">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-709">2N3N4OFMTH</span></span>
- <span data-ttu-id="af9a3-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="af9a3-710">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="af9a3-711">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="af9a3-711">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="af9a3-712">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="af9a3-712">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="af9a3-713">LASTOFQTR - LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="af9a3-713">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="af9a3-714">LASTMTHOFQTR - LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="af9a3-714">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="af9a3-715">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="af9a3-715">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="af9a3-716">LASTOFYEAR - LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="af9a3-716">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="af9a3-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="af9a3-717">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="af9a3-718">Indirizzi</span><span class="sxs-lookup"><span data-stu-id="af9a3-718">Addresses</span></span>

<span data-ttu-id="af9a3-719">L'identificazione del paese specifico o dei codici di paese, stato e provincia (municipalità) richiede formati specifici che i fornitori di Dayforce e nazionali/regionali possono riconoscere.</span><span class="sxs-lookup"><span data-stu-id="af9a3-719">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="af9a3-720">Sebbene il formato per le città sia flessibile, ogni città deve essere associata a uno stato.</span><span class="sxs-lookup"><span data-stu-id="af9a3-720">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="af9a3-721">Risorse umane</span><span class="sxs-lookup"><span data-stu-id="af9a3-721">Human Resources</span></span>              | <span data-ttu-id="af9a3-722">Dayforce</span><span class="sxs-lookup"><span data-stu-id="af9a3-722">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="af9a3-723">Paese/area geografica</span><span class="sxs-lookup"><span data-stu-id="af9a3-723">Country/Region</span></span>      | <span data-ttu-id="af9a3-724">Codice paese</span><span class="sxs-lookup"><span data-stu-id="af9a3-724">Country Code</span></span>          |
| <span data-ttu-id="af9a3-725">CAP/Codice postale</span><span class="sxs-lookup"><span data-stu-id="af9a3-725">Zip/Postal Code</span></span>     | <span data-ttu-id="af9a3-726">CAP</span><span class="sxs-lookup"><span data-stu-id="af9a3-726">Postal Code</span></span>           |
| <span data-ttu-id="af9a3-727">Stato/regione</span><span class="sxs-lookup"><span data-stu-id="af9a3-727">State</span></span>               | <span data-ttu-id="af9a3-728">Codice stato</span><span class="sxs-lookup"><span data-stu-id="af9a3-728">State Code</span></span>            |
| <span data-ttu-id="af9a3-729">Città</span><span class="sxs-lookup"><span data-stu-id="af9a3-729">City</span></span>                | <span data-ttu-id="af9a3-730">Città</span><span class="sxs-lookup"><span data-stu-id="af9a3-730">City</span></span>                  |
| <span data-ttu-id="af9a3-731">Regione</span><span class="sxs-lookup"><span data-stu-id="af9a3-731">County</span></span>              | <span data-ttu-id="af9a3-732">Provincia (municipalità)</span><span class="sxs-lookup"><span data-stu-id="af9a3-732">County (Municipality)</span></span> |
| <span data-ttu-id="af9a3-733">Via</span><span class="sxs-lookup"><span data-stu-id="af9a3-733">Street</span></span>              | <span data-ttu-id="af9a3-734">Riga indirizzo 1</span><span class="sxs-lookup"><span data-stu-id="af9a3-734">Address Line 1</span></span>        |
| <span data-ttu-id="af9a3-735">Numero civico</span><span class="sxs-lookup"><span data-stu-id="af9a3-735">Street Number</span></span>       | <span data-ttu-id="af9a3-736">Riga indirizzo 2</span><span class="sxs-lookup"><span data-stu-id="af9a3-736">Address Line 2</span></span>        |
| <span data-ttu-id="af9a3-737">Informazioni aggiuntive sull'indirizzo</span><span class="sxs-lookup"><span data-stu-id="af9a3-737">Building Complement</span></span> | <span data-ttu-id="af9a3-738">Riga indirizzo 5</span><span class="sxs-lookup"><span data-stu-id="af9a3-738">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="af9a3-739">Numero passaporto</span><span class="sxs-lookup"><span data-stu-id="af9a3-739">Passport number</span></span>

<span data-ttu-id="af9a3-740">I dipendenti possono indicare le informazioni sul passaporto.</span><span class="sxs-lookup"><span data-stu-id="af9a3-740">Employees can declare passport information.</span></span> <span data-ttu-id="af9a3-741">Queste informazioni sono del tipo di identificazione **Passaporto** e vengono integrate in Dayforce come parte delle informazioni di un dipendente specifiche per il Messico.</span><span class="sxs-lookup"><span data-stu-id="af9a3-741">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="af9a3-742">Tipo di identificazione = "Passaporto"</span><span class="sxs-lookup"><span data-stu-id="af9a3-742">Identification Type = "Passport"</span></span>
- <span data-ttu-id="af9a3-743">Data di emissione</span><span class="sxs-lookup"><span data-stu-id="af9a3-743">Issued Date</span></span>
- <span data-ttu-id="af9a3-744">Data di scadenza</span><span class="sxs-lookup"><span data-stu-id="af9a3-744">Expiration Date</span></span>

<span data-ttu-id="af9a3-745">I dipendenti possono dichiarare più numeri di identificazione più del tipo di identificazione **Passaporto**.</span><span class="sxs-lookup"><span data-stu-id="af9a3-745">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="af9a3-746">Tuttavia, solo l'immissione del passaporto attivo corrente viene integrata in Dayforce.</span><span class="sxs-lookup"><span data-stu-id="af9a3-746">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="af9a3-747">Se tutte le immissioni di passaporto sono scadute, in Dayforce viene integrato il passaporto di emissione più recente.</span><span class="sxs-lookup"><span data-stu-id="af9a3-747">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
