...
## <a name="preview-leave-accrual-transaction-auditing"></a>(Anteprima) Controllo transazione accumulo per congedo

[!include [Preview feature](includes/preview-feature.md)]

Questa funzionalità di anteprima consente ai responsabili delle ferie e delle assenze di comprendere le transazioni di accumulo di ferie e assenze relative ai saldi di ferie di un dipendente per un tipo di ferie specifico.
