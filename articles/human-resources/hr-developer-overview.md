...
Questa Guida per gli sviluppatori fornisce un'API e riferimenti ai campi personalizzati. Fornisce inoltre informazioni sull'integrazione con altre app.

- [Panoramica](hr-developer-overview.md)
