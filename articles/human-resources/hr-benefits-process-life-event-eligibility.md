...
description: Questo articolo spiega come elaborare l'ammissibilità degli eventi della vita.
author: twheeloc
ms.date: 08/23/2021
ms.topic: article
ms.prod: ''
...
Questo articolo spiega come procedere per l'idoneità agli eventi della vita.

1. Nell'area di lavoro **Gestione benefit**, sotto **Elaborazione**, selezionare **Elaborazione idoneità a eventi reali**.

2. Nella finestra di dialogo **Esegui elaborazione idoneità a eventi reali**, specificare i valori per i seguenti campi:

   | Campo | Descrizione |
   | --- | --- |
   | **Periodo di iscrizione** | Il periodo di iscrizione per il quale elaborare l'idoneità a eventi reali. |
