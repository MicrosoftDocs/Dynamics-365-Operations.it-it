...
description: Questo articolo include informazioni di concetto su reparti, mansioni e posizioni sono elementi organizzativi che vengono gestiti in Risorse umane.
author: twheeloc
ms.date: 01/03/2022
ms.topic: article
ms.prod: ''
