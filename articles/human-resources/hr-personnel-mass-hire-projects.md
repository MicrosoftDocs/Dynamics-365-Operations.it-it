...
description: Questo articolo descrive i progetti di assunzione collettiva che consentono ai responsabili delle risorse umane di creare più posizioni e assumere in modo efficiente i lavoratori per tali posizioni.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
