...
description: Questo articolo fornisce dettagli e una query di esempio per l'entità Dipendente retribuzioni in Dynamics 365 Human Resources.
author: jcart
ms.date: 08/25/2021
ms.topic: article
ms.prod: ''
...
Questo articolo descrive l'entità dipendente Retribuzioni per Dynamics 365 Human Resources.
...
| **ID entità dipendente retribuzioni**</br>mshr_payrollemployeeentityid</br>*GUID* | Generato dal sistema | Un valore dell'identificatore univoco globale (GUID) generato dal sistema per identificare il dipendente in modo univoco. |
