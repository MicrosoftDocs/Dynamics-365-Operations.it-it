...
description: Questo articolo descrive le opzioni di copertura in Microsoft Dynamics 365 Human Resources per l'elezione di un partecipante in un piano o programma di benefici.
author: twheeloc
ms.date: 08/24/2021
ms.topic: article
ms.prod: ''
