---
title: Benvenuti in Dynamics 365 Human Resources
description: ''
...
ms.locfileid: "3036501"
---
# <a name="welcome-to-dynamics-365-human-resources"></a>Benvenuti in Dynamics 365 Human Resources
...
[Impostare e gestire istanze](hr-admin-setup-provision.md)</br>
[Impostare l'integrazione di dati](hr-admin-integration-choose-technology.md)</br>
...
[Risolvere problemi relativi a Human Resources](hr-admin-troubleshooting-support.md)</br>
...
[Entità di Human Resources in Common Data Service](hr-developer-entities.md)</br>
[Campi personalizzati](hr-developer-custom-fields.md)</br>
[Impostare l'integrazione di dati](hr-admin-integration-choose-technology.md)</br>
[Riferimento all'API dell'entità](hr-developer-api-authentication.md)

## <a name="user-guide"></a>Manuale dell'utente

[Panoramica](hr-hrpro-overview.md)</br>
[Esplorare l'interfaccia utente](../fin-ops-core/fin-ops/get-started/user-interface-elements.md?toc=/dynamics365/human-resources/toc.json)</br>
[Configurare Human Resources](hr-setup-parameters.md)</br>
...
[Crea corsi](hr-learning-courses.md)
