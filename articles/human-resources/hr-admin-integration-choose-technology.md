...
description: Questo articolo fornisce informazioni sull'integrazione con i dati gestiti da Human Resources.
author: twheeloc
ms.date: 08/19/2021
ms.topic: article
ms.prod: ''
...
Questo articolo fornisce informazioni per l'integrazione con i dati gestiti da Dynamics 365 Human Resources. Descrive diverse tecnologie di integrazione per aiutare a decidere quali tecnologie si adattano meglio alle proprie esigenze.
...
| Componente aggiuntivo di Excel           | No                                       | Sincronizza                                        | No                                        | Media (decine di migliaia di record)                      | Supporta tutte le entità abilitate per OData |
| Servizio di integrazione di dati        | Sì, programmato nel servizio di integrazione di dati        | Asincrona, batch                                | No                                        | Varia con il caso d'uso                                       | Supporta tutte le tabelle Dataverse           |
