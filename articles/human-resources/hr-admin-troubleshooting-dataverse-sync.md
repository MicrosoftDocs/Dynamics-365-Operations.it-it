...
description: Questo articolo descrive come risolvere i problemi dei record che non si sincronizzano correttamente tra Microsoft Dynamics 365 Human Resources e la soluzione Gestione risorse umane (HCM) comune in Microsoft Dataverse.
author: jaredha
ms.date: 09/27/2021
ms.topic: article
ms.prod: ''
