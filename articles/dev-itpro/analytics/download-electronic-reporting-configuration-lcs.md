...
9. Fare clic su **Importa** per scaricare la versione selezionata da LCS nell'istanza corrente di Finance and Operations.

    > [!NOTE]
    > Il pulsante **Importa** non è disponibile per le versioni di configurazione di creazione di report elettronici già presenti nell'istanza corrente di Finance and Operations.
