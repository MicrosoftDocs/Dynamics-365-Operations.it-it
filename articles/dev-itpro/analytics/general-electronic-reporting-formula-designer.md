...
<a href="./media/ER-data-model-enumeration-values.PNG"><img src="./media/ER-data-model-enumeration-values.PNG" alt="Available values for data model enumeration" class="alignnone wp-image-290681 size-full" width="397" height="136" /></a> I seguenti esempi mostrano:
...
<li>L'espressione ER <strong>$IsArrivals</strong> progettata per l'utilizzo dell'enumerazione di modello come parametro di questa funzione. Il valore di questa condizione è <strong>TRUE</strong>.
