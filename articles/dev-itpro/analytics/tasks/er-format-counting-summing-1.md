...
---
# <a name="create-format-for-counting-and-summing-for-electronic-reporting-er"></a>Creare il formato per il conteggio e la somma per la creazione di report elettronici (ER)
