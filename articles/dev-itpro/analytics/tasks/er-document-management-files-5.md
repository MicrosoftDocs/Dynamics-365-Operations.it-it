...
---
# <a name="modify-and-run-formats-to-use-document-management-files-in-er-output"></a>Modificare ed eseguire i formati per utilizzare i file di gestione documenti nell'output di ER
