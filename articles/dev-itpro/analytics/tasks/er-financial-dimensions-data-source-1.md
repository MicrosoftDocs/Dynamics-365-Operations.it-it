...
---
# <a name="design-data-models-to-use-financial-dimensions-as-data-sources"></a>Progettare modelli di dati per utilizzare le dimensioni finanziarie come origini dati
