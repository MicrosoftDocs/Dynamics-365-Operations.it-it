...
---
# <a name="prepare-data-models-to-use-document-management-files-in-er-output"></a>Preparare i modelli di dati per utilizzare i file di gestione documenti negli output di ER
