...
---
# <a name="run-electronic-reporting-er-formats-to-do-counting-and-summing"></a>Eseguire i formati di creazione di report elettronici (ER) per eseguire somme e conteggi
