...
4. Selezionare **File**, quindi **Salva con nome** e denominare il report Bilancio di verifica dettagliato con attributi.
    ...
    > [!NOTE]
    > Quando un nuovo report viene creato nella funzionalità di progettazione report, l'elenco dei report finanziari viene aggiornato in Finance and Operations.
...
[Creazione di report finanziari](../../financials/general-ledger/financial-reporting-getting-started.md)

[Visualizzare i report finanziari](../../financials/general-ledger/view-financial-reports.md)
