...
È possibile configurare una destinazione Microsoft Power BI per ogni componente cartella o file di un formato ER configurato per generare documenti in uscita. In base all'impostazione della destinazione, un documento generato viene archiviato in una cartella SharePoint configurata in precedenza.
