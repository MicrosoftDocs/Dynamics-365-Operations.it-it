---
title: Tracciare i risultati del report generato e paragonarli ai valori di base
description: In questo articolo viene descritto come confrontare i risultati dei report ER generati ai valori di report di base.
author: kfend
ms.date: 06/17/2019
ms.topic: article
ms.prod: ''
