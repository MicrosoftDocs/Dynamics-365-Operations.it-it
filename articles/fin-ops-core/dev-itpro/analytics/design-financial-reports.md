...
ms.locfileid: "9799520"
---
# <a name="view-and-design-financial-reports"></a>Visualizzare e progettare i report finanziari

[!include [banner](../includes/banner.md)]

L'articolo fornisce esercizi che guidano alla visualizzazione e creazione dire report finanziari per Microsoft Dynamics 365 Finance. I report finanziari sono costituiti da una esperienza di visualizzazione nell'applicazione e una funzionalità di Report Designer con un solo clic che consente di creare e modificare report finanziari.
...
2. Spostare le dimensioni nel seguente ordine:
    ...
    > [!NOTE]
    > Le altre dimensioni possono rimanere nell'ordine in cui sono attualmente.
...
6. Selezionare **Modifica**.
    ...
    > [!NOTE]
    > Verrà richiesto di scaricare la funzionalità di Report Designer con un solo clic e di accedere. Per accedere, utilizzare le proprie credenziali.

7. Modificare l'anno di base a 2021 e selezionare **Genera**. Quando un report viene generato mediante la funzionalità di Report Designer, verrà aperto in una nuova scheda del browser. È possibile esplorare il report nella nuova scheda del browser o accedere alla scheda del browser originale e aprire il report da tale posizione selezionandolo dall'elenco **Report finanziari**.
...
11. Selezionare lo stesso conto o un conto diverso e **aprire le transazioni giustificativo**. Le transazioni giustificativo vengono filtrate per periodo, anno e conto + la combinazione di dimensioni del conto selezionato. Da **Transazioni giustificativo** puoi scegliere di esplorare altre informazioni relative alla transazione.
12. Chiudi **Transazioni giustificativo**. In un report finanziario è possibile scegliere di visualizzare i dati per un periodo e un anno diversi o con diversi attributi e dimensioni applicati. Questa operazione viene effettuata mediante **Opzioni report**.
13. Selezionare **Opzioni report**.
14. Selezionare **Aggiungere un filtro dimensioni** e scegliere **Business Unit**.
15. Digita **001** nel campo e seleziona **OK**. Il report mostra ora solo i dati per la Business Unit 001. Si tratta di una visualizzazione personalizzata del report e non è disponibile per altri utenti.
16. Chiudere il report filtrato. I report finanziari possono essere visualizzati in qualsiasi valuta aggiunta all'applicazione.
...
In questo esercizio verrà modificato un report predefinito esistente. Verrà aggiornata sia la definizione di riga per includere tutti i conti che la definizione di colonna per includere gli attributi del conto. Una volta completati gli aggiornamenti, verrà generato ed esplorato il report appena creato. Cominceremo dall'elenco **Report finanziari**.

1. Passare **Report finanziari** in **Richieste di informazioni e report** nella contabilità generale.
2. Selezionare la riga per il report denominato **Bilancio di verifica riepilogativo - Predefinito**.
3. Selezionare **Modifica**. **Bilancio di verifica riepilogativo - Predefinito** si aprirà nella funzionalità di Report Designer.
4. Seleziona **File**, quindi **Salva con nome** e denomina il report **Bilancio di verifica dettagliato con attributi**.

    > [!NOTE]
    > Quando un nuovo report viene creato nella funzionalità di Report Designer, l'elenco **Report finanziari** viene aggiornato.
...
Per questo esercizio verrà modificato un report predefinito esistente. Verrà creata una struttura del report e verrà aggiunta a una definizione di report per produrre **Centro di costo/conto economico divisionario**. Una volta completati gli aggiornamenti, verrà generato **Centro di costo/conto economico divisionario** e verrà esplorato il report utilizzando la struttura del report. Cominceremo dall'elenco **Report finanziari**.
...
3. Selezionare **Modifica**. **Conto economico - Predefinito** si aprirà nella funzionalità di Report Designer.
4. Scegliere **Nuovo** dal menu **File** e quindi fare clic su **Definizione di albero gerarchico**.
5. Scegliere **Inserisci unità gerarchiche da dimensioni** dal menu **Modifica**.
...
8. **Salva** la struttura risultante con il nome **Centri di costo per divisione**. Ora che la struttura del report è stata creata, verrà modificata per inserirvi tre nuove unità di rollup: Marketing, Operazioni e Vendita al dettaglio.
9. Nel menu **Finestra**, fare clic su **Centri di costo per divisione**. Se la struttura del report è stata chiusa, selezionarla da **Definizioni di albero gerarchico** nel riquadro di spostamento.
...
29. Modificare l'anno di base in **2021**, **salvare** le modifiche e **generare** il report. Una volta generato e aperto il report, è possibile esplorarlo.
...
3. Selezionare **Modifica**. **Conto patrimoniale e conto economico affiancati - Predefinito** si aprirà nella funzionalità di Report Designer.
4. Selezionare **File** &gt; **Salva con nome** e denominare il report **Conto patrimoniale e conto economico consolidati affiancati**.
5. Modificare l'anno di base in 2021.
...
1. Passare **Report finanziari** in **Richieste di informazioni e report** nella contabilità generale.
2. Selezionare **Nuovo**. La funzionalità di Report Designer verrà visualizzata con una definizione di report vuota aperta. La prima attività sarà la creazione della definizione di colonna.
...
16. Modificare l'anno di base in **2021**.
...
[Blog di Dynamics 365 Finance](https://community.dynamics.com/365/financeandoperations/b/dynamics-365-finance-blog)
