...
description: In questo articolo sono riportate le informazioni sull'utilizzo della funzione VALUEIN della creazione di report elettronici (ER).
author: kfend
ms.date: 12/14/2021
ms.prod: ''
ms.technology: ''
