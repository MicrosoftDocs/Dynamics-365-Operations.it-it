...
description: In questo articolo viene descritto cosa è incluso nel pacchetto di contenuto Power BI Gestione spese.
author: panolte
ms.date: 03/18/2019
ms.topic: article
ms.prod: ''
...
In questo articolo viene descritto cosa è incluso nel contenuto Power BI Gestione spese. 
