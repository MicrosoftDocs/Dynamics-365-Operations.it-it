...
Per generare un report utilizzando **Report Designer**, aprire la definizione del report e quindi selezionare il pulsante **Genera** nella barra degli strumenti. Verrà visualizzata la pagina **Stato coda report** che indica la posizione del report nella coda. Per impostazione predefinita, il report generato si aprirà nel Visualizzatore Web.
...
Quando le programmazioni report vengono create e salvate, vengono visualizzate nel riquadro di spostamento in **Programmazioni del report**. Per organizzare i report è possibile creare cartelle. Se un singolo report in una pianificazione non viene eseguito, tutti gli altri report continueranno ad esserlo.
...
1. In **Report Designer**, nel menu **File** seleziona **Nuovo**, quindi seleziona **Programmazione report**. Verrà visualizzata la finestra di dialogo **Nuova pianificazione di report**.
...
7. Nell area **Criterio ricorrenza**, specificare la frequenza con cui il report viene eseguito. Per impostazione predefinita, è selezionato **Giornaliero** per un valore **Intervallo (giorni)** di **1**. Altre opzioni includono **Settimanale**, **Mensile** e **Annuale**.
8. Nell'area **Intervallo di ricorrenza**, specifica quando la generazione del report deve essere interrotta.
...
9. Seleziona **Salva**. Nella finestra di dialogo **Salva con nome** specifica un nome univoco e una descrizione per la programmazione di report.
...
1. In Report Designer, seleziona **Programmazioni del report** nel riquadro di spostamento e aprire una programmazione di report da copiare.
2. Nel menu **File**, seleziona **Salva con nome** e immetti un nuovo nome e una nuova descrizione per la programmazione nella finestra di dialogo **Salva con nome**. Selezionare **OK** e la nuova programmazione apparirà nel pannello di navigazione.
...
1. In Report Designer, nel riquadro di spostamento, seleziona **Programmazioni report**.
...
Se non si immettono le credenziali necessarie per tutte le società incluse nei report, si riceve un messaggio di questo tipo quando si salva la programmazione di report: "È necessario immettere le credenziali per le società che sono contenute nella programmazione di report. Fai clic sul pulsante **Autorizzazioni** per immettere le credenziali".
...
Per continuare, seleziona il pulsante **Autorizzazioni** nella finestra di dialogo **Programmazione report**, quindi immetti le credenziali appropriate.
...
[Interfaccia di Report Designer](report-designer-interface.md)
