...
description: In questo articolo sono riportate le informazioni sull'utilizzo della funzione CHANGETIMEZONE della creazione di report elettronici (ER).
author: kfend
ms.date: 09/09/2021
ms.prod: ''
ms.technology: ''
