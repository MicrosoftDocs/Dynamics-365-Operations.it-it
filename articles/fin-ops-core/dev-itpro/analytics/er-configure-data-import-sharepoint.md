...
2. Nella pagina **Stati dei file per le origini** selezionare **Aggiorna** per aggiornare la pagina. Si noti che il file di Excel che è stato caricato in SharePoint viene visualizzato in questa pagina con lo stato **Pronto**. Al momento sono disponibili i seguenti stati:
