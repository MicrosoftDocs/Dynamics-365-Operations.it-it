...
description: In questo articolo sono riportate le informazioni sull'utilizzo della funzione LISTOFFIELDS della creazione di report elettronici (ER).
author: kfend
ms.date: 12/12/2019
ms.prod: ''
ms.technology: ''
