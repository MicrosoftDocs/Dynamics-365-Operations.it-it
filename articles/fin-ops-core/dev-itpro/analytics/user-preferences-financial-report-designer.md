...
description: In questo articolo viene descritto come impostare le preferenze utente per personalizzare le interazioni utente in progettazione report finanziari e controllare l'esperienza di accesso iniziale.
author: aprilolson
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
