...
description: In questo articolo sono riportate le informazioni sull'utilizzo della funzione LISTDISTINCT della creazione di report elettronici (ER).
author: kfend
ms.date: 07/30/2020
ms.prod: ''
ms.technology: ''
