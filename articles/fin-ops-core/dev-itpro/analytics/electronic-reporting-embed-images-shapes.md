...
description: Questo argomento spiega come utilizzare lo strumento Creazione di report elettronici per generare documenti aziendali con immagini e forme incorporate.
author: NickSelin
ms.date: 04/23/2021
ms.topic: article
ms.prod: ''
