...
ms.locfileid: "6757275"
---
# <a name="workforce-metrics-power-bi-content"></a>Contenuto Power BI sulle metriche della forza lavoro

[!include [banner](../includes/banner.md)]

In questo argomento viene descritto il contenuto **Metriche forza lavoro** di Microsoft Power BI. Descrive come accedere ai report di Power BI e fornisce informazioni sul modello dati e sulle entità utilizzati per costruire il contenuto.
