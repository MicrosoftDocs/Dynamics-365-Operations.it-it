...
description: In questo articolo viene descritto il contenuto Power BI Metriche forza lavoro.
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9289818"
---
# <a name="workforce-metrics-power-bi-content"></a>Contenuto Power BI sulle metriche della forza lavoro

[!include [banner](../includes/banner.md)]

In questo articolo viene descritto il contenuto Microsoft Power BI **Metriche forza lavoro**. Descrive come accedere ai report di Power BI e fornisce informazioni sul modello dati e sulle entità utilizzati per costruire il contenuto.
...
> [!NOTE]
> I file .pbix disponibili in Lifecycle Services si applicano solo alle app per la finanza e le operazioni.
