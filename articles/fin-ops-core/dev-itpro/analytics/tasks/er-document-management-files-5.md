...
description: In questo articolo viene descritto come configurare un formato di reporting elettronico (ER) per utilizzare i file di gestione dei documenti (allegati) nell'output ER. (Parte 5)
author: NickSelin
ms.date: 08/29/2018
