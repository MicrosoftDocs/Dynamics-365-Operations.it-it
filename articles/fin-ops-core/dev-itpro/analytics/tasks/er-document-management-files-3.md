...
description: In questo articolo viene descritto come configurare un formato di reporting elettronico per utilizzare i file di gestione dei documenti nell'output ER. (Parte 3)
author: kfend
ms.date: 08/29/2018
...
ms.locfileid: "9290936"
---
# <a name="er-use-document-management-files-in-format-outputs-part-3---create-format"></a>ER Usare file di gestione documenti in output di formato (parte 3 - creare il formato)
