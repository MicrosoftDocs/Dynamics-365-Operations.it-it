...
description: In questo argomento sono riportate le informazioni sull'utilizzo della funzione GETLABELTEXT della creazione di report elettronici (ER).
author: NickSelin
ms.date: 03/18/2022
ms.prod: ''
ms.technology: ''
