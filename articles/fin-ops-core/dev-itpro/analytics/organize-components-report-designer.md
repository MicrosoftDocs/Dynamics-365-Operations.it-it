...
description: In questo articolo viene spiegato come organizzare i report, i blocchi predefiniti e gli oggetti esistenti in Progettazione report.
author: aprilolson
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
