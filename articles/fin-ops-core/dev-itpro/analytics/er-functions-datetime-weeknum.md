...
description: In questo argomento sono riportate le informazioni sull'utilizzo della funzione WEEKNUM della creazione di report elettronici (ER).
author: NickSelin
ms.date: 12/03/2021
ms.prod: ''
ms.technology: ''
