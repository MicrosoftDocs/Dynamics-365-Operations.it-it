...
1. Nell'app Finance and Operations, eliminare le colonne **PrimaryContactPersonId** e **InvoiceVendorAccountNumber** dal mapping e salvare il mapping.
...
1. Nell'app Finance and Operations, eliminare le colonne **ContactPersonID** e **InvoiceAccount** dal mapping **Clienti V3 (account)** e quindi salvare il mapping.
