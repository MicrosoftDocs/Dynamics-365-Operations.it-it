## <a name="product-default-order-settings-v2-to-msdyn_productspecificdefaultordersettings"></a>Impostazioni ordine predefinite del prodotto V2 per msdyn_productspecificdefaultordersettings
