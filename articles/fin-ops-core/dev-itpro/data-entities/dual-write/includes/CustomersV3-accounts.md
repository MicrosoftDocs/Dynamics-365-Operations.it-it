## <a name="customers-v3-to-accounts"></a>Clienti V3 per accounts

Questo modello sincronizza i dati tra le app Finance and Operations e Common Data Service.

Filtro origine: ((PartyType == "Organization"))

Filtro origine in ordine inverso: customertypecode eq 3
...
nessuno | >> | address1_addresstypecode | 2
nessuno | >> | customertypecode | 3
PARTYTYPE | << | nessuno | Organization
