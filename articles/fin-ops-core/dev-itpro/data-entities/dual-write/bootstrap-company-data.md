...
È possibile avere un Common Data Service esistente o un'altra istanza dell'app Dynamics 365 con dati aziendali e si desidera abilitare la connessione a doppia scrittura. In questo caso, è necessario eseguire il bootstrap di Common Data Service o altri dati dell'app Dynamics 365 con le informazioni della società prima di abilitare la connessione a doppia scrittura.  
...
4. Attivare la mappa dell'entità **Cdm_companies**. In tal modo si sincronizzano le società dall'app Finance and Operations in Common Data Service.  
    > [!div class="mx-imgBorder"]
    > ![Attivare la mappa dell'entità](media/dual-write-boot-2.png)
5. Eseguire il codice di bootstrap di esempio in Common Data Service o in un'altra istanza dell'app Dynamics 365.  
6. Al termine del bootstrap e il sistema è pronto per la sincronizzazione in tempo reale, abilitare le mappe entità.  

    L'abilitazione delle mappe di entità attiva la sincronizzazione dei dati iniziali per le mappe entità abilitate. I dati corrispondenti alle società scelte sulla connessione a doppia scrittura sono sincronizzati tra l'app Finance and Operations e Common Data Service. 
