---
title: Piano per la rubrica globale e altre rubriche
description: Questo articolo descrive le considerazioni e le decisioni che è necessario prendere durante il processo di pianificazione.
author: msftbrking
ms.date: 01/13/2020
ms.topic: article
ms.prod: ''
