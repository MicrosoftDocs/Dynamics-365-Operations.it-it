...
3. Espandere la scheda **Immagine nel dashboard**.
4. Selezionare **Modifica**.
    
    La risoluzione ideale per un'immagine di tipo banner è 1920 x 281 pixel. La larghezza ideale per un'immagine di tipo logo è 350 pixel.
