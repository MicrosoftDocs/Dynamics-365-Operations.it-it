...
> [!NOTE]
> Questa funzionalità verrà deprecata a settembre 2022, i nuovi utenti dovranno usare la creazione di report elettronici. Per ulteriori informazioni, vedere [Impostare file di pagamenti sicuri mediante la creazione di report elettronici](set-up-positive-pay-er.md).
...
> [!NOTE]
> I nomi XML nell'XSLT devono corrispondere all'ortografia dei nodi nell'XML. Entrambi i file XSLT e XML fanno distinzione tra maiuscole e minuscole. 
