...
description: Questo articolo descrive come utilizzare sequenze numeriche condivise per copiare un fornitore in un'altra persona giuridica ma mantenendo lo stesso ID fornitore.
author: sunfzam
ms.date: 08/24/2018
ms.topic: index-page
ms.prod: ''
