...
Per una pianificazione più precisa del budget, è possibile creare posizioni previste utilizzando i dettagli delle posizioni esistenti, indipendentemente dalla posizione attualmente compilata o non compilata. 
...
[![Grafico "Assegna gruppo di retribuzione"](./media/graphic4.png)](./media/graphic4.png) 
