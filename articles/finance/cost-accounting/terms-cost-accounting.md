...
description: In questo articolo vengono definiti i termini principali utilizzati in Contabilità industriale.
author: aprilolson
ms.date: 08/31/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8881935"
---
# <a name="cost-accounting-terminology"></a>Terminologia della contabilità industriale

[!include [banner](../includes/banner.md)]

In questo articolo vengono definiti i termini principali utilizzati in Contabilità industriale.
...
-  Dynamics 365 Finance (preconfigurato)
...
|  **Origini dati** |  **Connettore dati Transazioni importate** | **Connettore dati Dynamics 365 Finance**  | **Connettore dati Dynamics AX**  |
|---|---|---|---|
