...
description: Questo articolo spiega come personalizzare le configurazioni imposte aggiungendo campi dati.
author: Kai-Cloud
ms.date: 10/21/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8872328"
---
# <a name="add-data-fields-in-tax-configurations"></a>Aggiungere campi dati nelle configurazioni imposte

[!include [banner](../includes/banner.md)]

Questo articolo spiega come personalizzare le configurazioni imposte utilizzando i [campi di dati aggiunti nell'integrazione fiscale](tax-service-add-data-fields-tax-integration-by-extension.md).
