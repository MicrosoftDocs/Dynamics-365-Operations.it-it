...
description: In questo articolo vengono forniti i collegamenti alle risorse della documentazione Microsoft Dynamics 365 Finance per l'Europa.
author: kfend
ms.date: 01/15/2022
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8856520"
---
# <a name="europe-overview"></a>Panoramica Europa

[!include [banner](../includes/banner.md)]

In questo articolo vengono fornite informazioni e collegamenti a risorse utili per impostare persone giuridiche con un indirizzo principale in Europa. 

- [Panoramica titolari di anticipi](emea-advance-holders.md)
 - [Transazioni dei titolari di anticipi](emea-advance-holders-transactions.md)
 - [Pagamento anticipato al dipendente](tasks/advance-payment-employee.md)
- [Fatture anticipo per Europa orientale](emea-advance-invoice.md)
- [Rendiconto bancario e riconciliazione dei pagamenti](emea-bank-reconciliation.md)
- [Fatturazione correttiva](emea-corrective-invoice.md)
- [Periodi divisi nei giornali di registrazione periodici](emea-create-post-periodic-journals.md)
- [Creare pagamenti per un cliente con mandati di addebito diretto](tasks/create-payments-customers-who-have-direct-debit-mandates.md)
...
- [Panoramica Intrastat](emea-intrastat.md)
  - [Trasferire transazioni a Intrastat](tasks/transfer-transactions-intrastat.md)
  - [Specifica di un indirizzo di carico per una transazione intracomunitaria](tasks/eur-00002-specify-lading-address-intra-community.md)
...
- [Scadenza emissione fattura](emea-invoice-issue-deadline.md)
...
- [Report distinta di pagamento](emea-eur-payment-slip-report-giro.md)
- [Piccola cassa per Europa orientale e Russia](emea-petty-cash.md)
...
- [Ricevere un certificato di entrata UE](tasks/eur-00012-receive-eu-entry-certificate.md)
- [ID registrazione](emea-registration-ids.md)
- [Reverse charge IVA](emea-reverse-charge.md)
...
- Imposta sul valore aggiunto (IVA)
  - [Impostare l'ID IVA](tasks/eur-00015-vat-id.md)
  - [Registrazione dell'ID IVA fornitore](tasks/eur-00015-registration-vendor-vat-id.md)
  - [Panoramica sul tasso di cambio IVA](emea-vat-exchange-rate.md)
