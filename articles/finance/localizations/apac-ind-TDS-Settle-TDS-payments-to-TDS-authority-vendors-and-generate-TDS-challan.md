...
description: Questo articolo descrive come liquidare i pagamenti dell'imposta dedotta all'origine (TDS) ai fornitori dell'autorità TDS.
author: kailiang
ms.date: 03/12/2021
ms.topic: article
ms.prod: ''
...
Questo articolo descrive come liquidare i pagamenti dell'imposta dedotta all'origine (TDS) ai fornitori dell'autorità TDS.
