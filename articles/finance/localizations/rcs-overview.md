...
description: Questo articolo fornisce una panoramica delle funzionalità di Regulatory Configuration Service (RCS) e spiega come accedere al servizio.
author: kfend
ms.date: 06/04/2021
ms.topic: overview
ms.prod: ''
...
> [!NOTE] 
> RCS non è attualmente disponibile per Government Community Cloud (GCC).
