...
description: Questo argomento spiega come allegare le distinte di pagamento stampate alle fatture di progetto per comodità dei clienti e per fornire un riferimento di pagamento per la registrazione e la liquidazione.
