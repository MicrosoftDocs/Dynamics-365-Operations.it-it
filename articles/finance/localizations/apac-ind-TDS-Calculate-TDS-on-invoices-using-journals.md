...
description: In questo articolo sono elencati i passaggi per il calcolo dell'imposta dedotta all'origine (TDS) nei giornali di registrazione.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
In questo articolo sono elencati i passaggi per il calcolo dell'imposta dedotta all'origine (TDS) nei giornali di registrazione.
