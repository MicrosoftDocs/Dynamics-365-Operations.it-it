...
description: In questo articolo vengono fornite informazioni su una funzionalità per l'abilitazione della data di registrazione IVA fornitore
author: anasyash
ms.date: 01/15/2022
ms.topic: article
ms.prod: ''
