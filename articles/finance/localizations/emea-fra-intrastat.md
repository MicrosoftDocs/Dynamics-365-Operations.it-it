...
La tabella seguente mostra i campi che sono inclusi nella dichiarazione Intrastat francese in formato SAISUNIC 330. La tabella indica anche il livello di report del campo. Il campo può essere **4** (semplificato), **1** (completo) o entrambi.

| **Campo**                   | **Livello report** |
|-----------------------------|------------------|
| Periodo di riferimento         | 4, 1              | 
| Numero di dichiarazione       | 4, 1              |
| Numero riga                 | 4, 1              |
| Codice ISO paese (FR)       | 4, 1              | 
| Codice complementare          | 4, 1              | 
| Numero Siren                | 4, 1              | 
| Codice IVA del cliente        | 4, 1              | 
| Codice direzione              | 4, 1              |
| Tipo di transazione            | 4, 1              | 
| Livello di obbligo            | 4, 1              |
| Codice voce doganale              | 1                | 
| NGP nazionale                | 1                | 
| Provincia (reparto)         | 1                |
| Natura della transazione       | 1                | 
| Paese di origine      | 1                | 
| Paese di origine - Importazioni | 1                | 
| Destinazione finale - Esportazioni | 1                | 
| Valore fattura               | 4, 1              | 
| Valore statistico           | 1                |
| Peso netto                  | 1                | 
| Unità supplementari            | 1                |
| Codice di trasporto              | 1                | 

La tabella seguente mostra i campi che sono inclusi nella dichiarazione Intrastat francese in formato INTRACOM.
La tabella indica anche il livello di report del campo. Il campo può essere **4** (semplificato), **1** (completo) o entrambi.
