---
title: Installa il componente aggiuntivo per microservizi in Lifecycle Services
description: In questo argomento viene descritto come installare il componente aggiuntivo Fatturazione elettronica in Microsoft Dynamics Lifecycle Services (LCS).
author: dkalyuzh
ms.date: 02/11/2022
ms.topic: article
ms.prod: ''
