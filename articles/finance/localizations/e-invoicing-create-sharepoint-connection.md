...
description: Questo argomento spiega come configurare una connessione in modo che la fatturazione elettronica possa accedere a un sito di Microsoft SharePoint.
author: dkalyuzh
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
