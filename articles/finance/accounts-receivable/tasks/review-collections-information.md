...
description: In questa articolo vengono descritti i passaggi per esaminare le informazioni sulla riscossione nonché le varie opzioni di impostazione e le transazioni di riscossione.
...
ms.locfileid: "8876213"
---
# <a name="review-collections-information"></a>Rivedere le informazioni sulla riscossione

[!include [banner](../../includes/banner.md)]

In questa articolo vengono descritti i passaggi per esaminare le informazioni sulla riscossione nonché le varie opzioni di impostazione e le transazioni di riscossione. Questa procedura utilizza la società dimostrativa USMF.
