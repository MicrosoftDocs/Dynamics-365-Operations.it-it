...
description: In questo articolo vengono fornite informazioni sul flusso di lavoro del cliente. È possibile modificare campi specifici per un cliente e inviare tali modifiche per l'approvazione utilizzando il flusso di lavoro prima che vengano aggiunte al cliente.
author: abruer
ms.date: 08/24/2018
ms.topic: index-page
ms.prod: ''
