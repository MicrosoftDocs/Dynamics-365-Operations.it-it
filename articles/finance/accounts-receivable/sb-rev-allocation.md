...
description: Questo articolo spiega come usare l'allocazione ricavi nella fatturazione abbonamento.
...
ms.locfileid: "8864370"
---
# <a name="revenue-allocation"></a>Allocazione ricavi

Questo articolo spiega come impostare i parametri di allocazione ricavi per un programma di fatturazione. Puoi impostare o modificare l'allocazione ricavi quando crei il programma di fatturazione. Quando apri la pagina **Allocazione ricavi** per un programma di fatturazione attivo o terminato, i campi sono di sola lettura.
