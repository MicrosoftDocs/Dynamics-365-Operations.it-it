...
description: In questo articolo viene descritto come utilizzare le sequenze numeriche condivise per copiare un cliente in un'altra persona giuridica mantenendo lo stesso ID cliente.
author: abruer
ms.date: 08/31/2018
ms.topic: index-page
ms.prod: ''
