...
description: Vengono fornite le informazioni sull'area di lavoro gestione banche. Questa area di lavoro mostra le informazioni relative ai conti bancari della società.
author: roschlom
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
