...
> [!NOTE]
> Questa funzionalità verrà deprecata a settembre 2022, i nuovi utenti dovranno usare la creazione di report elettronici. Per ulteriori informazioni, vedere [Impostare il processo di importazione della riconciliazione estratti conto avanzata mediante la creazione di report elettronici](../accounts-payable/import-bai2-er.md).
