...
description: Questo argomento illustra il campo Arrotonda ammortamento presente nelle pagine Impostazione libro.
author: moaamer
ms.date: 06/20/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8726727"
---
# <a name="round-off-amount-for-depreciation-calculations"></a>Importo per l'arrotondamento dei calcoli di ammortamento

[!include [banner](../includes/banner.md)]

Questo argomento illustra il campo **Arrotonda ammortamento** presente nelle pagine **Impostazione libro**.
