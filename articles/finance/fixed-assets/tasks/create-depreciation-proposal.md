...
description: In questo articolo viene descritto come le proposte di ammortamento batch vengono eseguite e viene illustrato come proporre l'ammortamento per i cespiti.
author: abruer
ms.date: 08/01/2019
...
ms.locfileid: "8858498"
---
# <a name="create-a-depreciation-proposal"></a>Creare una proposta di ammortamento

[!include [banner](../../includes/banner.md)]

In questo articolo viene descritto come le proposte di ammortamento batch vengono eseguite e viene illustrato come proporre l'ammortamento per i cespiti. In questa attività viene utilizzata la società dimostrativa USMF e il ruolo Ragioniere.
