...
description: Questo articolo elenca i passaggi per impostare la ritenuta d'acconto globale per vendite e acquisti.
author: kailiang
ms.date: 01/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8902460"
---
# <a name="set-up-global-withholding-tax"></a>Impostare la ritenuta d'acconto globale

Questo articolo elenca i passaggi per impostare la ritenuta d'acconto globale per vendite e acquisti. 
