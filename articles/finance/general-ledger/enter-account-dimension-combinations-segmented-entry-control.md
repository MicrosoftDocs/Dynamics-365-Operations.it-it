...
<tbody>
<tr class="odd">
<td>Freccia ALT + Giù</td>
<td>Aprire la ricerca. Se si preme la freccia ALT + Giù una seconda volta, lo stato attivo passa ai segmenti nel riquadro a comparsa.</td>
</tr>
<tr class="even">
<td><ul>
<li>Invio e MAIUSC + Invio</li>
<li>Delimitatore piano dei conti</li>
<li>Freccia destra e freccia sinistra</li>
</ul></td>
<td>Passare al segmento successivo o precedente.</td>
</tr>
<tr class="odd">
<td>TAB</td>
<td>Passare al campo successivo nella griglia.</td>
</tr>
</tbody>
</table>

Nella seguente tabella sono descritti i tasti di scelta rapida che possono essere utilizzati quando la ricerca viene aperta.
...
<tr class="odd">
<td>ESC</td>
<td>Chiudere la ricerca.</td>
</tr>
<tr class="even">
<td><ul>
<li>Freccia Su e freccia Giù</li>
<li>Pagina Su e pagina Giù</li>
<li>Home e Fine</li>
</ul></td>
<td>Passare al valore precedente o successivo negli elenchi, al gruppo di valori precedente o successivo o al primo o all'ultimo elemento nella ricerca.</td>
</tr>
<tr class="odd">
<td><ul>
<li>Delimitatore piano dei conti</li>
...
<tr class="odd">
<td>ALT + W</td>
<td>Passare tra <strong>Mostra tutti</strong> e <strong>Visualizza validi</strong>.</td>
</tr>
</tbody>
</table>
