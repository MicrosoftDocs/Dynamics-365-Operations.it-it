---
title: Valore del campo errato in TaxTrans
description: Questo articolo fornisce informazioni sulla risoluzione dei problemi relativi a valori di campo errati in TaxTrans.
author: EricWangChen
ms.date: 04/27/2021
ms.topic: article
ms.prod: ''
