...
> [!TIP]
> Per ulteriori informazioni su come creare e gestire definizioni di riga, di colonna e alberi gerarchici, vedere [Componenti del report finanziario](../../fin-ops-core/dev-itpro/analytics/financial-report-components.md).
