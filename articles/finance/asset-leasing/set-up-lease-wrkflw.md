...
description: L'articolo spiega come configurare un flusso di lavoro di approvazione che verrà eseguito quando viene creato un nuovo leasing.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8870280"
---
# <a name="set-up-lease-approval-workflows"></a>Configurare flussi di lavoro di approvazione del leasing

[!include [banner](../includes/banner.md)]

L'articolo spiega come configurare un flusso di lavoro di approvazione che verrà eseguito quando viene creato un nuovo leasing. Per informazioni su come utilizzare il flusso di lavoro, vedi [Utilizza flussi di lavoro di approvazione del leasing](use-create-lease-wrkflw.md). 
