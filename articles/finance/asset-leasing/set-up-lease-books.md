...
description: In questo articolo vengono descritte le informazioni conservate nei libri di leasing. I libri di leasing contengono i criteri contabili che determinano la modalità di contabilizzazione di un leasing nel sistema.
author: moaamer
ms.date: 07/16/2021
ms.topic: article
ms.prod: ''
