...
description: Questo articolo spiega come stornare una transazione di leasing registrata. Qualsiasi transazione creata tramite Leasing cespite può essere stornata.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
