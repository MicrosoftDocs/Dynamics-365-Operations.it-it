...
ms.locfileid: "2552327"
---
# <a name="project-timesheet-mobile-application"></a>App per dispositivi mobili Project timesheet
...
In Finance, l'app mobile Project Timesheet deve essere abilitata. Per abilitare la funzionalità, andare a **Parametri Gestione progetti e contabilità \> Foglio presenze** e selezionare il parametro **Abilita Microsoft Dynamics 365 Project Timesheet**.

## <a name="sign-in-to-the-app"></a>Accedere all'app

1.  Avviare l'app sul dispositivo mobile.

2.  Immettere l'ULR di Finance.
