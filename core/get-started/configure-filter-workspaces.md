...
<a name="configuring-a-workspace"></a>Configurazione di un'area di lavoro
-----------------------
...
[configurare-e-filtro- aree di lavoro![(]. /media/configure-and-filter-workspaces.png)](. /media/configure-and-filter-workspaces.png)   
...
[configurare-mio- area di lavoro![(]. /media/configure-my-workspace.png)](. /media/configure-my-workspace.png)

## <a name="filtering-a-workspace"></a>Filtrare un'area di lavoro
Molte aree di lavoro consentono di filtrare il contenuto visualizzato. I controlli disponibili consentono di filtrare tutto il contenuto nell'area di lavoro o solo il contenuto nella sezione specifica dell'area di lavoro. I filtri nelle aree di lavoro possono essere campi di ricerca, caselle combinate, compi di testo in formato libero o altri tipi di controlli. Tuttavia, ogni tipo di filtro ha gli stessi effetti, come descritto nelle sezioni seguenti.

### <a name="workspace-wide-filters"></a>Filtri per l'intera area di lavoro
...
[area di lavoro filtro![(]. /media/workspace-filter.png)](. /media/workspace-filter.png) 

Quando si fa clic per aprire il filtro, verranno visualizzate varie opzioni. 

[![area di lavoro-filtro- su più righe (]. /media/workspace-filter-expanded.png)](. /media/workspace-filter-expanded.png) 
...
[area di lavoro-sezione- filtri![(]. /media/workspace-section-filters.png)](. /media/workspace-section-filters.png) 
