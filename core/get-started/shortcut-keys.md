...
| Spostarsi nel riquadro azioni standard                  | CTRL + F6                          |
...
| Spostarsi tra le date nella selezione | CTRL + FRECCE                               |
| Spostarsi sul mese successivo/precedente       | Pagina GIÙ/Pagina SU                       |
| Spostarsi sull'anno successivo/precedente        | CTRL + MAIUSC + Pagina SU/CTRL + MAIUSC + Pagina GIÙ |
...
| Aprire il riquadro filtri (o spostare lo stato attivo tra il riquadro filtri e il modulo principale se il riquadro filtri è già aperto) | CTRL + F3       |
...
| Aprire l'elenco di navigazione nel modulo Dettagli (o spostare lo stato attivo tra l'elenco di navigazione e il modulo principale se è già aperto) | CTRL + F8           |
...
| Spostarsi sulla riga successiva/precedente                                                                                 | Freccia SU/Freccia GIÙ           |
| Spostarsi sulla riga successiva/precedente senza selezionare (nota: questo collegamento si applica solo agli scenari di scelta multipla) | CTRL + Freccia SU/CTRL + Freccia GIÙ |
| Selezionare/deselezionare la riga corrente (nota: questo collegamento si applica solo agli scenari di scelta multipla)                    | CTRL + Barra spaziatrice/CTRL + clic         |
| Aggiungere la riga successiva/precedente a quella selezionata (nota: questo collegamento si applica solo agli scenari di scelta multipla)   | MAIUSC + Barra spaziatrice                     |
| Aggiungere un intervallo di righe a quella selezionata (nota: questo collegamento si applica solo agli scenari di scelta multipla)         | MAIUSC + clic                     |
| Passare alla pagina di dati successiva/precedente                                                                          | Pagina SU/Pagina GIÙ             |
| Creare una nuova riga nella parte inferiore della griglia                                                                    | Freccia GIÙ (dall'ultima riga)  |
| Selezionare o deselezionare tutte le righe                                                                                      | CTRL + MAIUSC + O                    |
| Passare al primo record                                                                                      | CTRL + HOME                       |
| Passare all'ultimo record                                                                                       | CTRL + FINE                        |
...
| Chiudere/aprire la parte destra dell'elenco a discesa                                                                      | ALT + Freccia DESTRA/ALT + Freccia SINISTRA |
| Passare tra le modalità "Visualizza validi" e "Mostra tutto"                                                                        | ALT + W                            |
