# [](index.md)Introduzione

# [Onboard a Dynamics 365 per operazioni](get-started/onboarding-home.md)
## Introduzione a Dynamics 365 per operazioni
### [Iniziare con Microsoft FastTrack per Dynamics 365](get-started/fasttrack-dynamics-365-overview.md)
...
## [Distribuire un ambiente demo](/dynamics365/operations/dev-itpro/deployment/deploy-demo-environment?toc=/dynamics365/operations/toc.json)

## Esplorare l'interfaccia utente
### [Ricerca di azioni](get-started/action-search.md)
### [Sintassi di filtro e query avanzata](get-started/advanced-filtering-query-options.md)
### [Dynamics 365 per client operazioni domande frequenti](get-started/client-faq.md)
...
### [Comprendere i servizi del ciclo di vita](/dynamics365/operations/dev-itpro/lifecycle-services/lcs-works-lcs?toc=/dynamics365/operations/toc.json)
...
### [La connessione di Guida](/dynamics365/operations/dev-itpro/get-started/help-connect?toc=/dynamics365/operations/toc.json)
### [View and export field descriptions](get-started/view-export-field-descriptions.md)

### Le guide di attività e registrazione attività
#### [Registrazione attività](/dynamics365/operations/dev-itpro/user-interface/task-recorder?toc=/dynamics365/operations/toc.json)
#### [Creazione di documentazione o formazione](/dynamics365/operations/dev-itpro/user-interface/task-recorder?toc=/dynamics365/operations/toc.json)

## [Contenuto della Guida specifiche del paese/regione](/dynamics365/operations/dev-itpro/lcs-solutions/country-region?toc=/dynamics365/operations/toc.json)
...
## [Configurare una gerarchia organizzativa](organization-administration/plan-organizational-hierarchy.md)
...
## [Cenni preliminari sulla gestione dei casi](organization-administration/cases.md)
### [Configurare le categorie, processi e sicurezza caso](organization-administration/plan-case-management.md)
## [Creare modelli di record](organization-administration/record-templates.md)
## [Configurare e inviare posta elettronica](organization-administration/configure-email.md)
## [Dati Data/ora e fusi orari](organization-administration/date-time-zones.md)

# Progettazione flussi di lavoro
## [Panoramica del sistema del flusso di lavoro](organization-administration/overview-workflow-system.md)
...
# [Amministratore e sviluppatore](/dynamics365/operations/dev-itpro/index)

# Altre risorse
## [Dynamics 365 per il glossario di operazioni](get-started/glossary.md)
