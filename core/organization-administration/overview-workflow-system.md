...
# <a name="workflow-system-overview"></a>Panoramica del sistema flusso di lavoro
...
Il sistema del flusso di lavoro viene installato con Dynamics 365 for Operations e viene eseguito nel server oggetti applicativi (AOS). Nel sistema sono disponibili funzionalità che consentono di creare singoli flussi di lavoro o processi aziendali.
